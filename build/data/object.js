    ...
    items: {
        ...
        Lifegiving_Gem: {
            ...
            dustIncrease: function () {
                return (this.effect() +
                    Math.max(0, autoBattle.trimp.lifesteal -
        ...
        Box_of_Spores: {
            ...
            zone: 220,
            description: function () {
                return ("If the Enemy dies while Poisoned after never Bleeding, it drops " +
                    this.dustMult() +
                    "x more Dust.");
            },
            upgrade: "+1x Dust",
        ...
        Myco_Mitts: {
            ...
            zone: 230,
            description: function () {
                return ("Multiplies the damage dealt by Poison ticks by " +
                    this.poisonMult() +
                    "x.");
            },
...
function prettify(number) {
    ...
    if (!isFinite(number))
        return "<span class='icomoon icon-infinity'></span>";
