...
import { changeValueSafe, hideHover, showHover, updateButton, } from "../controller/utility.js";
...
function partItemsDiv(parts, ind) {
    ...
    for (let i = start; i < end; i++) {
        ...
        button.classList.add("uncheckedButton", "text", "itemsButton", "generalButton");
...
function addChangeForHover(hoverDiv, displayDiv) {
