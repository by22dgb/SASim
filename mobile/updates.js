...
function tooltip(
  ...
  if (
    !game.options.menu.bigPopups.enabled &&
    (what == "The Improbability" ||
      ...
      (what == "The Mutated Zones" &&
        game.global.highestRadonLevelCleared >= 220))
  ) {
    return;
  }
  ...
  if (
    event != "lock" &&
    (event != "update" || isItIn) &&
    !game.options.menu.tooltips.enabled &&
    !shiftPressed &&
    what != "Well Fed" &&
    what != "Perk Preset" &&
    what != "Activate Portal" &&
    !ignoreShift
  ) {
    var whatU = what,
      isItInU = isItIn,
  ...
  if (
    ...
    if (typeof toTip === "undefined") console.log(what);
      ...
      if (typeof toTip.cost !== "undefined")
        ...
        costText = "Purchase a Hut, House, Mansion, Hotel, Resort, or Gateway";
    }
  }
  if (isItIn == "advMaps") {
    var advTips = {
      ...
      Difficulty:
        "This slider allows you to fine tune the map Difficulty modifier. Moving this slider from left to right will guarantee an easier map, but increase the cost.",
      get Biome() {
        var text =
          "<p>If you're looking to farm something specific, you can select the biome here. Anything other than random will increase the cost of the map.</p><ul>";
        text +=
          "<li><b>Mountain</b> - Contains a lot of Metal</li><li><b>Forest</b> - A great place to find some Wood</li><li><b>Sea</b> - Just filled with food to catch</li><li><b>Depths</b> - Ancient Gem mines</li>";
        if (game.global.decayDone)
          text +=
            "<li><b>Gardens</b> - 25% extra loot and a random assortment of resources</li>";
        if (game.global.farmlandsUnlocked)
          text +=
            "<li><b>Farmlands</b> - 100% extra loot in Universe 2, 50% extra Herbs. Mimics Mountains on Z6, Forest on Z7, Sea on Z8, Depths at Z9, Gardens at Z10. Continues on rotating every World Zone.";
        text += "</ul>";
        return text;
      },
      get Special_Modifier() {
        var text =
          "<p>Select a special modifier to add to your map from the drop-down below! You can only add one of these to each map. The following bonuses are currently available:</p><ul>";
        for (var item in mapSpecialModifierConfig) {
          var bonusItem = mapSpecialModifierConfig[item];
          var unlocksAt =
            game.global.universe == 2
              ? bonusItem.unlocksAt2
              : bonusItem.unlocksAt;
          if (
            ...
            text +=
              "<li><b>Next modifier unlocks at Z" + unlocksAt + "</b></li>";
            break;
          }
          text +=
            "<li><b>" +
      ...
      Show_Hide_Map_Config:
        "Click this to collapse/expand the map configuration options.",
      Save_Map_Settings:
        "Click this to save your current map configuration settings to your currently selected preset. These settings will load by default every time you come in to the map chamber or select this preset.",
      Reset_Map_Settings:
        "Click this to reset all settings to their default positions. This will not clear your saved setting, which will still be loaded next time you enter the map chamber.",
      Extra_Zones:
      ...
      Perfect_Sliders:
        "<p>This option takes all of the RNG out of map generation! If sliders are maxxed and the box is checked, you have a 100% chance to get a perfect roll on Loot, Size, and Difficulty.</p><p>You can only choose this setting if the sliders for Loot, Size, and Difficulty are at the max.</p>",
      Map_Preset:
        "You can save up to 5 different map configurations to switch between at will. The most recently selected setting will load each time you enter your map chamber.",
    };
  ...
  if (isItIn == "dailyStack") {
    tooltipText = dailyModifiers[what].stackDesc(
      game.global.dailyChallenge[what].strength,
  ...
  if (what == "Confirm Purchase") {
    if (attachFunction == "purchaseImport()" && !boneTemp.selectedImport)
      return;
    ...
    if (numCheck && game.global.b < numCheck) {
      ...
      tooltipText =
        "You can't afford this bonus. Would you like to visit the shop?";
      attachFunction = "showPurchaseBones()";
      btnText = "Visit Shop";
    } else tooltipText = textString;
    costText +=
      '<div class="maxCenter"><div id="confirmTooltipBtn" class="btn btn-info" onclick="' +
      attachFunction +
      '; cancelTooltip()">' +
      btnText +
      '</div><div class="btn btn-info" onclick="cancelTooltip()">Cancel</div></div>';
  ...
  if (what == "Trimps Info") {
    ...
    var text =
      '<div class="trimpsInfoPopup">Need help, found a bug or just want to talk about Trimps? Check out the <a href="https://www.reddit.com/r/trimps" target="_blank">/r/Trimps SubReddit</a>';
    if (kongMode)
      text +=
        ' or the <a href="https://www.kongregate.com/forums/11405-trimps" target="_blank">Kongregate Forums</a>.<br/><br/>';
    else
      text +=
        ' or come hang out in the new <a href="https://discord.gg/kSpNHte" target="_blank">Trimps Official Discord</a>!<br/><br/>';
    text +=
      ' If you want to read about or discuss the finer details of Trimps mechanics, check out the <a href="https://trimps.wikia.com/wiki/Trimps_Wiki" target="_blank">community-created Trimps Wiki!</a><br/><br/>';
    if (kongMode)
      text +=
        ' If you need to contact the developer for any reason, <a target="_blank" href="https://www.kongregate.com/accounts/Greensatellite/private_messages?focus=true">send a private message to GreenSatellite</a> on Kongregate.';
    else
      text +=
        ' If you need to contact the developer for any reason, <a href="https://www.reddit.com/message/compose/?to=Greensatellite" target="_blank">click here to send a message on Reddit</a> or find Greensatellite in the Trimps Discord.<hr/><br/>';
    if (!kongMode)
      text +=
    ...
    tooltipText = text;
    costText =
      '<div class="btn btn-info" onclick="cancelTooltip()">Close</div>';
    game.global.lockTooltip = true;
    elem.style.left = "33.75%";
    elem.style.top = "25%";
    noExtraCheck = true;
  ...
  if (what == "NW Trimps Info") {
    what = "Trimps Info";
    var text =
      '<div class="trimpsInfoPopup">Need help, found a bug or just want to talk about Trimps? Check out the <a class="nwWebLink" onclick="nwWebLink(\'https://www.reddit.com/r/trimps\')">/r/Trimps SubReddit</a>';
    text +=
      ' or come hang out in the <a class="nwWebLink" onclick="nwWebLink(\'https://discord.gg/Trimps\')">Trimps Official Discord</a>!<br/><br/>';
    text +=
      ' If you want to read about or discuss the finer details of Trimps mechanics, check out the <a class="nwWebLink" onclick="nwWebLink(\'https://trimps.wikia.com/wiki/Trimps_Wiki\')">community-created Trimps Wiki!</a><br/><br/>';
    text +=
      ' If you need to contact the developer for any reason, <a class="nwWebLink" onclick="nwWebLink(\'https://www.reddit.com/message/compose/?to=Greensatellite\')">click here to send a message on Reddit</a> or find Greensatellite#7771 in the Trimps Discord.';
    text += "</div>";
    tooltipText = text;
    costText =
      '<div class="btn btn-info" onclick="cancelTooltip()">Close</div>';
  ...
  if (what == "Fluffy") {
    if (event == "update") {
      ...
      tooltipText =
        "<div id='fluffyTooltipTopContainer'>" + fluffyTip[0] + "</div>";
      tooltipText +=
        "<div id='fluffyLevelBreakdownContainer' class='niceScroll'>" +
        fluffyTip[1] +
        "</div>";
      costText =
        '<div class="btn btn-danger btn-lg" onclick="cancelTooltip()">Close</div>';
      if (game.challenges.Nurture.boostsActive()) {
        costText +=
          "<span id='toggleCruffyTipBtn' class='btn btn-lg btn-primary' onclick='Fluffy.toggleCruffys()'>Show ";
        costText += Fluffy.cruffysTipActive() ? "Scruffy" : "Cruffys";
        costText += " Info</span>";
      }
      costText +=
        "<span onclick='Fluffy.pat()' id='fluffyPatBtn' style='display: " +
        (Fluffy.cruffysTipActive() ? "none" : "inline-block") +
        "' class='btn btn-lg btn-warning'>Pat</span>";
      openTooltip = "Fluffy";
  ...
  if (what == "First Amalgamator") {
    tooltipText =
      "<p><b>You found your first Amalgamator! You can view this tooltip again and track how many Amalgamators you currently have under 'Jobs'.</b></p>";
    tooltipText += game.jobs.Amalgamator.tooltip;
    costText =
      "<div class='maxCenter'><div class='btn btn-info' id='confirmTooltipBtn' onclick='cancelTooltip()'>Thanks for the help, tooltip, but you can go now.</div></div>";
    game.global.lockTooltip = true;
    elem.style.left = "33.75%";
    elem.style.top = "25%";
    noExtraCheck = true;
  ...
  if (what == "Empowerments of Nature") {
    ...
    var lvlsLeft =
      5 - ((game.global.world - 1) % 5) + (game.global.world - 1) + 1;
    tooltipText =
      "<p>The " +
      active +
      " Empowerment is currently active!</p><p>" +
      emp.description() +
      "</p><p>This Empowerment will end on Z" +
      lvlsLeft;
    if (game.global.challengeActive !== "Eradicated") {
      tooltipText +=
        ", at which point you'll be able to fight a " +
        getEmpowerment(null, true) +
        " enemy to earn";
  ...
  if (what == "Helium Per Hour") {
    ...
    tooltipText =
      ...
      name +
      " Per Hour is simply a calculation of how much " +
      name +
      " you've earned so far this run, divided by the amount of hours you've spent so far on this run.<br/><br/>This value is <b>not</b> production like the other resources. " +
      name +
      " is always earned from killing strong Bad Guys and never produced automatically.";
    costText = "";
  }
  if (what == "Finish Daily") {
    var reward = game.challenges.Daily.getCurrentReward();
    tooltipText =
      "Clicking <b>Finish</b> below will end your daily challenge and you will be unable to attempt it again. You will earn <b>" +
      prettify(reward) +
      " extra " +
      heliumOrRadon() +
      "!</b>";
    costText =
      '<div class="maxCenter"><div id="confirmTooltipBtn" class="btn btn-info" onclick="abandonChallenge(); cancelTooltip()">Finish</div><div class="btn btn-danger" onclick="cancelTooltip()">Cancel</div></div>';
    game.global.lockTooltip = true;
    elem.style.left = "33.75%";
    elem.style.top = "25%";
  }
  if (what == "Switch Daily") {
    ...
    tooltipText =
      ...
      (textString == 0
        ? "today"
        : dayOfWeek(getDailyTimeString(textString, false, true))) +
      "s challenge, which resets in less than " +
      daysUntilReset +
      " day" +
      (daysUntilReset == 1 ? "" : "s") +
      ".";
  ...
  if (what == "Decay") {
    ...
    var decayedAmt = (
      (1 - Math.pow(challenge.decayValue, challenge.stacks)) *
      100
    ).toFixed(2);
    tooltipText =
      "Things are quickly becoming tougher. Gathering, looting, and Trimp attack are reduced by " +
      decayedAmt +
      "%.";
    costText = "";
  }
  if (what == "Heirloom") {
    ...
    tooltipUpdateFunction = "";
    tooltipText = displaySelectedHeirloom(
      false,
      0,
      true,
      numCheck,
    ...
    if (getSelectedHeirloom(numCheck, attachFunction).rarity == 8) {
      ondisplay = function () {
        document.getElementById("tooltipHeirloomIcon").style.animationDelay =
  ...
  if (what == "Respec") {
    tooltipText =
      "You can respec your perks once per portal. Clicking cancel after clicking this button will not consume your respec.";
    costText = "";
  }
  if (what == "Respec Mutators") {
    tooltipText =
      "You can only respec your Mutators when you are activating your Portal. Make sure your Mutator setup will work for your entire run!";
    costText = "";
  }
  if (what == "Well Fed") {
    var tBonus = 50;
    ...
    tooltipText =
      "That Turkimp was delicious, and you have leftovers. If you set yourself to gather Food, Wood, or Metal while this buff is active, you can share with your workers to increase their gather speed by " +
      tBonus +
      "%";
    costText = "";
  }
  ...
  if (what == "Trustworthy Trimps") {
    if (usingScreenReader) {
      setTimeout(function () {
        document.getElementById("screenReaderTooltip").innerHTML = textString;
      }, 2000);
    ...
    game.global.lockTooltip = true;
    costText =
      "<div class='maxCenter'><div class='btn btn-info' id='confirmTooltipBtn' onclick='cancelTooltip()'>Sweet, thanks.</div></div>";
    elem.style.left = "33.75%";
    elem.style.top = "25%";
  }
  if (what == "Unequip Heirloom") {
    ...
    if (game.global.maxCarriedHeirlooms > game.heirlooms.values.length) {
      tooltipText +=
        "and you've already purchased the maximum amount of slots.</p><p>Would you like to leave this Heirloom equipped ";
    } else if (game.global.nullifium < getNextCarriedCost()) {
      tooltipText +=
        "and don't have enough Nullifium to purchase another Carried slot.</p><p>Would you like to leave this Heirloom equipped ";
    } else {
      tooltipText +=
        "but you do have enough Nullifium to purchase another Carried slot!</p><p>Would you like to purchase another Carried slot, leave this Heirloom equipped, ";
      costText +=
        "<div class='btn btn-success' onclick='cancelTooltip(); addCarried(true); unequipHeirloom();'>Buy a Slot (" +
        getNextCarriedCost() +
        " Nu)</div>";
    }
    tooltipText +=
      "or put it in Temporary Storage? <b>If you use your Portal while this Heirloom is in Temporary Storage, it will be recycled!</b></p>";
    costText +=
      "<div class='btn btn-info' id='confirmTooltipBtn' onclick='cancelTooltip()'>Leave it equipped</div><div class='btn btn-danger' onclick='cancelTooltip(); unequipHeirloom(null, \"heirloomsExtra\");'>Place in Temporary</div></div>";
  }
  if (what == "Configure AutoStructure") {
    ...
    for (var item in game.buildings) {
      ...
      if (item == "Laboratory" && game.global.challengeActive != "Nurture")
        continue;
    ...
    if (game.global.universe == 1) {
      ...
      if (getHighestLevelCleared() >= 229) {
        var nurserySetting =
          typeof settingGroup.NurseryZones !== "undefined"
            ? settingGroup.NurseryZones
            : 1;
        tooltipText +=
          "<td><div class='row'><div class='col-xs-12' style='text-align: right; padding-right: 5px;'>Don't buy Nurseries Until Z: <input style='width: 20.8%; margin-right: 4%;' class='structConfigQuantity' id='structZoneNursery' type='number' value='" +
          nurserySetting +
          "'></div></div></td>";
      }
      tooltipText += "</tr>";
    ...
    options =
      "<option value='0'>Apply Percent to All</option><option value='0.1'>0.1%</option><option value='1'>1%</option><option value='5'>5%</option><option value='10'>10%</option><option value='25'>25%</option><option value='50'>50%</option><option value='99'>99%</option>";
    tooltipText += "<tr style='text-align: center'>";
    tooltipText +=
      "<td><span data-nexton='true' onclick='toggleAllAutoStructures(this)' class='btn colorPrimary btn-md toggleAllBtn'>Toggle All Structures On</span></td>";
    tooltipText +=
      "<td><select class='toggleAllBtn' id='autoStructureAllPctSelect' onchange='setAllAutoStructurePercent(this)'>" +
      options +
      "</select></td>";

    tooltipText += "</tr></tbody></table>";
    costText =
      "<div class='maxCenter'><div id='confirmTooltipBtn' class='btn btn-info btn-lg' onclick='saveAutoStructureConfig()'>Apply</div><div class='btn-lg btn btn-danger' onclick='cancelTooltip()'>Cancel</div></div>";
    game.global.lockTooltip = true;
    ondisplay = function () {
      verticalCenterTooltip(false, true);
    };
  ...
  if (what == "Configure AutoEquip") {
    ...
    tooltipText +=
      "<td><span data-nexton='true' onclick='uncheckAutoEquip(\"Armor\", this)' class='toggleAllBtn btn colorPrimary btn-md'>Toggle All Armor On</span></td>";
    tooltipText +=
      "<td><select class='toggleAllBtn' onchange='setAllAutoEquipPercent(\"Armor\", this)'>" +
      options +
      "</select></td>";
    ...
    tooltipText +=
      "<td><span data-on='" +
      highestTierOn +
      "' onclick='toggleAutoEquipHighestTier(this)' id='highestTierOnlyBtn' class='toggleAllBtn btn color" +
      (highestTierOn ? "Success" : "Danger") +
      " btn-md'>Only Buy From Highest Tier" +
      (highestTierOn ? " On" : " Off") +
      "</span></td>";
    tooltipText +=
      "<td><span data-nexton='true' onclick='uncheckAutoEquip(\"Wep\", this)' class='toggleAllBtn btn colorPrimary btn-md'>Toggle All Weapons On</span></td>";
    tooltipText +=
      "<td><select class='toggleAllBtn' onchange='setAllAutoEquipPercent(\"Wep\", this)'>" +
      options +
      "</select></td>";
    tooltipText += "</tr></tbody></table>";

    costText =
      "<div class='maxCenter'><div id='confirmTooltipBtn' class='btn btn-lg btn-info' onclick='saveAutoEquipConfig()'>Apply</div><div class='btn btn-lg btn-danger' onclick='cancelTooltip()'>Cancel</div></div>";
    game.global.lockTooltip = true;
    elem.style.left = "25%";
    elem.style.top = "25%";
    ondisplay = function () {
  ...
  if (what == "AutoEquip") {
    tooltipText =
      "<p>The Auspicious Presence has blessed your Trimps with the ability to automatically upgrade their own equipment! Click the cog icon on the right side of this button to tell your Trimps what they should upgrade and when to do it, then click the left side of the button to tell them to start or stop.</p>";
    costText = "";
  }
  if (what == "Configure Generator State") {
    ...
    elem.style.top = "25%";
    tooltipText =
      "<div style='padding: 1.5vw;'><div style='color: red; font-size: 1.1em; text-align: center;' id='genStateConfigError'></div>";
    tooltipText +=
      "<div id='genStateConfigTooltip'>" +
      getGenStateConfigTooltip() +
      "</div>";
    costText =
      "<div class='maxCenter'><div id='confirmTooltipBtn' class='btn-lg btn btn-info' onclick='saveGenStateConfig()'>Apply</div><div class='btn btn-lg btn-danger' onclick='cancelTooltip()'>Cancel</div></div>";
  }
  if (what == "Rename SA Preset") {
    ...
    costText =
      "<div class='maxCenter'><div id='confirmTooltipBtn' onclick='autoBattle.savePresetName(" +
      textString +
      ")' class='btn-lg btn autoItemEquipped'>Save</div><div class='btn btn-lg autoItemHide' onclick='autoBattle.popup(false,false,false,true);'>Cancel</div>";
  }
  if (what == "Configure AutoJobs") {
    ...
    for (var x = 0; x < ratioJobs.length; x++) {
      ...
      var max;
      var checkbox = buildNiceCheckbox(
        "autoJobCheckbox" + item,
        "autoCheckbox",
        setting && setting.enabled
      );
      tooltipText +=
        ...
        "&nbsp;&nbsp;<span>" +
        item +
        "</span></div><div class='col-xs-6 lowPad' style='text-align: right'>Ratio: <input class='jobConfigQuantity' id='autoJobQuant" +
        item +
        "' type='number'  value='" +
        (setting && setting.ratio ? setting.ratio : 1) +
        "'/></div></div>";
      if (ratioJobs[x] == "Scientist") {
        max = setting && setting.buyMax ? setting.buyMax : 0;
        if (max > 1e4) max = max.toExponential().replace("+", "");
        sciMax = max;
        if (percentJobs.length < 4)
          tooltipText +=
            "</td><td style='width: 60%'><div class='row' style='width: 50%; border: 0; text-align: left;'><span style='padding-left: 0.4vw'>&nbsp;</span>Up To: <input class='jobConfigQuantity' id='autoJobQuant" +
            item +
            "' value='" +
            prettify(max) +
            "'/></div></td>";
      ...
      if (percentJobs.length > x) {
        ...
        var options =
          ...
          ">99%</option>";
        tooltipText +=
          "<td style='width: 60%'><div class='row'><div class='col-xs-5' style='padding-right: 5px'>" +
          checkbox +
          "&nbsp;&nbsp;<span>" +
          item +
          "</span></div><div style='text-align: center; padding-left: 0px;' class='col-xs-2'><select  id='autoJobSelect" +
          item +
          "'>" +
          options +
          "</select></div><div class='col-xs-5 lowPad' style='text-align: right'>Up To: <input class='jobConfigQuantity' id='autoJobQuant" +
          item +
          "'  value='" +
          prettify(max) +
          "'/></div></div></td></tr>";
    ...
    if (percentJobs.length >= 4)
      tooltipText +=
        "<tr><td style='width: 40%'><div class='row'><div class='col-xs-6' style='padding-right: 5px'>&nbsp;</div><div class='col-xs-6 lowPad' style='text-align: right'>Up To: <input class='jobConfigQuantity' id='autoJobQuantScientist2' value='" +
        prettify(sciMax) +
        "'></div></div></td><td style='width: 60%'>&nbsp;</td></tr>";
    tooltipText +=
      "<tr><td style='width: 40%'><div class='col-xs-7' style='padding-right: 5px'>Gather on Portal:</div><div class='col-xs-5 lowPad' style='text-align: right'><select style='width: 100%' id='autoJobSelfGather'><option value='0'>Nothing</option>";
    var values = ["Food", "Wood", "Metal", "Science"];
    for (var x = 0; x < values.length; x++) {
      tooltipText +=
        "<option" +
        (settingGroup.portalGather &&
        settingGroup.portalGather == values[x].toLowerCase()
          ? " selected='selected'"
          : "") +
        " value='" +
        values[x].toLowerCase() +
        "'>" +
        values[x] +
        "</option>";
    }
    ...
    costText =
      "<div class='maxCenter'><div id='confirmTooltipBtn' class='btn-lg btn btn-info' onclick='saveAutoJobsConfig()'>Apply</div><div class='btn btn-lg btn-danger' onclick='cancelTooltip()'>Cancel</div></div>";
    game.global.lockTooltip = true;
    elem.style.left = "33.75%";
    elem.style.top = "25%";
    ondisplay = function () {
  ...
  if (what == "AutoJobs") {
    tooltipText =
      "<p>Your continued mastery of this world has enabled you to set rules for automatic job allocation. Click the cog icon on the right side of this button to tell your Human Resourceimps what you want and when you want it, then click the left side of the button to tell them to start or stop.</p>";
    costText = "";
  }
  if (what == "AutoGold") {
    ...
    tooltipText +=
      "<p><b>AutoGold Void (" +
      game.goldenUpgrades.Void.purchasedAt.length +
      "/" +
      Math.round(game.goldenUpgrades.Void.currentBonus * 100) +
      "%)</b> which comes in 2 different flavors";
    if (getTotalPortals() == 0)
      tooltipText +=
        ", but you can't find Void Maps until you've found the Portal Device at least once, so you can't use them.</p>";
    else
      tooltipText +=
        ":<br/><b>" +
        voidHeName +
        "</b> - Will entrust your Scientists with purchasing as many Golden Voids as possible (to reach 72%) before switching to Golden " +
        heName +
        ", or...<br/><b>Voidtle</b> - Where your Scientists will again attempt to buy as many Golden Voids as possible (to reach 72%), but will instead switch to Golden Battle afterwards.</p>";
    if (game.global.canGuString)
      tooltipText +=
        "<p><b>Custom AutoGold</b> - For the advanced Trimp commander/archaeologist who wants even more control. <b>Ctrl Click to customize your string</b></p>";
    tooltipText +=
      "<p>Please allow 4 seconds for Trimp retraining after clicking this button before any Golden Upgrades are automatically purchased, and don't forget to frequently thank your scientists! Seriously, they get moody.</p>";
    costText = "";
  }
  if (what == "Unliving") {
    ...
    if (stacks > 130)
      tooltipText =
        "Your Trimps are looking quite dead, which is very healthy in this dimension. You're doing a great job!";
    else if (stacks > 75)
      tooltipText =
        "Your Trimps are starting to look more lively and slow down, but at least they're still fairly pale.";
    else if (stacks > 30)
      tooltipText =
        "The Bad Guys in this dimension seem to be way more dead than your Trimps!";
    else
      tooltipText =
        "Your Trimps look perfectly normal and healthy now, which is not what you want in this dimension.";
  ...
  if (what == "AutoGolden Unlocked") {
    ...
    costText =
      "<div class='maxCenter'><div id='confirmTooltipBtn' class='btn btn-info' onclick='cancelTooltip()'>Close</div></div>";
    game.global.lockTooltip = true;
    elem.style.left = "33.75%";
    elem.style.top = "25%";
  }
  if (what == "Poisoned") {
    tooltipText =
      "This enemy is harmed by the Empowerment of Poison, and is taking " +
      prettify(game.empowerments.Poison.getDamage()) +
      " extra damage per turn.";
    costText = "";
  }
  if (what == "Chilled") {
    tooltipText =
      "This enemy has been chilled by the Empowerment of Ice, is taking " +
      prettify(game.empowerments.Ice.getDamageModifier() * 100) +
      "% more damage, and is dealing " +
      prettify((1 - game.empowerments.Ice.getCombatModifier()) * 100) +
      "% less damage with each normal attack." +
      game.empowerments.Ice.overkillDesc();
    costText = "";
  }
  if (what == "Breezy") {
    var heliumText = !game.global.mapsActive
      ? "increasing all Helium gained by " +
        prettify(game.empowerments.Wind.getCombatModifier(true) * 100) +
        "% and all other"
      : "increasing all non-Helium ";
    tooltipText =
      "There is a rather large amount of Wind swelling around this enemy, " +
      heliumText +
      " resources by " +
      prettify(game.empowerments.Wind.getCombatModifier() * 100) +
      "%.";
    costText = "";
  }
  if (what == "Perk Preset") {
    if (textString == "Save") {
      ...
      tooltipText =
        "Click to save your current perk loadout to the selected preset";
    } else if (textString == "Rename") {
      what = "Rename Perk Preset";
      tooltipText =
        "Click to set a name for your currently selected perk preset";
      ...
      if (!game.global.respecActive)
        tooltipText +=
          " <p class='red'>You must have your Respec active to load a preset!</p>";
      ...
      tooltipText =
        "Click to export a copy of your current perk setup to share with friends, or to save and import later!";
      ...
      if (isObjectEmpty(preset)) {
        tooltipText =
          "<span class='red'>This Preset slot is empty!</span> Select this slot and then click 'Save' to save your current Perk configuration to this slot. You'll be able to load this configuration back whenever you want, as long as you have your Respec active.";
      } else {
        ...
        for (var item in preset) {
          ...
          tooltipText += count > 0 ? ", " : "";
          tooltipText +=
            "<b>" + item.replace("_", "&nbsp;") + ":</b>&nbsp;" + preset[item];
          count++;
        }
      }
    }
  ...
  if (what == "Rename Preset") {
    ...
    tooltipText =
      "Type a name below for your Perk Preset! This name will show up on the Preset bar and make it easy to identify which Preset is which.";
    ...
    tooltipText +=
      "<br/><br/><input id='renamePresetBox' maxlength='25' style='width: 50%' value='" +
      oldName +
      "' />";
    costText =
      "<div class='maxCenter'><div id='confirmTooltipBtn' class='btn btn-info' onclick='renamePerkPreset()'>Apply</div><div class='btn btn-info' onclick='cancelTooltip()'>Cancel</div></div>";
    game.global.lockTooltip = true;
    elem.style.left = "33.75%";
    elem.style.top = "25%";
    ondisplay = function () {
  ...
  if (what == "UnlockedChallenge2") {
    ...
    game.global.lockTooltip = true;
    costText =
      "<div class='maxCenter'><div class='btn btn-info' id='confirmTooltipBtn' onclick='cancelTooltip()'>Thanks, Scientists</div></div>";
    elem.style.left = "33.75%";
    elem.style.top = "25%";
  }
  ...
  if (what == "Eggs") {
    tooltipText =
      '<span class="eggMessage">It seems as if some sort of animal has placed a bunch of brightly colored eggs in the world. If you happen to see one, you can click on it to send a Trimp to pick it up! According to your scientists, they have a rare chance to contain some neat stuff, but they will not last forever...</span>';
    game.global.lockTooltip = true;
    costText =
      "<div class='maxCenter'><div class='btn btn-info' id='confirmTooltipBtn' onclick='cancelTooltip()'>I'll keep an eye out.</div></div>";
    elem.style.left = "33.75%";
    elem.style.top = "25%";
  }
  if (what == "Portal") {
    tooltipText =
      "The portal device you found shines " +
      (game.global.universe == 1 ? "green" : "blue") +
      " in the lab. Such a familiar shade... (Hotkey: T)";
    costText = "";
  }
  if (what == "Repeat Map") {
    tooltipText =
      "Allow the Trimps to find their way back to square 1 once they finish without your help. They grow up so fast. <br/><br/>If you are <b>not</b> repeating, your current group of Trimps will not be abandoned after the map ends. (Hotkey: R)";
    costText = "";
  }
  if (what == "Challenge2") {
    var sup =
      portalUniverse == 1 || game.global.highestRadonLevelCleared < 49
        ? "2"
        : "3";
    ...
    if (portalUniverse == 2 && game.global.highestRadonLevelCleared < 49) {
      tooltipText =
        "<p><b style='color: #003b99'>Reach Zone 50 in Universe 2 to unlock Challenge<sup>3</sup>, which combine multiplicatively with your Challenge<sup>2</sup>. Just imagine the possibilities!</b></p>";
    } else {
      if (!textString)
        tooltipText =
          "<p>Click to toggle a challenge mode for your challenges!</p>";
      tooltipText +=
        "<p>In Challenge<sup>" +
        sup +
        ...
        (sup == 2
          ? "attack and health and " +
            prettify(rewardEach / 10) +
            "% increased " +
            heliumOrRadon()
          : "Challenge<sup>" + sup + "</sup> bonus") +
        " for every " +
        ...
        " Zones, " +
        (sup == 2
          ? "the attack and health bonus will increase by an additional " +
            rewardGrowth +
            "%, and the " +
            heliumOrRadon() +
            " bonus will increase by " +
            prettify(rewardGrowth / 10) +
            "%"
          : "this bonus will increase by an additional " + rewardGrowth + "%") +
    ...
    if (game.global.highestRadonLevelCleared >= 49) {
      ...
      tooltipText +=
        "<p>You are currently gaining " +
        prettify(game.global.totalSquaredReward) +
        "% extra attack and health, and are gaining " +
        prettify(game.global.totalSquaredReward / 10) +
        "% extra " +
        heliumOrRadon() +
        " thanks to your Challenge<sup>" +
        sup +
        "</sup> bonus.</p>";
    if (game.talents.headstart.purchased)
      tooltipText +=
        "<p><b>Note that your Headstart mastery will be disabled during Challenge<sup>" +
        sup +
        "</sup> runs.</b></p>";
    if (portalUniverse == 1 && uniArray[0] >= 35000) {
      ...
      var extra =
        uniArray[0] >= 60000
          ? " You've reached this bonus and are officially done with Challenge<sup>2</sup>! Congratulations!"
          : "";
      tooltipText +=
        "<p><b" +
        color +
        ">Note that Challenge<sup>2</sup> Bonus is capped at " +
        prettify(60000) +
        "%." +
        extra +
        "</b></p>";
    ...
    if (isItIn == null) {
      ...
      tooltipText =
        ...
        buildNiceCheckbox(
          ...
          null,
          game.options.menu.GeneticistassistTarget.disableOnUnlock
        ) +
        "&nbsp;Start disabled when unlocked each run</div></div>";
      costText =
        "<div class='maxCenter'><div class='btn btn-info' id='confirmTooltipBtn' onclick='customizeGATargets();'>Confirm</div> <div class='btn btn-danger' onclick='cancelTooltip()'>Cancel</div></div>";
      elem.style.left = "33.75%";
      elem.style.top = "25%";
    }
  }
  if (what == "Configure Maps") {
    if (isItIn == null) {
      ...
      var steps = game.global.GeneticistassistSteps;
      tooltipText =
        "<div id='GATargetError'></div><div>Customize your settings for running maps!</div>";
      tooltipText += "<hr class='noBotMarg'/><div class='maxCenter'>";
      var settingCount = 0;
      if (game.global.totalPortals >= 1) {
        tooltipText += getSettingHtml(
          game.options.menu.mapLoot,
          "mapLoot",
          null,
          "CM"
        );
      ...
      tooltipText +=
        '<div class="optionContainer"><div class="noselect settingsBtn ' +
        (game.global.repeatMap ? "settingBtn1" : "settingBtn0") +
        '" id="repeatBtn2" onmouseover="tooltip(\'Repeat Map\', null, event)" onmouseout="tooltip(\'hide\')" onclick="repeatClicked()">' +
        (game.global.repeatMap ? "Repeat On" : "Repeat Off") +
        "</div></div>";
      settingCount++;
      if (settingCount % 2 == 0) tooltipText += "<br/><br/>";
      tooltipText += getSettingHtml(
        game.options.menu.repeatUntil,
        "repeatUntil",
        null,
        "CM"
      );
      ...
      settingCount++;
      if (
        game.options.menu.mapsOnSpire.lockUnless() &&
        game.global.universe == 1
      ) {
        if (settingCount % 2 == 0) tooltipText += "<br/><br/>";
        tooltipText += getSettingHtml(
          game.options.menu.mapsOnSpire,
          "mapsOnSpire",
          null,
          "CM"
        );
      ...
      if (settingCount % 2 == 0) tooltipText += "<br/><br/>";
      tooltipText += getSettingHtml(
        game.options.menu.extraMapBtns,
        "extraMapBtns",
        null,
        "CM"
      );
      ...
      tooltipText += "</div>";
      costText =
        "<div class='maxCenter'><div class='btn btn-info' id='confirmTooltipBtn' onclick='cancelTooltip();'>Close</div></div>";
      elem.style.left = "33.75%";
      elem.style.top = "25%";
    }
  }
  if (what == "Set Map At Zone") {
    ...
    for (var x = 0; x < maxSettings; x++) {
      ...
      if (
        ...
        presetDropdown +=
          "<option value='8'" +
          (vals.preset == 8 ? " selected='selected'" : "") +
          ">Melting Point</option>";
      if (
        game.global.universe == 2 &&
        ...
        presetDropdown +=
          "<option value='5'" +
          (vals.preset == 5 ? " selected='selected'" : "") +
          ">Black Bog</option>";
      if (
        game.global.universe == 2 &&
        game.global.highestRadonLevelCleared >= 174
      )
        presetDropdown +=
          "<option value='9'" +
          (vals.preset == 9 ? " selected='selected'" : "") +
          ">Frozen Castle</option>";
      var repeatDropdown =
        "<option value='0'" +
        (vals.repeat == 0 ? " selected='selected'" : "") +
        ">No Change</option><option value='1'" +
        (vals.repeat == 1 ? " selected='selected'" : "") +
        ">On</option><option value='2'" +
        (vals.repeat == 2 ? " selected='selected'" : "") +
        ">Off</option>";
      var repeatUntilDropdown =
        "<option value='0'" +
      ...
      var exitDropdown =
        "<option value='0'" +
        (vals.exit == 0 ? " selected='selected'" : "") +
        ">No Change</option><option value='1'" +
        (vals.exit == 1 ? " selected='selected'" : "") +
        ">Maps</option><option value='2'" +
        (vals.exit == 2 ? " selected='selected'" : "") +
        ">World</option>";
      var timesDropdown =
        "<option value='-1'" +
      ...
      className +=
        vals.preset == 3 && vals.until == 5 ? " mazBwZoneOn" : " mazBwZoneOff";
      ...
      tooltipText +=
        ...
        ">";
      tooltipText +=
        "<div class='mazDelete' onclick='game.options.menu.mapAtZone.removeRow(" +
        x +
        ")'><span class='icomoon icon-cross'></span></div>";
      tooltipText +=
        "<div class='mazCheckbox' style='text-align: center;'>" +
        buildNiceCheckbox("mazEnableSetting" + x, null, vals.on) +
        "</div>";
      tooltipText +=
        "<div class='mazWorld'><input value='" +
        vals.world +
        "' type='number' id='mazWorld" +
        x +
        "'/></div>";
      tooltipText +=
        "<div class='mazThrough'><input value='" +
        vals.through +
        "' type='number' id='mazThrough" +
        x +
        "'/></div>";
      tooltipText +=
        "<div class='mazCell'><input value='" +
        vals.cell +
        "' type='number' id='mazCell" +
        x +
        "'/></div>";
      tooltipText +=
        "<div class='mazPrio'><input value='" +
        vals.prio +
        "' type='number' id='mazPrio" +
        x +
        "'/></div>";
      tooltipText +=
        "<div class='mazCheckbox' style='text-align: center;'>" +
        buildNiceCheckbox("mazCheckbox" + x, null, vals.check) +
        "</div>";
      tooltipText +=
        "<div class='mazPreset' onchange='updateMazPreset(" +
        x +
        ")'><select value='" +
        vals.preset +
        "' id='mazPreset" +
        ...
        "</select></div>";
      tooltipText +=
        "<div class='mazRepeat'><select value='" +
        vals.repeat +
        "' id='mazRepeat" +
        x +
        "'>" +
        ...
        "</select></div>";
      tooltipText +=
        "<div class='mazRepeatUntil' onchange='updateMazPreset(" +
        x +
        ")'><select value='" +
        vals.until +
        "' id='mazRepeatUntil" +
        ...
        "</select></div>";
      tooltipText +=
        "<div class='mazRx'><div style='text-align: center;'>X&nbsp;Times</div><input value='" +
        vals.rx +
        "' type='number' id='mazRx" +
        x +
        "'/></div>";
      tooltipText +=
        "<div class='mazBwWorld'><div style='text-align: center; margin-left: -0.5vw;'>Climb&nbsp;To</div><input value='" +
        vals.bwWorld +
        "' type='number' id='mazBwWorld" +
        x +
        "'/></div>";
      tooltipText +=
        "<div class='mazExit'><select value='" +
        vals.exit +
        "' id='mazExit" +
        x +
        "'>" +
        ...
        "</select></div>";
      tooltipText +=
        "<div class='mazTimes select' onchange='updateMazPreset(" +
        x +
        ")'><select value='" +
        vals.times +
        "' id='mazTimes" +
        ...
        "</select></div>";
      tooltipText +=
        "<div class='mazTx'><div style='text-align: center;'>X&nbsp;Zones</div><input value='" +
        vals.tx +
        "' type='number' id='mazTx" +
        x +
        "'/></div>";
      tooltipText += "</div>";
    }
    tooltipText +=
      "<div id='mazAddRowBtn' style='display: " +
      (current.length < maxSettings ? "inline-block" : "none") +
      "' class='btn btn-success btn-md' onclick='game.options.menu.mapAtZone.addRow()'>+ Add Row</div>";
    var currentPreset =
      (game.global.universe == 1 &&
        game.options.menu.mapAtZone.U1Mode == "a") ||
      (game.global.universe == 2 && game.options.menu.mapAtZone.U2Mode == "a")
        ? "a"
        : "b";
    tooltipText +=
      "<div id='mazSwapPresetBtn' style='display: " +
      (game.talents.maz.purchased ? "inline-block" : "none") +
      "' class='btn btn-" +
      (currentPreset == "a" ? "info" : "danger") +
      " btn-md' onclick='game.options.menu.mapAtZone.swapPreset()'>Swap to Preset " +
      (currentPreset == "a" ? "B" : "A") +
      "</div>";
    tooltipText +=
      "</div><div style='display: none' id='mazHelpContainer'>" +
      mazHelp +
      "</div>";
    costText =
      "<div class='maxCenter'><span class='btn btn-success btn-md' id='confirmTooltipBtn' onclick='game.options.menu.mapAtZone.save()'>Save and Close (Z/Enter)</span><span class='btn btn-danger btn-md' onclick='cancelTooltip(true)'>Cancel (Esc)</span><span class='btn btn-primary btn-md' id='confirmTooltipBtn' onclick='game.options.menu.mapAtZone.save(true)'>Save</span><span class='btn btn-info btn-md' onclick='game.options.menu.mapAtZone.toggleHelp()'>Help</span></div>";
    game.global.lockTooltip = true;
    elem.style.top = "25%";
    elem.style.left = "10%";
  ...
  if (what == "Change Heirloom Icon") {
    ...
    var icons = [];
    tooltipText =
      "<div style='width: 100%; height: 100%; background-color: black; text-align: center;'>";
    ...
    for (var x = 0; x < icons.length; x++) {
      tooltipText +=
        "<div class='heirloomChangeIcon heirloomRare" +
        heirloom.rarity +
        "' onclick='saveHeirloomIcon(\"" +
        icons[x] +
        "\")'>" +
        convertIconNameToSpan(icons[x]) +
        "</div>";
    }
    tooltipText += "</div>";
    game.global.lockTooltip = true;
    ...
    elem.style.top = "25%";
    costText =
      "<div class='maxCenter'><span class='btn btn-success btn-md' id='confirmTooltipBtn' onclick='cancelTooltip(true)'>Close</span></div>";
  }
  if (what == "Change Portal Color") {
    ...
    for (var x = 1; x < tiers + 1; x++) {
      var selected =
        game.global.portalColor == x || (game.global.portalColor == 0 && x == 6)
          ? " selected"
          : "";
      tooltipText +=
        "<div class='pointer portalPreview portalMk" +
        x +
        selected +
        "' onclick='savePortalColor(" +
        x +
        ")'>" +
        x +
        "</div>";
  ...
  if (what == "Message Config") {
    tooltipText =
      "<div id='messageConfigMessage'>Here you can finely tune your message settings, to see only what you want from each category. Mouse over the name of a filter for more info.</div>";
    ...
    for (var x = 0; x < toCheck.length; x++) {
      var name = toCheck[x];
      tooltipText +=
        "<div class='col-xs-4'><span class='messageConfigTitle'>" +
        toCheck[x] +
        "</span><br/>";
      for (var item in msgs[name]) {
        if (item == "essence" && game.global.highestLevelCleared < 179)
          continue;
        ...
        if (item == "exp" && game.global.highestRadonLevelCleared < 49)
          continue;
        ...
        tooltipText +=
          "<span class='messageConfigContainer'><span class='messageCheckboxHolder'>" +
          buildNiceCheckbox(
            name + item,
            "messageConfigCheckbox",
            msgs[name][item]
          ) +
          "</span><span onmouseover='messageConfigHover(\"" +
          name +
          item +
          "\", event)' onmouseout='tooltip(\"hide\")' class='messageNameHolder'> - " +
    ...
    swapClass("tooltipExtra", "tooltipExtraLg", elem);
    costText =
      "<div class='maxCenter'><div class='btn btn-info' id='confirmTooltipBtn' onclick='cancelTooltip();configMessages();'>Confirm</div> <div class='btn btn-danger' onclick='cancelTooltip()'>Cancel</div></div>";
  }
  if (what == "Hotkeys") {
    tooltipText =
      "<table id='keybindsTable' class='table table-striped'><tbody>";
    tooltipText +=
      "<tr><td class='keybindsTitle' colspan='4'>General</td></tr>";
    tooltipText += "<tr><td>K/k</td><td>Show Hot(K)eys menu</td><td>";
    if (game.global.totalPortals > 0 || game.global.portalActive)
      tooltipText += "T/t</td><td>Open Por(T)al Window";
    else tooltipText += "</td><td>";
    tooltipText += "</td></tr>";
    tooltipText +=
      "<tr><td>F5</td><td>Reload the game to the last saved point</td><td>";
    if (game.stats.totalHeirlooms.valueTotal > 0)
      tooltipText += "L/l</td><td>Open Heir(L)ooms Window";
    else tooltipText += "</td><td>";
    tooltipText += "</td></tr>";
    tooltipText += "<tr><td>F11</td><td>Toggle Fullscreen</td><td>";
    if (game.stats.totalHeirlooms.valueTotal > 0)
      tooltipText += "C/c</td><td>Show Heirloom (C)hances on Heirlooms Window";
    else tooltipText += "</td><td>";
    tooltipText += "</td></tr>";
    tooltipText +=
      "<tr><td>Space</td><td>Pause (if enabled in settings)</td><td>";
    if (game.permaBoneBonuses.boosts.owned > 0)
      tooltipText += "O/o</td><td>W(O)rship Bone Shrine";
    else tooltipText += "</td><td>";
    tooltipText += "</td></tr>";
    tooltipText += "<tr><td>F/f</td><td>(F)ight</td><td>";
    if (!game.portal.Equality.radLocked)
      tooltipText += "E/e</td><td>(E)quality";
    else tooltipText += "</td><td>";
    tooltipText += "</td></tr>";
    tooltipText += "<tr><td>A/a</td><td>Toggle (A)utoFight</td><td>";
    if (game.global.highestRadonLevelCleared >= 74)
      tooltipText += "I/i</td><td>Sp(I)re Assault";
    else tooltipText += "</td><td>";
    tooltipText += "</td></tr>";
    tooltipText +=
      "<tr><td>Left/Right</td><td>Usable on windows with <span class='icomoon icon-arrow-left'></span> and <span class='icomoon icon-arrow-right'></span> icons</td><td></td><td></td></tr>";
    tooltipText +=
      "<tr><td>V</td><td>Open AD(V)ISOR</td><td></td><td></td></tr>";
    tooltipText +=
      "<tr><td>Esc</td><td>Close popups/menus. Open Settings if nothing else is open</td><td></td><td></td></tr>";
    if (game.global.highestLevelCleared >= 5) {
      tooltipText += "<tr><td class='keybindsTitle' colspan='4'>Maps</td></tr>";
      tooltipText +=
        "<tr><td>M/m</td><td>Toggle (M)aps</td><td>R/r</td><td>Toggle Map (R)epeat</td></tr>";
      tooltipText +=
        "<tr><td>Up</td><td>Increase Map level</td><td>Down</td><td>Decrease Map level</td></tr>";
    ...
    if (game.global.highestLevelCleared >= 60) {
      tooltipText +=
        "<tr><td class='keybindsTitle' colspan='4'>Formations</td></tr>";
      tooltipText +=
        "<tr><td>X/x/1/Num1</td><td>No Formation</td><td>H/h/2/Num2</td><td>(H)eap</td></tr>";
      if (
        game.global.highestLevelCleared >= 70 ||
        game.upgrades.Dominance.done > 0
      ) {
        tooltipText += "<tr><td>D/d/3/Num3</td><td>(D)ominance</td><td>";
        if (
          game.global.highestLevelCleared >= 80 ||
          game.upgrades.Barrier.done > 0
        )
          tooltipText += "B/b/4/Num4</td><td>(B)arrier";
        else tooltipText += "</td><td>";
        tooltipText += "</td></tr>";
      }
      if (game.global.highestLevelCleared >= 179) {
        tooltipText += "<tr><td>S/s/5/Num5</td><td>(S)cryer</td><td>";
        if (game.global.highestLevelCleared >= 239)
          tooltipText += "W/w/6/Num6</td><td>(W)ind";
        else tooltipText += "</td><td>";
        tooltipText += "</td></tr>";
      }
    }
    if (game.global.spiresCompleted > 0) {
      tooltipText +=
        "<tr><td class='keybindsTitle' colspan='4'>Personal Spire</td></tr>";
      tooltipText +=
        "<tr><td>P/p</td><td>Open S(P)ire</td><td>0/Num0</td><td>Sell a trap/tower</td></tr>";
      tooltipText +=
        "<tr><td>1-7/Num1-Num7</td><td colspan='3'>Buy a Trap/Tower</td></tr>";
    }
    tooltipText += "</tbody></table>";
    ondisplay = function () {
      verticalCenterTooltip();
    ...
    costText =
      "<div class='maxCenter'><div class='btn btn-danger' onclick='cancelTooltip()'>Close</div></div>";
  }
  if (isItIn == "goldenUpgrades") {
    ...
    var three =
      ...
      (game.global.universe == 2 && game.global.totalRadPortals == 0)
        ? "three"
        : "two";
    tooltipText +=
      " <b>You can only choose one of these " +
      three +
      " Golden Upgrades. Choose wisely...</b><br/><br/> Each time Golden Upgrades are unlocked, they will increase in strength. You are currently gaining " +
      Math.round(upgrade.currentBonus * 100) +
      "% from purchasing this upgrade " +
      timesPurchased +
      " time" +
      s +
      " since your last portal.";
    if (
      what == "Void" &&
      parseFloat(
        (
      ...
      tooltipText +=
        "<br/><br/><b class='red'>This upgrade would put you over 72% increased Void Map chance, which would destabilize the universe. You don't want to destabilize the universe, do you?</b>";
    else if (what == "Void")
      tooltipText +=
        "<br/><br/><b class='green'>Note: The absolute maximum value for Golden Void is +72%. Golden Void will no longer be able to be purchased if it would increase your bonus above 72%. Plan carefully!</b>";
    if (what == "Helium" && game.global.runningChallengeSquared) {
      var cMode = game.global.universe == 1 ? 2 : 3;
      tooltipText +=
        "<br/><br/><b class='red'>You can't earn " +
        heliumOrRadon() +
        " while running a Challenge<sup>" +
        cMode +
        "</sup>!</b>";
    }
    costText = "Free";
    if (getAvailableGoldenUpgrades() > 1)
      costText += " (" + getAvailableGoldenUpgrades() + " remaining)";
  ...
  if (isItIn == "Mutator") {
    ...
    if (game.global.mutatedSeeds < nextPrice && !mutator.purchased) {
      costText =
        "You need " +
        prettify(nextPrice - game.global.mutatedSeeds) +
        " more Seeds to afford this!";
      problem = true;
    }
    if (!u2Mutations.checkRequirements(what, true)) {
      ...
      if (missingRequire.length) {
        ...
        var listText = mutator.singleRequire
          ? listWithAnd(missingRequire, "-or-")
          : listWithAnd(missingRequire);
    ...
    if (
      mutator.ring &&
      mutator.ring > 0 &&
      u2Mutations.purchaseCount < u2Mutations.rings[mutator.ring]
    ) {
      if (problem) costText += "<br/>";
  ...
  if (isItIn == "talents") {
    ...
    if (ctrlPressed) {
      ...
      if (thisTierTalents == 6) {
        costText =
          "<span class='green'>You have already purchased this tier!</span>";
      } else if (isIdeal) {
        costText =
          "<span class='green'>You must buy this entire tier to be able to spend all of your Dark Essence.</span>";
      } else if (isAffordable) {
        costText =
          "<span class='green'>You can afford to purchase this entire tier!</span> <span class='red'>However, purchasing this entire tier right now may limit which other Masteries you can reach.</span>";
      } else {
        costText =
          "<span class='red'>You cannot afford to purchase this entire tier.</span>";
      }
    } else {
      if (talent.purchased)
        ...
        if (
          getAllowedTalentTiers()[talent.tier - 1] < 1 &&
          thisTierTalents < 6
        ) {
          costText = "<span style='color: red'>Locked";
          var lastTierTalents = countPurchasedTalents(talent.tier - 1);
          if (lastTierTalents <= 1)
            costText +=
              " (Buy " +
              (lastTierTalents == 0 ? "2 Masteries" : "1 more Mastery") +
              " from Tier " +
              (talent.tier - 1) +
              " to unlock Tier " +
              talent.tier;
            ...
            costText +=
              " (Buy 1 more Mastery from Tier " +
              (talent.tier - 1) +
              " to unlock the next from Tier " +
              talent.tier;
          if (requiresText)
            costText += ". This Mastery also requires " + requiresText;
          costText += ")</span>";
        } else if (requiresText)
          costText =
            "<span style='color: red'>Requires " + requiresText + "</span>";
        else if (
          game.global.essence < nextTalCost &&
          prettify(game.global.essence) != prettify(nextTalCost)
        )
          costText =
            "<span style='color: red'>" +
            prettify(nextTalCost) +
            " Dark Essence (Use Scrying Formation to earn more)</span>";
        else {
          costText = prettify(nextTalCost) + " Dark Essence";
          if (canPurchaseRow(talent.tier)) {
            costText +=
              "<br/><b style='color: black; font-size: 0.8vw;'>You can afford to purchase this whole row! Hold Ctrl when clicking to buy this entire row and any uncompleted rows before it.</b>";
          }
        }
      }
    }
  ...
  if (what == "Mastery") {
    if (game.global.tabForMastery)
      tooltipText =
        "<p>Click to view your masteries.</p><p>You currently have <b>" +
        prettify(game.global.essence) +
        "</b> Dark Essence.</p>";
    else {
      what = "Mutators";
      tooltipText =
        "<p>Click to view your Mutators.</p><p>You currently have <b>" +
  ...
  if (what == "The Improbability") {
    tooltipText =
      "<span class='planetBreakMessage'>That shouldn't have happened. There should have been a Blimp there. Something is growing unstable.</span>";
    if (!game.global.autoUpgradesAvailable)
      tooltipText +=
        "<br/><br/><span class='planetBreakMessage'><b>Your Trimps seem to understand that they'll need to help out more, and you realize how to permanently use them to automate upgrades!<b></span><br/>";
    costText =
    ...
    if (game.global.challengeActive == "Corrupted")
      costText +=
        "<br/><br/><span class='corruptedBadGuyName'>Looks like the Corruption is starting early...</span>";
    costText +=
      "<hr/><div class='maxCenter'><div class='btn btn-info' id='confirmTooltipBtn' onclick='cancelTooltip()'>I'll be fine</div><div class='btn btn-danger' onclick='cancelTooltip(); message(\"Sorry\", \"Notices\")'>I'm Scared</div></div>";
    game.global.lockTooltip = true;
    elem.style.left = "33.75%";
    elem.style.top = "25%";
  }
  if (what == "Corruption") {
    if (game.global.challengeActive == "Corrupted") {
      tooltipText =
        "<span class='planetBreakMessage'>Though you've seen the Corruption grow since the planet broke, you can now see a giant spire pumping out tons of the purple goo. Things seem to be absorbing it at a higher rate now.</span><br/>";
      costText +=
        "<span class='planetBreakDescription'><span class='bad'>Improbabilities and Void Maps are now more difficult.</span> <span class='good'>Improbabilities and Void Maps now drop 2x helium.</span></span>";
    } else {
      tooltipText = game.talents.headstart.purchased
        ? "Off in the distance, you can see a giant spire grow larger as you approach it."
        : "You can now see a giant spire only about 20 Zones ahead of you.";
      tooltipText =
        "<span class='planetBreakMessage'>" +
        tooltipText +
        " Menacing plumes of some sort of goopy gas boil out of the spire and appear to be tainting the land even further. It looks to you like the Zones are permanently damaged, poor planet. You know that if you want to reach the spire, you'll have to deal with the goo.</span><br/>";
      costText =
    ...
    costText +=
      "<hr/><div class='maxCenter'><div class='btn btn-info' id='confirmTooltipBtn' onclick='cancelTooltip()'>Bring it on</div></div>";
    game.global.lockTooltip = true;
    elem.style.left = "33.75%";
    elem.style.top = "25%";
  }
  if (what == "A Whole New World") {
    ...
    costText +=
      "<div class='maxCenter'><div class='btn btn-info' id='confirmTooltipBtn' onclick='cancelTooltip()'>Bring it on</div></div>";
    game.global.lockTooltip = true;
    elem.style.left = "33.75%";
    elem.style.top = "25%";
  }
  if (what == "Change Universe") {
    ...
    tooltipText =
      "Click this button to have your next Portal bring you to Universe " +
      nextUniverse +
      " - The " +
      newResource +
      " Universe. " +
      ...
      " Perks and " +
      oldPet +
      " can't come with you, but " +
      oldPet +
      "'s good pal " +
      newPet +
      " will be waiting for you.";
    if (game.global.totalSquaredReward < 15000 && portalUniverse == 1)
      tooltipText +=
        "<br/><br/><span style='color: red'>" +
        oldPet +
        " suggests having at least 15,000% Challenge<sup>2</sup> reward bonus before heading to Universe 2, but he trusts you to make your own decisions!</span>";
    if (portalUniverse == 1 && game.global.totalRadonEarned == 0)
      tooltipText +=
        "<br/><br/><b>You will earn Radon instead of Helium in Universe 2. It's an entirely new Universe to explore!</b>";
  }
  if (what == "The Spire") {
    tooltipText =
    ...
    if (game.options.menu.mapsOnSpire.enabled)
      tooltipText +=
        "<br/><hr/>You were moved to Maps to protect your limited chances at the spire. You can disable this in settings!";
    costText =
      "<div class='maxCenter'><div class='btn btn-info' onclick='startSpire(true)'>The Universe Awaits</div></div>";
    game.global.lockTooltip = true;
    elem.style.left = "33.75%";
    elem.style.top = "25%";
  }
  if (what == "The Magma") {
    ...
    costText +=
      "<div class='maxCenter'><div class='btn btn-info' id='confirmTooltipBtn' onclick='cancelTooltip()'>K</div></div>";
    game.global.lockTooltip = true;
    elem.style.left = "33.75%";
    elem.style.top = "25%";
  }
  if (what == "The Mutated Zones") {
    ...
    costText +=
      "<div class='maxCenter'><div class='btn btn-info' id='confirmTooltipBtn' onclick='cancelTooltip()'>Easy</div></div>";
    game.global.lockTooltip = true;
    elem.style.left = "33.75%";
    elem.style.top = "25%";
  }
  if (what == "Exit Spire") {
    tooltipText =
      "This will exit the spire, and you will be unable to re-enter until your next portal. Are you sure?";
    costText =
      "<div class='maxCenter'><div id='confirmTooltipBtn' class='btn btn-info' onclick='cancelTooltip(); endSpire()'>Exit Spire</div><div class='btn btn-danger' onclick='cancelTooltip()'>Cancel</div></div>";
    game.global.lockTooltip = true;
    elem.style.left = "33.75%";
    elem.style.top = "25%";
  }
  if (what == "Confirm Respec Masteries") {
    if (!textString)
      tooltipText =
        "This will return all Dark Essence that was spent on Masteries at the cost of 20 bones. Are you sure?";
    else
      tooltipText =
        "This will return all Dark Essence that was spent on Masteries, and will use " +
        (game.global.freeTalentRespecs > 1 ? "one of " : "") +
        "your remaining " +
        game.global.freeTalentRespecs +
        " free Mastery Respec" +
        needAnS(game.global.freeTalentRespecs) +
        ".";
    costText =
      "<div class='maxCenter'><div id='confirmTooltipBtn' class='btn btn-info' onclick='cancelTooltip(); respecTalents(true)'>Respec</div><div class='btn btn-danger' onclick='cancelTooltip()'>Cancel</div></div>";
    game.global.lockTooltip = true;
    elem.style.left = "33.75%";
    elem.style.top = "25%";
  }
  if (what == "Respec Masteries") {
    tooltipText =
      "<p>Click to Respec, refunding all Dark Essence that was spent on Masteries.<p>";
    if (game.global.freeTalentRespecs > 0)
      tooltipText +=
        "<p>Your first 3 Respecs are free, and you still have " +
        game.global.freeTalentRespecs +
        " left! When there are no more left, each respec will cost 20 Bones.";
    costText =
      game.global.freeTalentRespecs > 0
        ? "Free!"
        : (game.global.b >= 20
            ? "<span class='green'>"
            : "<span class='red'>") + "20 Bones</span>";
  }
  if (what == "The Geneticistassist") {
    tooltipText =
      "Greetings, friend! I'm your new robotic pal <b>The Geneticistassist</b> and I am here to assist you with your Geneticists. I will hang out in your Jobs tab, and will appear every run after Geneticists are unlocked. You can customize me in Settings under 'General'!";
    costText =
      "<div class='maxCenter'><div class='btn btn-info' id='confirmTooltipBtn' onclick='cancelTooltip()'>Thanks, Geneticistassist!</div></div>";
    game.global.lockTooltip = true;
    elem.style.left = "33.75%";
    elem.style.top = "25%";
  }
  if (what == "MagnetoShriek") {
    var shriekValue = (
      (1 - game.mapUnlocks.roboTrimp.getShriekValue()) *
      100
    ).toFixed(1);
    ...
    tooltipText =
      "Your pet RoboTrimp seems to be gifted at distorting the magnetic field around certain Bad Guys, especially " +
      plural +
      ". You can activate this ability once every 5 Zones in order to tell your RoboTrimp to reduce the attack damage of the next " +
      bossName +
      " by " +
      shriekValue +
      "%. This must be reactivated each time it comes off cooldown.";
    tooltipText +=
      "<span id='roboTrimpTooltipActive' style='font-weight: bold'><br/><br/>";
    tooltipText += game.global.useShriek
      ? "MagnetoShriek is currently active and will fire on the next " +
        bossName +
        "."
      : "MagnetoShriek is NOT active and will not fire.";
    tooltipText += "</span>";
    costText = "";
    //elem.style.top = "55%";
  }
  if (what == "Reset") {
    tooltipText =
      "Are you sure you want to reset? This will really actually reset your game. You won't get anything cool. It will be gone. <b style='color: red'>This is not the soft-reset you're looking for. This will delete your save.</b>";
    costText =
      "<div class='maxCenter'><div class='btn btn-danger' onclick='resetGame(false, true);unlockTooltip();tooltip(\"hide\")'>Delete Save</div> <div class='btn btn-info' onclick='cancelTooltip()'>Cancel</div></div>";
    game.global.lockTooltip = true;
    elem.style.left = "33.75%";
    elem.style.top = "25%";
  }
  if (what == "Fight") {
    tooltipText =
      "Send your poor Trimps to certain doom in the battlefield. You'll get cool stuff though, they'll understand. (Hotkey: F)";
  ...
  if (what == "AutoFight") {
    tooltipText =
      "Allow your Trimps to start fighting on their own whenever their town gets overcrowded. (Hotkey: A)";
    costText = "";
  }
  if (what == "New Achievements") {
    tooltipText =
      "The universe has taken an interest in your achievements, and has begun tracking them. You already have some completed thanks to your previous adventures, would you like to see them?";
    costText =
      "<div class='maxCenter'><div class='btn btn-success' onclick='toggleAchievementWindow(); cancelTooltip()'>Check Achievements</div> <div class='btn btn-danger' onclick='cancelTooltip()'>No, That Sounds Dumb</div></div>";
    game.global.lockTooltip = true;
    elem.style.left = "33.75%";
    elem.style.top = "25%";
  }
  if (what == "Upgrade Generator") {
    ...
    costText =
      ...
      getMagmiteDecayAmt() +
      "% of your unspent Magmite will decay on portal.</b><br/><br/><div class='maxCenter'><span class='btn btn-info' onclick='cancelTooltip()'>Close</span></div>";
    game.global.lockTooltip = true;
    elem.style.left = "33.75%";
    elem.style.top = "25%";
    ondisplay = function () {
    ...
    titleText =
      "<div id='generatorUpgradeTitle'>Upgrade Generator</div><div id='magmiteOwned'></div>";
  }
  if (what == "Queue") {
    tooltipText =
      'This is a building in your queue, you\'ll need to click "Build" to build it. Clicking an item in the queue will cancel it for a full refund.';
    costText = "";
  }
  if (what == "Toxic" && isItIn != "dailyStack") {
    tooltipText =
      "This Bad Guy is toxic. You will obtain " +
      (
        game.challenges.Toxicity.lootMult * game.challenges.Toxicity.stacks
      ).toFixed(1) +
      "% more resources! Oh, also, this Bad Guy has 5x attack, 2x health, your Trimps will lose 5% health each time they attack, and the toxic air is causing your Trimps to breed " +
      (
        100 -
        Math.pow(
      ...
      "% slower. These stacks will reset after clearing the Zone.";
    costText = "";
  }
  if (what == "Momentum") {
    ...
    tooltipText =
      "This Bad Guy has " +
      prettify(stacks * 4) +
      "% more damage and health, pierces an additional " +
      (stacks * 0.1).toFixed(1) +
      "% block, and each attack that does not kill it will cause your Trimps to lose " +
      (stacks * 0.03).toFixed(2) +
      "% of their health.";
    costText = "";
  }
  if (what == "Custom") {
    ...
    if (textString) tooltipText += " <b>Max of 1,000 for most perks</b>";
    tooltipText +=
      "<br/><br/><input id='customNumberBox' style='width: 50%' value='" +
      (!isNumberBad(game.global.lastCustomExact)
        ? prettify(game.global.lastCustomExact)
        : game.global.lastCustomExact) +
      "' />";
    costText =
      "<div class='maxCenter'><div id='confirmTooltipBtn' class='btn btn-info' onclick='numTab(5, " +
      textString +
      ")'>Apply</div><div class='btn btn-info' onclick='cancelTooltip()'>Cancel</div></div>";
    game.global.lockTooltip = true;
    elem.style.left = "33.75%";
    elem.style.top = "25%";
    ondisplay = function () {
  ...
  if (what == "Max") {
    ...
    tooltipText =
      "No reason to spend everything in one place! Here you can set the ratio of your resources to spend when using the 'Max' button. Setting this to 0.5 will spend no more than half of your resources per click, etc.";
    costText =
      "<ul id='buyMaxUl'><li onclick='setMax(1, " +
      forPortal +
      ")'>Max</li><li onclick='setMax(0.5, " +
      forPortal +
      ")'>0.5</li><li onclick='setMax(0.33, " +
      forPortal +
      ")'>0.33</li><li onclick='setMax(0.25, " +
      forPortal +
      ")'>0.25</li><li onclick='setMax(0.1, " +
      forPortal +
      ")'>0.1</li></ul>";
    game.global.lockTooltip = true;
    elem.style.left = "33.75%";
  ...
  if (what == "Export") {
    ...
    if (textString) {
      tooltipText =
        textString +
        "<br/><br/><textarea id='exportArea' spellcheck='false' style='width: 100%' rows='5'>" +
        saveText +
        "</textarea>";
      what = "Thanks!";
    } else
      tooltipText =
        "This is your save string. There are many like it but this one is yours. Save this save somewhere safe so you can save time next time. <br/><br/><textarea spellcheck='false' id='exportArea' style='width: 100%' rows='5'>" +
        saveText +
        "</textarea>";
    costText =
      "<div class='maxCenter'><div id='confirmTooltipBtn' class='btn btn-info' onclick='cancelTooltip()'>Got it</div>";
    ...
    if (game.global.universe == 2 || game.global.totalRadPortals > 0) {
      saveName +=
        " " + game.global.totalRadPortals + " U" + game.global.universe;
    }
    saveName += " Z" + game.global.world;
    costText +=
      "<a id='downloadLink' target='_blank' download='" +
      saveName +
      ".txt', href=";
    if (Blob !== null) {
  ...
  if (what == "Lost Time") {
    ...
    elem.style.top = "25%";
    costText =
      "<div class='maxCenter'><div id='confirmTooltipBtn' class='btn btn-info btn-lg' onclick='cancelTooltip()'>Neat</div>";
  }
  if (what == "Export Perks") {
    tooltipText =
      "It may not look like much, but all of your perks are in here! You can share this string with friends, or save it to your computer to import later!<br/><br/><textarea spellcheck='false' id='exportArea' style='width: 100%' rows='5'>" +
      exportPerks() +
      "</textarea>";
    costText =
      "<div class='maxCenter'><div id='confirmTooltipBtn' class='btn btn-info' onclick='cancelTooltip()'>Got it</div>";
  ...
  if (what == "Import") {
    tooltipText =
      "Import your save string! It'll be fun, I promise.<br/><br/><textarea spellcheck='false' id='importBox' style='width: 100%' rows='5'></textarea>";
    costText =
      "<div class='maxCenter'><div id='confirmTooltipBtn' class='btn btn-info' onclick='cancelTooltip(); load(true);'>Import</div>";
    costText +=
      "<div class='btn btn-info' onclick='cancelTooltip()'>Cancel</div></div>";
    game.global.lockTooltip = true;
    elem.style.left = "33.75%";
    elem.style.top = "25%";
    ondisplay = function () {
  ...
  if (what == "Import Perks") {
    if (game.global.challengeActive == "Hypothermia") {
      ...
      if (portalStoryElem)
        portalStoryElem.innerHTML =
          "<span style='color: red'>You cannot change your perks while on the Hypothermia Challenge!</span>";
      return;
    }
    tooltipText =
      "Import your perks from a text string!<br/><br/><textarea spellcheck='false' id='perkImportBox' style='width: 100%' rows='5'></textarea>";
    costText = "<p class='red'></p>";
    costText +=
      "<div id='confirmTooltipBtn' class='btn btn-info' onclick='this.previousSibling.innerText = importPerks()'>Import</div>";
    costText +=
      "<div class='btn btn-info' onclick='cancelTooltip()'>Cancel</div></div>";
    game.global.lockTooltip = true;
    elem.style.left = "33.75%";
  ...
  if (what == "AutoUpgrade") {
    tooltipText =
      "Your scientists can finally handle some upgrades on their own! Toggling this on will cause most upgrades to be purchased automatically. Does not include equipment prestiges or upgrades that would trigger a confirmation popup.";
  }
  if (what == "Recycle All") {
  ...
  if (what == "DominationDominating") {
    ...
    noExtraCheck = true;
    tooltipText =
      "This Bad Guy is Dominating! It has 2.5x attack, 7.5x health, and heals for 5% of its max health after each attack. However, it will also drop 3x Helium!";
    costText = "";
  }
  if (what == "DominationWeak") {
    ...
    noExtraCheck = true;
    tooltipText =
      "This Bad Guy is having its power siphoned by an even worse Bad Guy! It deals 90% less damage and has 90% less health.";
    costText = "";
  }
  if (what == "Fire Trimps") {
    if (!game.global.firing)
      tooltipText =
        "Activate firing mode, turning the job buttons red, and forcing them to fire trimps rather than hire them. The newly unemployed Trimps will start breeding instead of working, but you will not receive a refund on resources.";
    else tooltipText = "Disable firing mode";
    costText = "";
  }
  if (what == "Maps") {
    if (!game.global.preMapsActive)
      tooltipText =
        "Travel to the Map Chamber. Maps are filled with goodies, and for each max level map you clear you will gain a 20% stacking damage bonus for that Zone (stacks up to 10 times). (Hotkey: M)";
    else tooltipText = "Go back to the World Map. (Hotkey: M)";
    costText = "";
  }
  ...
  if (isItIn == "jobs") {
    ...
    if (buyAmt == "Max")
      buyAmt = calculateMaxAfford(game.jobs[what], false, false, true);
    if (game.global.firing && what != "Amalgamator") {
      ...
      tooltipText =
        ...
        " " +
        what +
        ". Refunds no resources, but frees up some workspace for your Trimps.";
      costText = "";
    } else {
      var workspaces = game.workspaces;
      var ignoreWorkspaces =
        game.jobs[what].allowAutoFire && game.options.menu.fireForJobs.enabled;
  ...
  if (isItIn == "buildings") {
    ...
    if (game.global.buyAmt != 1) {
      if (game.buildings[what].percent || what == "Antenna") {
        tooltipText +=
          " <b>You can only purchase 1 " + what + " at a time.</b>";
        what += " X 1";
      } else {
        what +=
          " X " +
          prettify(
            game.global.buyAmt == "Max"
              ? calculateMaxAfford(game.buildings[what], true)
              : game.global.buyAmt
          );
      }
    }
  ...
  if (what == "Scale Equality Scaling") {
    ...
    if (textString)
      tooltipText =
        '<div style="font-size: 1.7vh"><div class="maxCenter"><div style="width: 50%; margin-left: 25%" role="button" class="noselect pointer portalThing thing perkColorOff changingOff equalityColor' +
        state +
        '" id="equalityScaling2" onclick="toggleEqualityScale()"><span class="thingName">Scale Equality</span><br><span class="thingOwned"><span id="equalityScalingState2">' +
        state +
    ...
    costText =
      "<div class='maxCenter'><div class='btn btn-info' id='confirmTooltipBtn' onclick='cancelTooltip()'>Done</div></div>";
    ondisplay = function () {
      verticalCenterTooltip();
    };
  }
  if (what == "Equality Scaling") {
    ...
    tooltipText =
      "<p>You can enable or disable Equality Scaling at any time.</p><p>With Equality Scaling On, each Portal starts with 0 levels of Equality active. If a group of Trimps dies after attacking <b>" +
      game.portal.Equality.scalingSetting +
      "</b> or fewer time" +
      needAnS(game.portal.Equality.scalingSetting) +
      ", one level of Equality will activate, up to your purchased level of Equality.";
    tooltipText +=
      "</p><p><b>You currently have " +
      activeLevels +
      " stack" +
      needAnS(activeLevels) +
      " of Equality active.</b></p>";
    if (!textString)
      tooltipText +=
        "<p><b>Ctrl Click this button to customize your Equality settings.</b></p>";
    else tooltipText += "<p>(Hotkey: E)</p>";
  } else if (isItIn == "portal") {
    var resAppend = game.global.kongBonusMode
      ? " Bonus Point"
      : " " + heliumOrRadon(true, true);
    var perkItem = game.portal[what];
    var price = getPortalUpgradePrice(what);
    if (
      !perkItem.max ||
      perkItem.max > getPerkLevel(what, true) + perkItem.levelTemp
    )
      costText = prettify(price) + resAppend + needAnS(price);
    else costText = "";
    tooltipText +=
      "<br/><br/><b>You have spent " +
      prettify(getSpentPerkResource(what, true) + perkItem.heliumSpentTemp) +
      " " +
      heliumOrRadon(false, true) +
      " on this Perk.</b>";
    if (game.global.buyAmt == "Max")
      what += " X " + prettify(getPerkBuyCount(what));
    else if (game.global.buyAmt > 1)
      what += " X " + prettify(game.global.buyAmt);
    what = what.replace("_", " ");
  }
  if (isItIn == "equipment") {
    ...
    if (what == "Shield") {
      ...
      tooltipText +=
        "<br/><br/>" +
        prettify(resPerStat) +
        " wood spent per point of " +
        (equip.blockNow ? "Block" : "Health") +
        ".";
    } else {
      tooltipText +=
        "<br/><br/>" +
        prettify(resPerStat) +
        " metal spent per point of " +
        (equip.attack ? "Attack" : "Health") +
        ".";
      if (
        game.options.menu.equipHighlight.enabled > 0 &&
        !game.equipment.Mace.locked
      ) {
        tooltipText += " The most efficient Attack and Health equipment";
        if (
          game.options.menu.equipHighlight.enabled == 1 &&
          equip.prestige >= 2
        )
          tooltipText += " of your highest Tier";
        tooltipText += " have blue backgrounds.";
        if (equip.prestige >= 2)
          tooltipText +=
            " (Search Settings for Highlight Equipment to change behavior)";
      }
    }
    if (game.global.buyAmt != 1) {
      what += " X " + buyAmt;
  ...
  if (isItIn == "upgrades") {
    var mouseOverElem =
      lastMousePos[0] && lastMousePos[1]
        ? document.elementFromPoint(lastMousePos[0], lastMousePos[1])
        : null;
    ...
    if (typeof tooltipText.split("@")[1] !== "undefined") {
      var prestigeCost =
        "Your next " +
        game.upgrades[what].prestiges +
        " will grant " +
        getNextPrestigeValue(what) +
        ".";
    ...
    if (
      typeof tooltipText.split("?")[1] !== "undefined" &&
      what != "Dominance"
    ) {
    ...
    if (what == "Coordination") {
      var coordReplace = getPerkLevel("Coordinated")
        ? (
            25 *
            Math.pow(
      ...
      if (!canAffordCoordinationTrimps()) {
        ...
        if (game.global.challengeActive == "Trappapalooza")
          tooltipText +=
            " <b>You need " +
            prettify(currentSend) +
            " unemployeed Trimps available.";
        else
          tooltipText +=
            " <b>You need enough room for " +
            prettify(currentSend) +
            " max Trimps.";
        tooltipText +=
          " You are short " +
          prettify(Math.floor(amtToGo)) +
          " Trimp" +
          s +
          ".</b>";
      }
    }
    if (typeof game.upgrades[what].name !== "undefined")
      what = game.upgrades[what].name;
  }
  if (isItIn == "maps") {
    tooltipText =
      "This is a map. Click it to see its properties or to run it. Maps can be run as many times as you want.";
    costText = "";
  }
  if (what == "confirm") {
    ...
    if (what != "Spire Assault")
      costText =
        ' <div class="maxCenter" id="confirmTipCost"><div id="confirmTooltipBtn" class="btn btn-info"' +
        attachFunction +
        ">" +
        renameBtn +
        "</div>";
  ...
  if (isItIn == "customText") {
    ...
    if (event == "lock") {
      ...
      if (!attachFunction)
        costText =
          '<div class="btn btn-danger" onclick="cancelTooltip()">Close</div>';
      event = "update";
    }
    if (numCheck == "center") {
      ondisplay = function () {
  ...
  if (!noExtraCheck) {
    ...
    if (typeof tipSplit[1] !== "undefined") {
      if (tipSplit[1] == "incby") {
        ...
        if (
          toTip.increase.what == "trimps.max" &&
          game.global.challengeActive == "Downsize"
        )
          increase = 1;
        if (getPerkLevel("Carpentry") && toTip.increase.what == "trimps.max")
          increase *= Math.pow(1.1, getPerkLevel("Carpentry"));
        if (getPerkLevel("Carpentry_II") && toTip.increase.what == "trimps.max")
          increase *=
            1 +
            game.portal.Carpentry_II.modifier * getPerkLevel("Carpentry_II");
        if (game.global.expandingTauntimp)
          increase *= game.badGuys.Tauntimp.expandingMult();
        ...
        if (getPerkLevel("Motivation") > 0)
          newValue *= 1 + getPerkLevel("Motivation") * 0.05;
    ...
    if (
      isItIn == "buildings" &&
      what.split(" ")[0] == "Warpstation" &&
      game.global.lastWarp
    ) {
      tooltipText +=
        "<b> You had " +
        game.global.lastWarp +
        " Warpstations when you purchased your last Gigastation (" +
        game.upgrades.Gigastation.done +
        ").</b>";
    }
    if (typeof tooltipText.split("~") !== "undefined") {
      ...
      if (percentIncrease > 0) {
        percentIncrease += 4;
        text =
          " and increases the base block of all Gyms by " +
          percentIncrease +
          "% (compounding).";
      }
    ...
    if (event == "screenRead") {
      ...
      if (game.global.lockTooltip) {
        document.getElementById("screenReaderTooltip").innerHTML =
          "Confirmation Popup is active. Press S to view the popup.";
      } else {
        document.getElementById("screenReaderTooltip").innerHTML = "";
      }
      game.global.lockTooltip = false;
...
function updateMazPreset(index) {
  ...
  var until = parseInt(
    document.getElementById("mazRepeatUntil" + index).value,
    10
  );
  if (preset != 3 && until == 5) {
    until = 0;
...
function getEqualitySliders(short) {
  ...
  text +=
    "<b>Your current setting is <span id='equalityCurrentScale'>" +
    game.portal.Equality.scalingSetting +
    "</span>.</b>";
  text +=
    "<br/><input oninput='scaleEqualityScale(this)' onchange='scaleEqualityScale(this)' type='range' id='scaleEqualitySlider' min='0' max='10' value='" +
    game.portal.Equality.scalingSetting +
    "' />";
  if (!short)
    text +=
      "<br/>If Reversing is allowed, Equality stacks will also decrease after the set amount of attacks against the same bad guy.<br/><br/>";
  text +=
    buildNiceCheckbox(
      "equalityReversing",
      null,
      game.portal.Equality.scalingReverse,
      'scaleEqualityScale(this, "reverse")'
    ) +
    " Allow Reversing<br/><b>Your current reversing setting is <span id='equalityCurrentScaleReverse'>" +
    game.portal.Equality.reversingSetting +
    "</span>.</b><br/><input oninput='scaleEqualityScale(this)' onchange='scaleEqualityScale(this)' type='range' id='scaleEqualitySliderReverse' min='1' max='10' value='" +
    game.portal.Equality.reversingSetting +
    "' />";
  ...
  if (!short)
    text +=
      "<br/>You can also manually set how many stacks of Equality should be used if Scaling is disabled by changing the slider below. This allows you to customize exactly how many stacks of Equality to use without having to respec your Perks.<br/><br/>";
  text +=
    "<b>Your Equality stacks when Scaling is disabled will be <span id='equalityDisabledStackCount'>" +
    stackText +
    "</span>.</b><input oninput='scaleEqualityScale(this)' onchange='scaleEqualityScale(this)' type='range' id='equalityDisabledSlider' min='0' max='" +
    max +
    "' value='" +
    disabledStackCount +
    "' />";
...
function getExtraScryerText(fromForm) {
  ...
  if (game.global.formation == fromForm) {
    if (!isScryerBonusActive())
      tooltipText +=
        "<p>You recently switched to " +
        formName +
        " Formation and will <b>not</b> earn a bonus from this enemy.</p>";
    else tooltipText += "<p>You will earn a bonus from this enemy!</p>";
    if (game.global.mapsActive) {
      var currentMap = getCurrentMapObject();
      if (
        currentMap.bonus &&
        mapSpecialModifierConfig[currentMap.bonus].cache
      ) {
        if (game.global.canScryCache)
          tooltipText +=
            "<p>You will earn a bonus from the Cache at the end of this map!</p>";
        else
          tooltipText +=
            "<p>You completed some of this map outside of " +
            formName +
            " Formation, and will <b>not</b> earn a bonus from the Cache.</p>";
      }
      if (game.global.voidBuff && game.talents.scry2.purchased) {
        if (game.global.canScryCache)
          tooltipText +=
            "<p>You will earn bonus Helium at the end of this map from Scryhard II!</p>";
        else
          tooltipText +=
            "<p>You completed some of this map outside of " +
            formName +
            " Formation, and will <b>not</b> earn a bonus to Helium from Scryhard II</p>";
      }
    }
  }
  if (game.global.world >= 181) {
    ...
    tooltipText +=
      ...
      " remaining " +
      (essenceRemaining == 1
        ? "enemy in your current Zone is"
        : "enemies in your current Zone are") +
      " holding Dark Essence. Your current enemy at this Zone would be worth " +
      prettify(calculateScryingReward()) +
      " Essence if it were holding any.</b></p>";
  }
  return tooltipText;
}
...
function buildNiceCheckbox(id, extraClass, enabled, extraFunction) {
  var html = enabled
    ? "icomoon icon-checkbox-checked' data-checked='true' "
    : "icomoon icon-checkbox-unchecked' data-checked='false' ";
...
function checkAlert(what, isItIn) {
  ...
  if (document.getElementById(isItIn + "Alert") !== null)
    document.getElementById(isItIn + "Alert").innerHTML = "";
}
...
function addTooltipPricing(toTip, what, isItIn) {
  ...
  for (var cost in toTip.cost) {
    if (
      typeof toTip.cost[cost] === "object" &&
      typeof toTip.cost[cost][1] === "undefined"
    ) {
      ...
      for (var item in costItem) {
        ...
        if (typeof itemToCheck[item] !== "undefined") {
          ...
          if (
            (item == "food" || item == "wood" || item == "metal") &&
            price > getMaxForResource(item)
          )
            canAfford = "orange";
          if (typeof itemToCheck[item].owned !== "undefined") {
            if (
              itemToCheck[item].owned < price &&
              typeof game.resources[item] !== "undefined"
            ) {
              var thisPs = getPsString(item, true);
              if (thisPs > 0) {
                percentOfTotal = calculateTimeToMax(
                  null,
                  thisPs,
                  price - itemToCheck[item].owned
                );
              ...
              percentOfTotal =
                itemToCheck[item].owned > 0
                  ? prettify(
                      ((price / itemToCheck[item].owned) * 100).toFixed(1)
                    )
                  : 0;
              percentOfTotal = "(" + percentOfTotal + "%)";
            }
          ...
          costText +=
            ...
            percentOfTotal +
            "</span>, ";
        } else costText += item + ": " + prettify(price) + ", ";
      }
      continue;
    }
  }
...
function messageConfigHover(what, event) {
  ...
  switch (what) {
    ...
    case "Lootsecondary":
      text =
        "Log the less common loot items: Gems, Fragments, Territory Bonus, and others.";
      title = "Secondary";
      break;
    case "Lootevents":
    ...
    case "Unlocksrepeated":
      text =
        "Log all unlocks that drop more than once per run, such as Speedfarming or Coordination.";
      title = "Repeated";
      break;
    case "Unlocksunique":
      text =
        "Log all unlocks that only drop once per portal, such as Gyms or Miners.";
      title = "Unique";
      break;
    case "Combattrimp":
  ...
  document.getElementById("messageConfigMessage").innerHTML =
    "<b>" + title + "</b> - " + text;
...
function getPsString(what, rawNum) {
  ...
  //Add base
  textString +=
    "<tr><td class='bdTitle'>Base</td><td class='bdPercent'></td><td class='bdNumber'>" +
    prettify(base) +
    "</td></tr>";
  //Add job count
  ...
  textString +=
    ...
    jobs[index] +
    s +
    "</td><td class='bdPercent'>" +
    prettify(job.owned) +
    "</td><td class='bdNumber'>" +
    prettify(currentCalc) +
    "</td></tr>";
  //Add books
  if (what != "gems" && game.permaBoneBonuses.multitasking.owned > 0) {
    var str =
      game.resources.trimps.owned >= game.resources.trimps.realMax()
        ? game.permaBoneBonuses.multitasking.mult()
        : 0;
    currentCalc *= 1 + str;
    textString +=
      "<tr><td class='bdTitle'>Multitasking (Bones)</td><td class='bdPercent'>+ " +
      prettify(str * 100) +
      "%</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  ...
  if (what != "gems" && game.upgrades.Bounty.done > 0) {
    currentCalc *= 2;
    textString +=
      "<tr><td class='bdTitle'>Bounty</td><td class='bdPercent'>+ 100%</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  //Add Tribute
  if (what == "gems" && game.buildings.Tribute.owned > 0) {
    var tributeStrength = Math.pow(
      game.buildings.Tribute.increase.by,
      game.buildings.Tribute.owned
    );
    currentCalc *= tributeStrength;
    tributeStrength = prettify((tributeStrength - 1) * 100) + "%";
    textString +=
      "<tr><td class='bdTitle'>Tribute</td><td class='bdPercent'>+ " +
      tributeStrength +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  ...
  if (game.unlocks.impCount.Whipimp > 0) {
    ...
    textString +=
      "<tr><td class='bdTitle'>Whipimp</td><td class='bdPercent'>+ " +
      whipStrength +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  ...
  //Add motivation
  if (getPerkLevel("Motivation") > 0) {
    var motivationStrength =
      getPerkLevel("Motivation") * game.portal.Motivation.modifier;
    currentCalc *= motivationStrength + 1;
    motivationStrength = prettify(motivationStrength * 100) + "%";
    textString +=
      "<tr><td class='bdTitle'>Motivation</td><td class='bdPercent'>+ " +
      motivationStrength +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  ...
  if (getPerkLevel("Motivation_II") > 0) {
    ...
    motivationStrength = prettify(motivationStrength * 100) + "%";
    textString +=
      "<tr><td class='bdTitle'>Motivation II</td><td class='bdPercent'>+ " +
      motivationStrength +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  ...
  if (
    ...
    currentCalc *= mult;
    textString +=
      "<tr><td class='bdTitle'>Observation</td><td class='bdPercent'>" +
      formatMultAsPercent(mult) +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  ...
  if (Fluffy.isRewardActive("gatherer")) {
    currentCalc *= 2;
    textString +=
      "<tr><td class='bdTitle'>Gatherer (" +
      Fluffy.getName() +
      ")</td><td class='bdPercent'>+ 100%</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  //Add Meditation
  if (getPerkLevel("Meditation") > 0) {
    ...
    if (medStrength > 0) {
      ...
      textString +=
        "<tr><td class='bdTitle'>Meditation</td><td class='bdPercent'>" +
        meditation.getBonusPercent(true) * 10 +
        " minutes (+" +
        medStrength +
        "%)</td><td class='bdNumber'>" +
        prettify(currentCalc) +
  ...
  var potionFinding;
  if (game.global.challengeActive == "Alchemy")
    potionFinding = alchObj.getPotionEffect("Potion of Finding");
  if (potionFinding > 1 && what != "fragments" && what != "science") {
    currentCalc *= potionFinding;
    textString +=
      "<tr><td class='bdTitle'>Potion of Finding</td><td class='bdPercent'>+ " +
      prettify((potionFinding - 1) * 100) +
      "%</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  ...
  if (potionFinding > 1 && what != "fragments" && what != "science") {
    currentCalc *= potionFinding;
    textString +=
      "<tr><td class='bdTitle'>Elixir of Finding</td><td class='bdPercent'>+ " +
      prettify((potionFinding - 1) * 100) +
      "%</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  ...
  if (game.jobs.Magmamancer.owned > 0 && what == "metal") {
    ...
    if (manceStrength > 1) {
      ...
      textString +=
        "<tr><td class='bdTitle'>Magmamancers</td><td class='bdPercent'>" +
        game.jobs.Magmamancer.getBonusPercent(true) * 10 +
        " minutes (+" +
        prettify(manceStrength) +
        "%)</td><td class='bdNumber'>" +
        prettify(currentCalc) +
        "</td></tr>";
    }
  ...
  if (game.upgrades.Speedexplorer.done > 0 && what == "fragments") {
    ...
    currentCalc *= bonus;
    textString +=
      "<tr><td class='bdTitle'>Speedexplorer</td><td class='bdPercent'>+ " +
      prettify((bonus - 1) * 100) +
      "%</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  ...
  if (
    ...
    currentCalc *= 1.5;
    textString +=
      "<tr><td class='bdTitle'>Huge (Size)</td><td class='bdPercent'>+ 50%</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  ...
  if (game.global.challengeActive == "Frigid") {
    ...
    currentCalc *= mult;
    textString +=
      "<tr style='color: red'><td class='bdTitle'>Shattered (Frigid)</td><td class='bdPercent'>x " +
      prettify(mult) +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  ...
  if (game.global.challengeActive == "Downsize") {
    currentCalc *= 5;
    textString +=
      "<tr><td class='bdTitle'>Solitary (Downsize)</td><td class='bdPercent'>+ 400%</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  if (challengeActive("Meditate")) {
    currentCalc *= 1.25;
    textString +=
      "<tr><td class='bdTitle'>Meditate</td><td class='bdPercent'>+ 25%</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  if (challengeActive("Toxicity")) {
    ...
    textString +=
      "<tr><td class='bdTitle'>Tweaky (Toxicity)</td><td class='bdPercent'>+ " +
      toxMult +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  ...
  if (
    ...
    textString +=
      "<tr><td class='bdTitle'>Strength (" +
      game.global.challengeActive +
      ")</td><td class='bdPercent'>+ " +
      chal.getGatherMult(true) +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  if (game.global.challengeActive == "Decay") {
    currentCalc *= 10;
    textString +=
      "<tr><td class='bdTitle'>Sanity (Decay)</td><td class='bdPercent'>x 10</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
    var stackStr = Math.pow(
      game.challenges.Decay.decayValue,
      game.challenges.Decay.stacks
    );
    currentCalc *= stackStr;
    textString +=
      "<tr style='color: red'><td class='bdTitle'>Decay</td><td class='bdPercent'>x " +
      stackStr.toFixed(3) +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  ...
  if (game.global.challengeActive == "Melt") {
    currentCalc *= 10;
    textString +=
      "<tr><td class='bdTitle'>Sanity (Melt)</td><td class='bdPercent'>x 10</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
    var stackStr = Math.pow(
      game.challenges.Melt.decayValue,
      game.challenges.Melt.stacks
    );
    currentCalc *= stackStr;
    textString +=
      "<tr style='color: red'><td class='bdTitle'>Melt</td><td class='bdPercent'>x " +
      stackStr.toFixed(3) +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  ...
  if (challengeActive("Watch")) {
    currentCalc /= 2;
    textString +=
      "<tr style='color: red'><td class='bdTitle'>Sleepy (Watch)</td><td class='bdPercent'>50%</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  if (challengeActive("Lead") && game.global.world % 2 == 1) {
    currentCalc *= 2;
    textString +=
      "<tr><td class='bdTitle'>Determined (Lead)</td><td class='bdPercent'>+ 100%</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  if (game.global.challengeActive == "Archaeology" && what != "fragments") {
    ...
    textString +=
      "<tr" +
      style +
      "><td class='bdTitle'>Resource Relic</td><td class='bdPercent'>x " +
      prettify(mult) +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  ...
  if (game.global.challengeActive == "Insanity") {
    ...
    currentCalc *= mult;
    textString +=
      "<tr><td class='bdTitle'>Insane (Insanity)</td><td class='bdPercent'>+ " +
      (100 * (mult - 1)).toFixed(4) +
      "%</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  if (game.challenges.Nurture.boostsActive() && what != "fragments") {
    ...
    currentCalc *= mult;
    textString +=
      "<tr><td class='bdTitle'>Cruffys</td><td class='bdPercent'>" +
      formatMultAsPercent(mult) +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  ...
  if (game.global.pandCompletions && what != "fragments") {
    ...
    currentCalc *= mult;
    textString +=
      "<tr><td class='bdTitle'>Pandemonium</td><td class='bdPercent'>" +
      formatMultAsPercent(mult) +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  ...
  if (game.global.desoCompletions && what != "fragments") {
    ...
    currentCalc *= mult;
    textString +=
      "<tr><td class='bdTitle'>Desolation Completions</td><td class='bdPercent'>" +
      formatMultAsPercent(mult) +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  ...
  if (game.global.challengeActive == "Daily") {
    ...
    if (typeof game.global.dailyChallenge.dedication !== "undefined") {
      mult = dailyModifiers.dedication.getMult(
        game.global.dailyChallenge.dedication.strength
      );
      currentCalc *= mult;
      textString +=
        "<tr><td class='bdTitle'>Dedicated (Daily)</td><td class='bdPercent'>+ " +
        prettify(mult * 100 - 100) +
        "%</td><td class='bdNumber'>" +
        prettify(currentCalc) +
        "</td></tr>";
    }
    if (
      ...
      mult = dailyModifiers.famine.getMult(
        game.global.dailyChallenge.famine.strength
      );
      currentCalc *= mult;
      textString +=
        "<tr style='color: red'><td class='bdTitle'>Famine (Daily)</td><td class='bdPercent'>" +
        prettify(mult * 100) +
        "%</td><td class='bdNumber'>" +
        prettify(currentCalc) +
        "</td></tr>";
  ...
  if (game.global.challengeActive == "Hypothermia" && what == "wood") {
    ...
    currentCalc *= mult;
    textString +=
      "<tr style='color: red'><td class='bdTitle'>Hypothermia</td><td class='bdPercent'>x " +
      prettify(mult) +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  ...
  if (game.global.challengeActive == "Desolation" && what != "fragments") {
    ...
    currentCalc *= mult;
    textString +=
      "<tr style='color: red'><td class='bdTitle'>Desolation</td><td class='bdPercent'>x " +
      prettify(mult) +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  ...
  if (
    ...
    currentCalc *= mult;
    textString +=
      "<tr><td class='bdTitle'>Antenna Network</td><td class='bdPercent'>+ " +
      prettify((mult - 1) * 100) +
      "%</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  ...
  if (
    ...
    currentCalc *= mult;
    textString +=
      "<tr><td class='bdTitle'>Parity (Staff)</td><td class='bdPercent'>+ " +
      prettify((mult - 1) * 100) +
      "%</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  ...
  if (
    (what == "food" || what == "metal" || what == "wood") &&
    autoBattle.oneTimers.Gathermate.owned &&
    game.global.universe == 2
  ) {
    var mult = autoBattle.oneTimers.Gathermate.getMult();
    currentCalc *= mult;
    textString +=
      "<tr><td class='bdTitle'>Gathermate</td><td class='bdPercent'>" +
      formatMultAsPercent(mult) +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  ...
  if (what != "fragments" && getEmpowerment() == "Wind") {
    ...
    textString +=
      "<tr><td class='bdTitle'>Swiftness (Wind)</td><td class='bdPercent'>+ " +
      prettify(windMod * 100) +
      "%</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  var heirloomBonus = calcHeirloomBonus(
    "Staff",
    jobs[index] + "Speed",
    0,
    true
  ...
  if (heirloomBonus > 0) {
    ...
    textString +=
      "<tr><td class='bdTitle'>Heirloom (Staff)</td><td class='bdPercent'>+ " +
      heirloomBonus +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  ...
  if (game.global.playerGathering == what) {
    if (
      ...
      textString +=
        "<tr><td class='bdTitle'>Sharing Food</td><td class='bdPercent'>+ " +
        tBonus +
        "%</td><td class='bdNumber'>" +
        prettify(currentCalc) +
        "</td></tr>";
    ...
    textString +=
      "<tr><td class='bdTitle'>You</td><td class='bdPercent'>+ " +
      prettify(playerStrength) +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  ...
  if (game.options.menu.useAverages.enabled) {
    ...
    if (avg > 0.001) {
      currentCalc += avg;
      textString +=
        "<tr><td class='bdTitle'>Average Loot</td><td class='bdPercent'>+ " +
        prettify(avg) +
        "</td><td class='bdNumber'>" +
        prettify(currentCalc) +
        "</td></tr>";
  ...
  tooltip(
    ...
    textString,
    "getPsString('" + what + "')",
    what.charAt(0).toUpperCase() + what.substr(1, what.length) + " Per Second",
    "Refresh",
    true
  );
}
...
function getZoneStats(event, update) {
  ...
  textString +=
    "<tr><td class='bdTitle bdZoneTitle' colspan='3'>Zone " +
    game.global.world +
    ", Cell " +
    (game.global.lastClearedCell + 2) +
    "</td></tr>";
  textString +=
    "<tr><td colspan='3'>You have been in this Zone for " +
    formatSecondsForZoneTime(getZoneSeconds()) +
    "</td></tr>";
  if (game.global.spireActive)
    textString +=
      ...
      " group" +
      needAnS(game.global.spireDeaths) +
      " of Trimps" +
      (game.global.spireDeaths == 1 ? " has" : " have") +
      " died in this Spire.</td></tr>";
  if (
    ...
    textString +=
      "<tr><td class='bdTitle bdZoneTitle' colspan='3'>" +
      map.name +
      ", Level " +
      map.level;
    if (map.location == "Bionic" && game.talents.bionic2.purchased)
      ...
      map.bonus &&
      typeof mapSpecialModifierConfig[map.bonus] !== "undefined"
    )
      textString += " (" + mapSpecialModifierConfig[map.bonus].abv + ")";
    textString +=
      ", Cell " + (game.global.lastClearedMapCell + 2) + "</td></tr>";
    textString +=
      '<tr><td><span class="' +
      getMapIcon(map) +
      '"></span> ' +
      (map.location == "Void"
        ? voidBuffConfig[game.global.voidBuff].title
        : getMapIcon(map, true)) +
      '</td><td><span class="icomoon icon-gift2"></span>' +
      Math.floor(map.loot * 100) +
      '%</span> <span class="icomoon icon-cube2"></span>' +
      map.size +
      ...
      (map.location == "Void"
        ? "&nbsp"
        : "Items: " + addSpecials(true, true, map)) +
      "</td></tr>";
    textString +=
      "<tr><td colspan='3'>You have been on this map for " +
      formatSecondsForZoneTime(
        (getGameTime() - game.global.mapStarted) / 1000
      ) +
      "</td></tr>";
  }
  if (
    game.global.challengeActive == "Quest" &&
    game.global.world >= game.challenges.Quest.getQuestStartZone()
  ) {
    textString +=
      "<tr><td class='bdTitle bdZoneTitle' colspan='3'>Quest: " +
      game.challenges.Quest.getQuestDescription(true) +
      "</td></tr>";
  }
  var stackedMaps = 0;
  ...
  if (game.global.totalVoidMaps > 0)
    textString +=
      "<tr><td colspan='3'>You have " +
      game.global.totalVoidMaps +
      " Void Map" +
      (game.global.totalVoidMaps == 1 ? "" : "s") +
      (stackedMaps ? " (" + stackedMaps + " stacks)" : "") +
      "</td></tr>";
  textString += "</tbody></table>";
  if (update) {
...
function getTrimpPs() {
  ...
  textString +=
    "<tr><td class='bdTitle'>Breeding</td><td class='bdPercent'>" +
    prettify(breeding) +
    "</td><td class='bdNumber'>" +
    prettify(currentCalc) +
    "</td></tr>";
  ...
  if (game.upgrades.Potency.done > 0) {
    ...
    textString +=
      "<tr><td class='bdTitle'>Potency</td><td class='bdPercent'>+ " +
      potencyStrength +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  ...
  if (game.buildings.Nursery.owned > 0) {
    ...
    textString +=
      "<tr><td class='bdTitle'>Nurseries</td><td class='bdPercent'>+ " +
      nurseryStrength +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  ...
  if (game.unlocks.impCount.Venimp > 0) {
    ...
    textString +=
      "<tr><td class='bdTitle'>Venimp</td><td class='bdPercent'>+ " +
      venimpStrength +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  ...
  if (game.global.brokenPlanet) {
    currentCalc /= 10;
    textString +=
      "<tr style='color: red'><td class='bdTitle'>Broken Planet</td><td class='bdPercent'>x 0.1</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  //Add pheromones
  if (getPerkLevel("Pheromones") > 0) {
    var PheromonesStrength =
      getPerkLevel("Pheromones") * game.portal.Pheromones.modifier;
    currentCalc *= PheromonesStrength + 1;
    PheromonesStrength = prettify(PheromonesStrength * 100) + "%";
    textString +=
      "<tr><td class='bdTitle'>Pheromones</td><td class='bdPercent'>+ " +
      PheromonesStrength +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  ...
  if (game.jobs.Geneticist.owned > 0) {
    ...
    textString +=
      "<tr style='color: red'><td class='bdTitle'>Geneticist</td><td class='bdPercent'>x  " +
      display +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  ...
  if (game.singleRunBonuses.quickTrimps.owned) {
    currentCalc *= 2;
    textString +=
      "<tr><td class='bdTitle'>Quick Trimps</td><td class='bdPercent'>+ 100%</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  if (game.global.challengeActive == "Daily") {
    ...
    if (typeof game.global.dailyChallenge.dysfunctional !== "undefined") {
      mult = dailyModifiers.dysfunctional.getMult(
        game.global.dailyChallenge.dysfunctional.strength
      );
      currentCalc *= mult;
      textString +=
        "<tr style='color: red'><td class='bdTitle'>Dysfunctional (Daily)</td><td class='bdPercent'>x  " +
        mult.toFixed(3) +
        "</td><td class='bdNumber'>" +
        prettify(currentCalc) +
        "</td></tr>";
    ...
    if (typeof game.global.dailyChallenge.toxic !== "undefined") {
      mult = dailyModifiers.toxic.getMult(
        game.global.dailyChallenge.toxic.strength,
        game.global.dailyChallenge.toxic.stacks
      );
      currentCalc *= mult;
      textString +=
        "<tr style='color: red'><td class='bdTitle'>Toxic (Daily)</td><td class='bdPercent'>x  " +
        mult.toFixed(3) +
        "</td><td class='bdNumber'>" +
        prettify(currentCalc) +
        "</td></tr>";
  ...
  if (challengeActive("Toxicity") && game.challenges.Toxicity.stacks > 0) {
    var potencyMod = Math.pow(
      game.challenges.Toxicity.stackMult,
      game.challenges.Toxicity.stacks
    );
    currentCalc *= potencyMod;
    textString +=
      "<tr style='color: red'><td class='bdTitle'>Toxic Air</td><td class='bdPercent'>x  " +
      potencyMod.toFixed(3) +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  if (game.global.universe == 2 && u2Mutations.tree.GeneHealth.purchased) {
    currentCalc /= 50;
    textString +=
      "<tr style='color: red'><td class='bdTitle'>Gene Health</td><td class='bdPercent'>/ 50</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  if (game.global.universe == 2 && u2Mutations.tree.GeneAttack.purchased) {
    currentCalc /= 50;
    textString +=
      "<tr style='color: red'><td class='bdTitle'>Gene Attack</td><td class='bdPercent'>/ 50</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  if (game.global.challengeActive == "Archaeology") {
    ...
    textString +=
      "<tr" +
      style +
      "><td class='bdTitle'>Breed Relic</td><td class='bdPercent'>x  " +
      prettify(mult) +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  ...
  if (
    ...
    game.challenges.Quagmire.exhaustedStacks != 0
  ) {
    ...
    textString +=
      "<td class='bdTitle'>Exhausted</td><td class='bdPercent'>" +
      dispTotal +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  ...
  if (game.global.voidBuff == "slowBreed") {
    currentCalc *= 0.2;
    textString +=
      "<tr style='color: red'><td class='bdTitle'>Void Gas</td><td class='bdPercent'>x  0.2</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  ...
  if (heirloomBonus > 0) {
    ...
    heirloomBonus = prettify(heirloomBonus) + "%";
    textString +=
      "<tr><td class='bdTitle'>Heirloom (Shield)</td><td class='bdPercent'>+ " +
      heirloomBonus +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
...
function getBattleStatBd(what) {
  ...
  var textString =
    "<div id='breakdownScrollWrapper' class='niceScroll'><table class='bdTableSm table table-striped'><tbody><tr><td></td><td>Base</td><td>Level</td><td>Item " +
    name +
    "</td><td>Total</td>" +
    (what == "attack" ? "<td>Min</td><td>Max</td>" : "") +
    "</tr>";
  var currentCalc = 0;
  var maxFluct = 0.2;
  var minFluct = 0.2;
  ...
  if (what == "health" || what == "attack") {
    ...
    textString +=
      "<tr><td class='bdTitle'>Base</td><td class='bdPercentSm'>" +
      prettify(currentCalc) +
      "</td><td></td><td></td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
      "</td>" +
      (what == "attack" ? "<td>-20%</td><td>+20%</td>" : "") +
      "</tr>";
    if (what == "attack") {
      //Discipline
      if (
        ...
        minFluct = 0.995;
        maxFluct = 0.995;
        var title = challengeActive("Discipline")
          ? "Lack Discipline"
          : "Unharnessed Luck";
        textString +=
          "<tr><td class='bdTitle'>" +
          title +
          "</td><td class='bdPercentSm'></td><td></td><td></td><td class='bdNumberSm'></td><td>-99.5%</td><td>+99.5%</td></tr>";
      } else {
        //Range
        if (getPerkLevel("Range") > 0) {
          minFluct -= 0.02 * getPerkLevel("Range");
          textString +=
            "<tr><td class='bdTitle'>Range</td><td class='bdPercentSm'>+2% Min</td><td>" +
            getPerkLevel("Range") +
            "</td><td>+" +
            prettify(2 * getPerkLevel("Range")) +
            "% Min</td><td class='bdNumberSm'></td><td>-" +
            prettify(minFluct * 100) +
            "%</td><td>+" +
            prettify(maxFluct * 100) +
            "%</td></tr>";
        }
        //MinDamageDaily
        if (typeof game.global.dailyChallenge.minDamage !== "undefined") {
          var addMin = dailyModifiers.minDamage.getMult(
            game.global.dailyChallenge.minDamage.strength
          );
          minFluct += addMin;
          if (minFluct > 1) minFluct = 1;
          textString +=
            "<tr style='color: red'><td class='bdTitle'>Minimalist (Daily)</td><td class='bdPercentSm'>-" +
            prettify(addMin * 100) +
            "% Min</td><td></td><td></td><td class='bdNumberSm'></td><td>-" +
            prettify(minFluct * 100) +
            "%</td><td>+" +
            prettify(maxFluct * 100) +
            "%</td></tr>";
        ...
        if (typeof game.global.dailyChallenge.maxDamage !== "undefined") {
          var addMax = dailyModifiers.maxDamage.getMult(
            game.global.dailyChallenge.maxDamage.strength
          );
          maxFluct += addMax;
          textString +=
            "<tr><td class='bdTitle'>Prodigal (Daily)</td><td class='bdPercentSm'>+" +
            prettify(addMax * 100) +
            "% Max</td><td></td><td></td><td class='bdNumberSm'></td><td>-" +
            prettify(minFluct * 100) +
            "%</td><td>+" +
            prettify(maxFluct * 100) +
            "%</td></tr>";
    ...
    for (var equip in game.equipment) {
      ...
      if (typeof temp[what] === "undefined" || temp.level <= 0 || temp.blockNow)
        continue;
      ...
      textString +=
        ...
        equip +
        "</td><td>" +
        prettify(temp[what + "Calculated"]) +
        "</td><td>" +
        temp.level +
        "</td><td>" +
        prettify(equipStrength) +
        " (" +
        percent +
        ")</td><td>" +
        prettify(currentCalc) +
        "</td>" +
        (what == "attack"
          ? getFluctuation(currentCalc, minFluct, maxFluct)
          : "") +
        "</tr>";
    }
  } else if (what == "block") {
    ...
    if (gym.owned > 0) {
      ...
      textString +=
        "<tr><td class='bdTitle'>Gym</td><td>" +
        prettify(gym.increase.by) +
        "</td><td>" +
        prettify(gym.owned) +
        "</td><td>" +
        prettify(gymStrength) +
        " (" +
        percent +
        ")</td><td>" +
        prettify(currentCalc) +
    ...
    if (shield.blockNow && shield.level > 0) {
      ...
      textString +=
        "<tr><td class='bdTitle'>Shield</td><td>" +
        prettify(shield.blockCalculated) +
        "</td><td>" +
        prettify(shield.level) +
        "</td><td>" +
        prettify(shieldStrength) +
        " (" +
        percent +
        ")</td><td>" +
        prettify(currentCalc) +
    ...
    if (trainer.owned > 0) {
      ...
      trainerStrength = calcHeirloomBonus(
        "Shield",
        "trainerEfficiency",
        trainerStrength
      );
      ...
      textString +=
        "<tr><td class='bdTitle'>Trainers</td><td>" +
        prettify(
          calcHeirloomBonus("Shield", "trainerEfficiency", trainer.modifier)
        ) +
        "%</td><td>" +
        prettify(trainer.owned) +
        "</td><td>+ " +
        trainerStrength +
        "</td><td>" +
        prettify(currentCalc) +
    ...
    if (game.upgrades.Prismatic.done) {
      currentCalc += 0.5;
      textString +=
        "<tr><td class='bdTitle'>Prismatic (Z2)</td><td>50%</td><td>1</td><td>50%</td><td>" +
        Math.round(currentCalc * 100) +
        "%</td></tr>";
    }
    if (game.upgrades.Prismalicious.done) {
      currentCalc += 0.5;
      textString +=
        "<tr><td class='bdTitle'>Prismalicious (Z20)</td><td>50%</td><td>1</td><td>50%</td><td>" +
        Math.round(currentCalc * 100) +
        "%</td></tr>";
    }
    if (Fluffy.isRewardActive("prism")) {
      ...
      currentCalc += thisAmt;
      textString +=
        "<tr><td class='bdTitle'>Prisms (Scruffy)</td><td>25%</td><td>" +
        Fluffy.isRewardActive("prism") +
        "</td><td>" +
        prettify(thisAmt * 100) +
        "%</td><td>" +
        Math.round(currentCalc * 100) +
        "%</td></tr>";
    }
    if (getPerkLevel("Prismal") > 0) {
      ...
      currentCalc += thisAmt;
      textString +=
        "<tr><td class='bdTitle'>Prismal (Perk)</td><td>" +
        prettify(game.portal.Prismal.modifier * 100) +
        "%</td><td>" +
        getPerkLevel("Prismal") +
        "</td><td>" +
        prettify(thisAmt * 100) +
        "%</td><td>" +
        Math.round(currentCalc * 100) +
    ...
    if (game.global.challengeActive == "Bublé") {
      currentCalc += 2.5;
      textString +=
        "<tr><td class='bdTitle'>Bublé (Challenge)</td><td>100%</td><td>&nbsp;</td><td>250%</td><td>" +
        Math.round(currentCalc * 100) +
        "%</td></tr>";
    }
    if (getHeirloomBonus("Shield", "prismatic") > 0) {
      ...
      textString +=
        "<tr><td class='bdTitle'>Heirloom</td><td>&nbsp;</td><td>&nbsp;</td><td>" +
        prettify(bonus) +
        "%</td><td>" +
        Math.round(currentCalc * 100) +
        "%</td></tr>";
    ...
    if (autoBattle.oneTimers.Suprism.owned) {
      ...
      currentCalc += bonus;
      textString +=
        "<tr><td class='bdTitle'>Suprism</td><td>3%</td><td>" +
    ...
    if (Fluffy.isRewardActive("shieldlayer")) {
      ...
      currentCalc *= layers;
      textString +=
        "<tr class='shieldLayerCalcRow'><td class='bdTitle'>Shield Layer</td><td>&nbsp;</td><td>&nbsp;</td><td>x " +
        layers +
        "</td><td>" +
        Math.round(currentCalc * 100) +
        "%</td></tr>";
    ...
    textString +=
      "<tr><td colspan='5' style='font-weight: bold'>Your Prismatic Shield is equal to " +
      Math.round(currentCalc * 100) +
      "% of your Trimps' maximum Health. All enemy damage hits your Prismatic Shield before Health, and Prismatic Shield always regenerates to full after an enemy is killed.</td></tr>";
  }
  //Add coordination
  if (what != "shield") {
    currentCalc *= game.resources.trimps.maxSoldiers;
    textString +=
      "<tr><td class='bdTitle'>Soldiers</td><td class='bdPercentSm'></td><td></td><td>x " +
      prettify(game.resources.trimps.maxSoldiers) +
  ...
  //Add smithy
  if (
    (what == "attack" || what == "health") &&
    game.global.universe == 2 &&
    game.buildings.Smithy.owned > 0
  ) {
    currentCalc *= game.buildings.Smithy.getMult();
    textString +=
      "<tr><td class='bdTitle'>Smithy</td><td>x " +
      prettify(game.buildings.Smithy.getBaseMult()) +
      "</td><td>" +
      game.buildings.Smithy.owned +
      "</td><td>+ " +
      prettify((game.buildings.Smithy.getMult() - 1) * 100) +
      "%</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
      "</td>" +
      (what == "attack"
  ...
  if (
    ...
    textString +=
      "<tr><td class='bdTitle'>Enhanced Armor (Smithless)</td><td>x 1.25</td><td>" +
      game.challenges.Smithless.fakeSmithies +
      "</td><td>+ " +
      prettify((game.challenges.Smithless.getTrimpMult() - 1) * 100) +
      "%</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
      "</td>" +
      (what == "attack"
  ...
  if (
    what == "health" &&
    game.buildings.Antenna.owned >= 10 &&
    game.global.universe == 2
  ) {
    ...
    currentCalc *= amt;
    textString +=
      "<tr><td class='bdTitle'>Antenna Array</td><td>" +
      prettify(pct) +
      "%</td><td></td><td>+ " +
      prettify(pct) +
      "%</td><td class='bdNumberSm'>" +
  ...
  if (what == "attack" && game.global.achievementBonus > 0) {
    ...
    textString +=
      "<tr><td class='bdTitle'>Achievements</td><td class='bdPercentSm'></td><td></td><td>+ " +
      game.global.achievementBonus +
      "%</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
      "</td>" +
      getFluctuation(currentCalc, minFluct, maxFluct) +
  ...
  if (what == "attack" && getPerkLevel("Tenacity")) {
    ...
    textString +=
      "<tr><td class='bdTitle'>Tenacity</td><td>x " +
      prettify(game.portal.Tenacity.getBonusAmt()) +
      "</td><td>" +
  ...
  if (what == "attack" && getPerkLevel("Hunger")) {
    ...
    currentCalc *= amt;
    textString +=
      "<tr><td class='bdTitle'>Hunger</td><td></td><td>" +
      getPerkLevel("Hunger") +
      "</td><td>+ " +
      prettify((amt - 1) * 100) +
      "%</td><td class='bdNumberSm'>" +
  ...
  if (what == "health" && getPerkLevel("Resilience") > 0) {
    ...
    textString +=
      "<tr><td class='bdTitle'>Resilience</td><td>" +
      game.portal.Resilience.modifier * 100 +
      "%</td><td>" +
      getPerkLevel("Resilience") +
      "</td><td>+ " +
      resStrength +
  ...
  if (what == "health" && Fluffy.isRewardActive("healthy")) {
    ...
    textString +=
      "<tr><td class='bdTitle'>" +
      Fluffy.getName() +
      " is Life</td><td>+ 50%</td><td>&nbsp;</td><td>+ 50%</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  //Add Geneticist
  ...
  if (game.global.lastLowGen > 0 && what == "health") {
    ...
    textString +=
      "<tr><td class='bdTitle'>Geneticists</td><td>1%</td><td>" +
      prettify(calcedGenes) +
      "</td><td>+ " +
      geneticistStrength +
      "</td><td>" +
      prettify(currentCalc) +
  ...
  if (getPerkLevel("Anticipation") > 0 && what == "attack") {
    ...
    textString +=
      "<tr><td class='bdTitle'>Anticipation</td><td>2% (x" +
      game.global.antiStacks +
      ")</td><td>" +
      prettify(getPerkLevel("Anticipation")) +
      "</td><td>+ " +
      antiStrength +
      "</td><td>" +
      prettify(currentCalc) +
  ...
  if (
    ...
    currentCalc *= obsMult;
    textString +=
      "<tr><td class='bdTitle'>Observation</td><td>" +
      (game.portal.Observation.radLevel + 1) +
      "%</td><td>" +
      prettify(game.portal.Observation.trinkets) +
      "</td><td>" +
      formatMultAsPercent(obsMult) +
      "</td><td>" +
      prettify(currentCalc) +
      "</td>" +
      (what == "attack"
  ...
  if (game.global.formation > 0 && game.global.formation != 5) {
    ...
    if (
      (game.global.formation == 1 && what == "health") ||
    ...
    textString +=
      "<tr><td class='bdTitle'>Formation</td><td></td><td></td><td>x " +
      formStrength +
      "</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
      "</td>" +
  ...
  //Add Titimp
  if (
    game.global.titimpLeft > 1 &&
    game.global.mapsActive &&
    what == "attack"
  ) {
    currentCalc *= 2;
    textString +=
      "<tr><td class='bdTitle'>Titimp</td><td></td><td></td><td>x 2</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
      "</td>" +
      getFluctuation(currentCalc, minFluct, maxFluct) +
      "</tr>";
  ...
  if (!game.global.mapsActive && game.global.mapBonus > 0 && what == "attack") {
    ...
    mapBonusMult *= 100;
    textString +=
      "<tr><td class='bdTitle'>Map Bonus</td><td>" +
      displayBase +
      "</td><td>" +
      game.global.mapBonus +
      "</td><td>+ " +
      prettify(mapBonusMult) +
      "%</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
      "</td>" +
      getFluctuation(currentCalc, minFluct, maxFluct) +
  ...
  if (what == "attack" && game.global.roboTrimpLevel > 0) {
    ...
    roboTrimpMod *= 100;
    textString +=
      "<tr><td class='bdTitle'><span class='icomoon icon-chain'></span> RoboTrimp <span class='icomoon icon-chain'></span></td><td>20%</td><td>" +
      game.global.roboTrimpLevel +
      "</td><td>+ " +
      prettify(roboTrimpMod) +
      "%</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
      "</td>" +
      getFluctuation(currentCalc, minFluct, maxFluct) +
  ...
  if (
    ...
    currentCalc *= mult;
    textString +=
      "<tr><td class='bdTitle'>Frigid Completions</td><td>+ 2.5N%</td><td>" +
      game.global.frigidCompletions +
      "</td><td>+ " +
      prettify((mult - 1) * 100) +
      "%</td><td class='bdNumberSm'>" +
  ...
  if ((what == "attack" || what == "health") && game.global.mayhemCompletions) {
    ...
    currentCalc *= mult;
    textString +=
      "<tr><td class='bdTitle'>Mayhem Completions</td><td>+ 10N%</td><td>" +
  ...
  if ((what == "attack" || what == "health") && game.global.pandCompletions) {
    ...
    currentCalc *= mult;
    textString +=
      "<tr><td class='bdTitle'>Pandemonium Completions</td><td>+ 10N%</td><td>" +
  ...
  if ((what == "attack" || what == "health") && game.global.desoCompletions) {
    ...
    currentCalc *= mult;
    textString +=
      "<tr><td class='bdTitle'>Desolation Completions</td><td>+ 10N%</td><td>" +
  ...
  if (
    (what == "attack" || what == "health") &&
    autoBattle.bonuses.Stats.level > 0 &&
    game.global.universe == 2
  ) {
    var mult = autoBattle.bonuses.Stats.getMult();
    currentCalc *= mult;
    textString +=
      "<tr><td class='bdTitle'>Spire Assault Stats</td><td>+ 10%</td><td>" +
      autoBattle.bonuses.Stats.level +
      "</td><td>+ " +
      prettify((mult - 1) * 100) +
      "%</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
  ...
  if (what == "health" && game.global.challengeActive == "Life") {
    ...
    textString +=
      "<tr><td class='bdTitle'>Unliving (Life)</td><td>10%</td><td>" +
      game.challenges.Life.stacks +
      "</td><td>+ " +
      game.challenges.Life.getHealthMult(true) +
      "</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  if (what == "attack" && game.global.challengeActive == "Life") {
    currentCalc *= game.challenges.Life.getHealthMult();
    textString +=
      "<tr><td class='bdTitle'>Unliving (Life)</td><td></td><td></td><td>+ " +
      game.challenges.Life.getHealthMult(true) +
      "</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
      "</td>" +
  ...
  if (
    ...
    currentCalc *= 10;
    textString +=
      "<tr><td class='bdTitle'>Rallying Cry (Duel)</td><td>x 10</td><td></td><td>x 10</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  if (
    ...
    currentCalc *= 3;
    textString +=
      "<tr><td class='bdTitle'>Winning (Duel)</td><td>x 3</td><td></td><td>x 3</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
      "</td>" +
      getFluctuation(currentCalc, minFluct, maxFluct) +
      "</tr>";
  ...
  if (what == "health" && challengeActive("Balance")) {
    ...
    var display = mult > 0.0001 ? mult.toFixed(4) : mult.toExponential(3);
    textString +=
      "<tr style='color: red'><td class='bdTitle'>Weakness (Balance)</td><td>1%</td><td>" +
      game.challenges.Balance.balanceStacks +
      "</td><td>x " +
      display +
      "</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
  ...
  if (
    what == "attack" &&
    challengeActive("Lead") &&
    game.global.world % 2 == 1
  ) {
    currentCalc *= 1.5;
    textString +=
      "<tr><td class='bdTitle'>Determined (Lead)</td><td></td><td></td><td>+ 50%</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
      "</td>" +
      getFluctuation(currentCalc, minFluct, maxFluct) +
      "</tr>";
  ...
  if (
    ...
    textString +=
      "<td class='bdTitle'>Exhausted (Quagmire)</td><td>" +
      dispPercent +
      "</td><td>" +
  ...
  if (what != "shield") {
    var heirloomBonus = calcHeirloomBonus(
      "Shield",
      "trimp" + capitalizeFirstLetter(what),
      0,
      true
    );
    if (heirloomBonus > 0) {
      ...
      heirloomBonus = prettify(heirloomBonus) + "%";
      textString +=
        "<tr><td class='bdTitle'>Heirloom (Shield)</td><td></td><td></td><td>+ " +
        heirloomBonus +
        "</td><td class='bdNumberSm'>" +
        prettify(currentCalc) +
        "</td>" +
  ...
  if (game.global.challengeActive == "Decay" && what == "attack") {
    currentCalc *= 5;
    textString +=
      "<tr><td class='bdTitle'>Sanity (Decay)</td><td></td><td></td><td class='bdPercent'>x 5</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td>" +
      getFluctuation(currentCalc, minFluct, maxFluct) +
      "</tr>";
    ...
    currentCalc *= stackStr;
    textString +=
      "<tr style='color: red'><td class='bdTitle'>Decay</td><td>x 0.995</td><td>" +
      game.challenges.Decay.stacks +
      "</td><td class='bdPercent'>x " +
      stackStr.toFixed(3) +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td>" +
  ...
  if (game.global.challengeActive == "Melt" && what == "attack") {
    currentCalc *= 5;
    textString +=
      "<tr><td class='bdTitle'>Sanity (Melt)</td><td></td><td></td><td class='bdPercent'>x 5</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td>" +
      getFluctuation(currentCalc, minFluct, maxFluct) +
      "</tr>";
    ...
    currentCalc *= stackStr;
    textString +=
      "<tr style='color: red'><td class='bdTitle'>Melt</td><td>x 0.995</td><td>" +
      game.challenges.Melt.stacks +
      "</td><td class='bdPercent'>x " +
      stackStr.toFixed(3) +
      "</td><td class='bdNumber'>" +
  ...
  if (
    game.global.challengeActive == "Quest" &&
    game.challenges.Quest.finishedQuests > 0 &&
    what == "attack"
  ) {
    amt = game.challenges.Quest.getAttackMult();
    currentCalc *= amt;
    textString +=
      "<tr><td class='bdTitle'>Finished Quests!</td><td>x 1.1</td><td>" +
      game.challenges.Quest.finishedQuests +
      "</td><td class='bdPercent'>+ " +
      prettify((amt - 1) * 100) +
      "%</td><td class='bdNumber'>" +
      prettify(currentCalc) +
  ...
  if (
    ...
    game.challenges.Revenge.stacks > 0 &&
    (what == "attack" || what == "health")
  ) {
    amt = game.challenges.Revenge.getMult();
    currentCalc *= amt;
    textString +=
      "<tr><td class='bdTitle'>Revenge</td><td>+ 20%</td><td>" +
      game.challenges.Revenge.stacks +
      "</td><td class='bdPercent'>+ " +
      prettify((amt - 1) * 100) +
      "%</td><td class='bdNumber'>" +
      prettify(currentCalc) +
  ...
  if (
    ...
    textString +=
      "<tr style='color: red'><td class='bdTitle'>" +
      game.global.challengeActive +
      "</td><td>-10%</td><td>" +
      game.challenges.Electricity.stacks.toString() +
      "</td><td class='bdPercent'>x " +
      mult.toFixed(1) +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
  ...
  if (game.global.challengeActive == "Archaeology" && what == "attack") {
    ...
    textString +=
      "<tr><td" +
      style +
      " class='bdTitle'>Relic Strength</td><td>x1.05</td><td>" +
      count +
      "</td><td class='bdPercent'>x " +
      prettify(mult) +
      "</td><td class='bdNumber'>" +
  ...
  if (
    ...
    currentCalc *= mult;
    textString +=
      "<tr style='color: red'><td class='bdTitle'>Beta Trimps</td><td>-0.05%</td><td>" +
      game.challenges.Storm.beta +
      "</td><td>x " +
      prettify(mult) +
      "</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
  ...
  if (what == "health" && game.global.challengeActive == "Insanity") {
    ...
    currentCalc *= mult;
    textString +=
      "<tr style='color: red'><td class='bdTitle'>Insanity</td><td>x 0.99</td><td>" +
      game.challenges.Insanity.insanity +
      "</td><td>x " +
      prettify(mult) +
      "</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
  ...
  if (
    ...
    game.challenges.Berserk.frenzyStacks > 0
  ) {
    var mult = game.challenges.Berserk.getAttackMult();
    currentCalc *= mult;
    textString +=
      "<tr><td class='bdTitle'>Frenzied</td><td>+50%</td><td>" +
      game.challenges.Berserk.frenzyStacks +
      "</td><td>x " +
      prettify(mult) +
      "</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
  ...
  if (
    ...
    currentCalc *= mult;
    textString +=
      "<tr style='color: red'><td class='bdTitle'>Frenzied</td><td>-2%</td><td>" +
      game.challenges.Berserk.frenzyStacks +
      "</td><td>x " +
      prettify(mult) +
      "</td><td class='bdNumberSm'>" +
    ...
    what == "health" &&
    game.global.challengeActive == "Berserk" &&
    game.challenges.Berserk.weakened > 0
  ) {
    var mult = game.challenges.Berserk.getHealthMult();
    currentCalc *= mult;
    textString +=
      "<tr style='color: red'><td class='bdTitle'>Weakened</td><td>-4.99%</td><td>" +
      game.challenges.Berserk.weakened +
      "</td><td>x " +
      prettify(mult) +
      "</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
  ...
  if ((what == "attack" || what == "health") && getPerkLevel("Championism")) {
    ...
    currentCalc *= mult;
    textString +=
      "<tr><td class='bdTitle'>Championism</td><td>" +
      (1 + 0.5 * (autoBattle.maxEnemyLevel - 1)) +
      "%</td><td>" +
      getPerkLevel("Championism") +
      "</td><td>" +
      formatMultAsPercent(mult) +
      "</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
  ...
  if (
    ...
    currentCalc *= mult;
    textString +=
      "<tr><td class='bdTitle'>Potion of Strength</td><td>+ 15%</td><td>" +
      alchObj.getPotionCount("Potion of Strength") +
      "</td><td>" +
      formatMultAsPercent(mult) +
      "</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
  ...
  if (game.global.challengeActive == "Daily") {
    var mult = 0;
    if (
      typeof game.global.dailyChallenge.weakness !== "undefined" &&
      what == "attack"
    ) {
      mult = dailyModifiers.weakness.getMult(
        game.global.dailyChallenge.weakness.strength,
        game.global.dailyChallenge.weakness.stacks
      );
      currentCalc *= mult;
      textString +=
        "<tr style='color: red'><td class='bdTitle'>Weakness (Daily)</td><td>" +
        formatMultAsPercent(
          dailyModifiers.weakness.getMult(
            game.global.dailyChallenge.weakness.strength,
            1
          )
        ) +
    ...
    if (
      ...
      mult = dailyModifiers.oddTrimpNerf.getMult(
        game.global.dailyChallenge.oddTrimpNerf.strength
      );
      currentCalc *= mult;
      textString +=
        "<tr style='color: red'><td class='bdTitle'>Oddly Weak (Daily)</td><td>" +
        formatMultAsPercent(mult) +
        "</td><td></td><td class='bdPercent'>" +
        formatMultAsPercent(mult) +
        "</td><td class='bdNumber'>" +
        prettify(currentCalc) +
        "</td>" +
    ...
    if (
      ...
      mult = dailyModifiers.evenTrimpBuff.getMult(
        game.global.dailyChallenge.evenTrimpBuff.strength
      );
      currentCalc *= mult;
      textString +=
        "<tr><td class='bdTitle'>Even Stronger (Daily)</td><td>" +
        formatMultAsPercent(mult) +
        "</td><td></td><td class='bdPercent'>" +
        formatMultAsPercent(mult) +
        "</td><td class='bdNumber'>" +
    ...
    if (
      typeof game.global.dailyChallenge.rampage !== "undefined" &&
      what == "attack"
    ) {
      mult = dailyModifiers.rampage.getMult(
        game.global.dailyChallenge.rampage.strength,
        game.global.dailyChallenge.rampage.stacks
      );
      currentCalc *= mult;
      textString +=
        "<tr><td class='bdTitle'>Rampage (Daily)</td><td>" +
        formatMultAsPercent(
          dailyModifiers.rampage.getMult(
            game.global.dailyChallenge.rampage.strength,
            1
          )
        ) +
    ...
    if (
      ...
      mult = dailyModifiers.pressure.getMult(
        game.global.dailyChallenge.pressure.strength,
        game.global.dailyChallenge.pressure.stacks
      );
      currentCalc *= mult;
      textString +=
        "<tr style='color: red'><td class='bdTitle'>Pressure (Daily)</td><td>" +
        formatMultAsPercent(mult) +
        "</td><td></td><td class='bdPercent'>" +
        formatMultAsPercent(mult) +
        "</td><td class='bdNumber'>" +
  ...
  if (game.global.challengeActive == "Wither" && what == "health") {
    ...
    currentCalc *= mult;
    textString +=
      "<tr><td class='bdTitle'>Hardness (Wither)</td><td>+ 0.1%</td><td>" +
      game.challenges.Wither.trimpStacks +
      "</td><td class='bdPercent'>" +
      formatMultAsPercent(mult) +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
  ...
  if (game.global.challengeActive == "Desolation" && what == "attack") {
    ...
    currentCalc *= mult;
    textString +=
      "<tr style='color: red'><td class='bdTitle'>Chilled (Desolation)</td><td>x 0.998</td><td>" +
      prettify(game.challenges.Desolation.chilled) +
      "</td><td class='bdPercent'>x " +
      prettify(mult) +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
  ...
  if (game.global.challengeActive == "Desolation" && what == "health") {
    ...
    currentCalc *= mult;
    textString +=
      "<tr style='color: red'><td class='bdTitle'>Chilled (Desolation)</td><td>x 0.999</td><td>" +
      prettify(game.challenges.Desolation.chilled) +
      "</td><td class='bdPercent'>x " +
      prettify(mult) +
      "</td><td class='bdNumber'>" +
  ...
  if (game.global.challengeActive == "Desolation") {
    ...
    currentCalc *= mult;
    textString +=
      "<tr style='color: red'><td class='bdTitle'>Desolation</td><td>x " +
      (1 - game.challenges.Desolation.getReducePercent()).toFixed(3) +
      "</td><td>" +
      (game.global.world - 1) +
      "</td><td class='bdPercent'>x " +
      prettify(mult) +
      ...
      "</td>";
    if (what == "attack")
      textString += getFluctuation(currentCalc, minFluct, maxFluct);
    textString += "</tr>";
  }
  //Add golden battle
  if (
    what != "block" &&
    what != "shield" &&
    game.goldenUpgrades.Battle.currentBonus > 0
  ) {
    amt = game.goldenUpgrades.Battle.currentBonus;
    currentCalc *= 1 + amt;
    textString +=
      "<tr><td class='bdTitle'>Golden Battle</td><td></td><td></td><td>+ " +
      prettify(amt * 100) +
      "%</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
      "</td>" +
  ...
  if (what == "attack" && game.talents.herbalist.purchased) {
    ...
    amt = (amt - 1) * 100;
    textString +=
      "<tr><td class='bdTitle'>Herbalist</td><td></td><td></td><td>+ " +
      prettify(amt) +
      "%</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
      "</td>" +
  ...
  if (
    what != "block" &&
    what != "shield" &&
    game.talents.voidPower.purchased &&
    game.global.voidBuff
  ) {
    amt = game.talents.voidPower2.purchased
    ...
    textString +=
      "<tr><td class='bdTitle'>Void Power</td><td></td><td>" +
      (game.talents.voidPower2.purchased
        ? game.talents.voidPower3.purchased
          ? "III"
          : "II"
        : "I") +
  ...
  if (
    ...
    !game.global.mapsActive &&
    (getCurrentWorldCell().mutation == "Corruption" ||
      getCurrentWorldCell().mutation == "Healthy")
  ) {
    currentCalc *= 2;
    textString +=
      "<tr><td class='bdTitle'>Scryhard I</td><td>+100%</td><td></td><td>+ 100%</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
      "</td>" +
      getFluctuation(currentCalc, minFluct, maxFluct) +
      "</tr>";
  ...
  if (
    ...
    currentCalc *= 1.5;
    textString +=
      "<tr><td class='bdTitle'>Legs for Days</td><td>+50%</td><td></td><td>+ 50%</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
      "</td>" +
      getFluctuation(currentCalc, minFluct, maxFluct) +
      "</tr>";
  ...
  if (
    ...
    what == "attack" &&
    game.jobs.Magmamancer.getBonusPercent() > 1
  ) {
    amt = game.jobs.Magmamancer.getBonusPercent();
    currentCalc *= amt;
    textString +=
      "<tr><td class='bdTitle'>Magmamancermancy</td><td></td><td></td><td>+ " +
      prettify((amt - 1) * 100) +
      "%</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
      "</td>" +
  ...
  if (
    game.talents.stillRowing2.purchased &&
    what == "attack" &&
    game.global.spireRows >= 1
  ) {
    amt = game.global.spireRows * 0.06;
    currentCalc *= amt + 1;
    textString +=
      "<tr><td class='bdTitle'>Still Rowing II</td><td>6%</td><td>" +
  ...
  if (
    game.talents.healthStrength.purchased &&
    what == "attack" &&
    mutations.Healthy.active()
  ) {
    var cellCount = mutations.Healthy.cellCount();
    amt = 0.15 * cellCount;
    currentCalc *= amt + 1;
    textString +=
      "<tr><td class='bdTitle'>Strength in Health</td><td>15%</td><td>" +
      cellCount +
      "</td><td>+ " +
      prettify(amt * 100) +
      "%</td><td class='bdNumberSm'>" +
  ...
  if (
    ...
    currentCalc *= 1.5;
    textString +=
      "<tr><td class='bdTitle'>Bionic Magnet II</td><td>+50%</td><td></td><td>+ 50%</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
      "</td>" +
      getFluctuation(currentCalc, minFluct, maxFluct) +
      "</tr>";
  ...
  if (
    what == "attack" &&
    game.global.voidBuff &&
    game.talents.voidMastery.purchased
  ) {
    currentCalc *= 5;
    textString +=
      "<tr><td class='bdTitle'>Master of the Void</td><td>x5</td><td></td><td>x 5</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
      "</td>" +
      getFluctuation(currentCalc, minFluct, maxFluct) +
      "</tr>";
  ...
  if (
    ...
    currentCalc *= 2;
    textString +=
      "<tr><td class='bdTitle'>Safe Mapping</td><td>x 2</td><td class='bdNumberSm'>&nbsp;</td><td class='bdNumberSm'>x 2</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  //Pumpkimp buff
  if (game.global.sugarRush > 0 && what == "attack") {
    ...
    textString +=
      "<tr class='pumpkimpRow'><td class='bdTitle'>Sugar Rush</td><td>&nbsp;</td><td>&nbsp;</td><td>x " +
  ...
  //Challenge^2 bonus
  if (
    game.global.totalSquaredReward > 0 &&
    (what == "attack" || what == "health")
  ) {
    ...
    var c2Name =
      game.global.highestRadonLevelCleared < 49
        ...
        : "<span class='icomoon icon-infinity'></span>";
    textString +=
      "<tr><td class='bdTitle'>Challenge<sup>" +
      c2Name +
      "</sup> Rewards</td><td></td><td></td><td>+ " +
      prettify(amt) +
      "%</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
      "</td>" +
  ...
  if (what == "attack" && getEmpowerment() == "Ice") {
    ...
    currentCalc *= 1 + amt;
    textString +=
      "<tr><td class='bdTitle'>Chilled Enemy</td><td></td><td></td><td>+ " +
      prettify(amt * 100) +
      "%</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
      "</td>" +
  ...
  if (
    what == "attack" &&
    Fluffy.isRewardActive("voidSiphon") &&
    ...
    textString +=
      "<tr><td class='bdTitle'>Void Siphon (" +
      Fluffy.getName() +
      " E" +
      voidE +
      ")</td><td>+ " +
  ...
  if (
    ...
    game.global.universe == 1 &&
    Fluffy.isActive() &&
    game.talents.kerfluffle.purchased
  ) {
    amt = game.talents.kerfluffle.mult();
    currentCalc *= amt;
    textString +=
      "<tr><td class='bdTitle'>Kerfluffle</td><td>x 1.1</td><td>" +
      (Fluffy.getCurrentPrestige() + 1) +
      "</td><td>+ " +
      prettify((amt - 1) * 100) +
      "%</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
  ...
  if (
    ...
    currentCalc *= mult;
    textString +=
      "<tr><td class='bdTitle'>Cruffys</td><td></td><td>" +
      game.challenges.Nurture.getLevel() +
      "</td><td class='bdPercent'>" +
      formatMultAsPercent(mult) +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
  ...
  if (mutations.Magma.active() && (what == "attack" || what == "health")) {
    ...
    var display = mult > 0.0001 ? mult.toFixed(4) : mult.toExponential(3);
    textString +=
      "<tr style='color: red'><td class='bdTitle'>Overheating (Magma)</td><td>x 0.8</td><td>" +
      lvls +
      "</td><td class='bdPercent'>x " +
      display +
      "</td><td class='bdNumber'>" +
  ...
  if (what == "health" && game.jobs.Amalgamator.owned > 0) {
    ...
    currentCalc *= amt;
    textString +=
      "<tr><td class='bdTitle'>Amalgamator</td><td>x " +
      prettify(game.jobs.Amalgamator.healthModifier) +
      "</td><td class='bdNumberSm'>" +
      prettify(game.jobs.Amalgamator.owned) +
      "</td><td class='bdNumberSm'>x " +
      prettify(amt) +
      "</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
      "</td></tr>";
  ...
  if (what == "attack" && game.jobs.Amalgamator.owned > 0) {
    ...
    currentCalc *= amt;
    textString +=
      "<tr><td class='bdTitle'>Amalgamator</td><td>+ " +
      prettify(game.jobs.Amalgamator.damageModifier * 100) +
      "%</td><td>" +
  ...
  if (what == "attack" && playerSpireTraps.Strength.owned) {
    ...
    currentCalc *= 1 + amt / 100;
    textString +=
      "<tr><td class='bdTitle'>Strength Tower" +
      needAnS(playerSpireTraps.Strength.owned) +
      "</td><td>+ " +
      prettify(playerSpireTraps.Strength.getWorldBonus(true)) +
      "%</td><td>" +
  ...
  if (what == "attack" && getUberEmpowerment() == "Poison") {
    currentCalc *= 3;
    textString +=
      "<tr><td class='bdTitle'>Enlightened Poison</td><td>x 3</td><td></td><td>x 3</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
      "</td>" +
      getFluctuation(currentCalc, minFluct, maxFluct) +
      "</tr>";
  ...
  if (what == "attack" && game.singleRunBonuses.sharpTrimps.owned) {
    currentCalc *= 1.5;
    textString +=
      "<tr><td class='bdTitle'>Sharp Trimps</td><td></td><td></td><td>+ 50%</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
      "</td>" +
      getFluctuation(currentCalc, minFluct, maxFluct) +
      "</tr>";
  ...
  if (
    what == "health" &&
    game.global.universe == 2 &&
    u2Mutations.tree.Health.purchased
  ) {
    currentCalc *= 1.5;
    textString +=
      "<tr><td class='bdTitle'>Healthy Mutator</td><td>x 1.5</td><td class='bdNumberSm'></td><td class='bdNumberSm'>x 1.5</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  if (
    what == "attack" &&
    game.global.universe == 2 &&
    u2Mutations.tree.Attack.purchased
  ) {
    currentCalc *= 1.5;
    textString +=
      "<tr><td class='bdTitle'>Attack Mutator</td><td>x 1.5</td><td></td><td>x 1.5</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
      "</td>" +
      getFluctuation(currentCalc, minFluct, maxFluct) +
      "</tr>";
  ...
  if (
    what == "health" &&
    game.global.universe == 2 &&
    u2Mutations.tree.GeneHealth.purchased
  ) {
    currentCalc *= 10;
    textString +=
      "<tr><td class='bdTitle'>Gene Health Mutator</td><td>x 10</td><td class='bdNumberSm'></td><td class='bdNumberSm'>x 10</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  if (
    what == "attack" &&
    game.global.universe == 2 &&
    u2Mutations.tree.GeneAttack.purchased
  ) {
    currentCalc *= 10;
    textString +=
      "<tr><td class='bdTitle'>Gene Attack Mutator</td><td>x 10</td><td></td><td>x 10</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
      "</td>" +
      getFluctuation(currentCalc, minFluct, maxFluct) +
      "</tr>";
  ...
  if (
    what == "attack" &&
    game.global.universe == 2 &&
    u2Mutations.tree.Brains.purchased
  ) {
    mult = u2Mutations.tree.Brains.getBonus();
    currentCalc *= mult;
    textString +=
      "<tr><td class='bdTitle'>Brains to Brawn</td><td>x " +
      prettify(mult) +
      "</td><td></td><td>x " +
      prettify(mult) +
      "</td><td class='bdNumberSm'>" +
  ...
  if (
    ...
    currentCalc *= amt;
    textString +=
      "<tr style='color: red'><td class='bdTitle'>Blinded (Nova)</td><td>x 0.99</td><td>" +
      game.global.novaMutStacks +
      "</td><td class='bdPercent'>x " +
      prettify(amt) +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
  ...
  if (what == "attack" && game.global.challengeActive == "Unbalance") {
    ...
    var display = mult > 0.0001 ? mult.toFixed(4) : mult.toExponential(3);
    textString +=
      "<tr style='color: red'><td class='bdTitle'>Weakness (Unbalance)</td><td>x 0.99</td><td>" +
      game.challenges.Unbalance.balanceStacks +
      "</td><td>x " +
      display +
      "</td><td class='bdNumberSm'>" +
      prettify(currentCalc) +
  ...
  if (what == "attack" && getPerkLevel("Equality") > 0) {
    ...
    var modDisplay =
      modifier > 0.0001 ? modifier.toFixed(4) : modifier.toExponential(3);
    textString +=
      "<tr style='color: red'><td class='bdTitle'>Equality</td><td>x " +
      modDisplay +
      "</td><td>" +
      game.portal.Equality.getActiveLevels() +
      "</td><td class='bdPercent'>x " +
      display +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
  ...
  if (what == "attack") {
    ...
    if (critChance < 0) {
      ...
      textString +=
        "<tr class='critRow'><td class='bdTitle'><span style='color: yellow;'>Crit!</span> Chance</td><td>0% (" +
        (critChance * 100).toFixed(1) +
        "% Total)</td><td class='bdTitle'><span style='color: yellow;'>Crit!</span> Damage</td><td>+ " +
        prettify((critMult - 1) * 100) +
        "%</td><td class='bdNumberSm'>" +
        prettify(critCalc) +
        "</td>" +
        ...
        "</tr>";
      textString +=
        "<tr class='critRow'><td class='bdTitle'><span style='color: cyan;'>Weak!</span> Chance</td><td>" +
        (Math.abs(critChance) * 100).toFixed(1) +
        "%</td><td class='bdTitle'><span style='color: cyan;'>Weak!</span> Damage</td><td>x 0.2</td><td class='bdNumberSm'>" +
        prettify(currentCalc * 0.2) +
        "</td>" +
        getFluctuation(currentCalc * 0.2, minFluct, maxFluct) +
        "</tr>";
    } else {
      if (critChance > 0) {
        ...
        textString +=
          "<tr class='critRow'><td class='bdTitle'><span style='color: yellow;'>Crit!</span> Chance</td><td>" +
          (thisCritChance * 100).toFixed(1) +
          "%";
        if (critChance > 1)
          textString += " (" + (critChance * 100).toFixed(1) + "% Total)";
        textString +=
          "</td><td class='bdTitle'><span style='color: yellow;'>Crit!</span> Damage</td><td>+ " +
          prettify((critMult - 1) * 100) +
          "%</td><td class='bdNumberSm'>" +
          prettify(critCalc) +
          "</td>" +
      ...
      if (critChance > 1 && critChance < 3) {
        ...
        textString +=
          "<tr class='critRow'><td class='bdTitle'><span style='color: orange;'>CRIT!</span> Chance</td><td>" +
          (thisCritChance * 100).toFixed(1) +
          "%</td><td class='bdTitle'><span style='color: orange;'>CRIT!</span> Damage</td><td><span style='color: yellow;'>Crit!</span> x " +
          prettify(critMult) +
          "</td><td class='bdNumberSm'>" +
          prettify(critCalc) +
          "</td>" +
      ...
      if (critChance > 2 && critChance < 4) {
        ...
        critCalc = currentCalc * critMult * baseCritMult;
        textString +=
          "<tr class='critRow'><td class='bdTitle'><span style='color: red;'>CRIT!!</span> Chance</td><td>" +
          (thisCritChance * 100).toFixed(1) +
          "%</td><td class='bdTitle'><span style='color: red;'>CRIT!!</span> Damage</td><td><span style='color: yellow;'>Crit!</span> x " +
          prettify(critMult) +
          "</td><td class='bdNumberSm'>" +
          prettify(critCalc) +
          "</td>" +
      ...
      if (critChance > 3 && critChance < 5) {
        ...
        critCalc = currentCalc * critMult * baseCritMult;
        textString +=
          "<tr class='critRow'><td class='bdTitle'><span class='critTier4'>CRIT<span class='icomoon icon-atom'></span></span> Chance</td><td>" +
          (thisCritChance * 100).toFixed(1) +
          "%</td><td class='bdTitle'><span class='critTier4'>CRIT<span class='icomoon icon-atom'></span></span> Damage</td><td><span style='color: yellow;'>Crit!</span> x " +
          prettify(critMult) +
          "</td><td class='bdNumberSm'>" +
          prettify(critCalc) +
          "</td>" +
      ...
      if (critChance > 4 && critChance < 6) {
        ...
        critCalc = currentCalc * critMult * baseCritMult;
        textString +=
          "<tr class='critRow'><td class='bdTitle'><span class='critTier5'><span class='icomoon icon-bomb'></span> CRIT</span> Chance</td><td>" +
          (thisCritChance * 100).toFixed(1) +
          "%</td><td class='bdTitle'><span class='critTier5'><span class='icomoon icon-bomb'></span> CRIT</span> Damage</td><td><span style='color: yellow;'>Crit!</span> x " +
          prettify(critMult) +
          "</td><td class='bdNumberSm'>" +
          prettify(critCalc) +
          "</td>" +
      ...
      if (critChance > 6 && critChance < 8) {
        ...
        critCalc = currentCalc * critMult * baseCritMult;
        textString +=
          "<tr class='critRow'><td class='bdTitle'><span class='critTier7'><span class='icomoon icon-bolt'></span> CRIT!</span> Chance</td><td>" +
          (thisCritChance * 100).toFixed(1) +
          "%</td><td class='bdTitle'><span class='critTier7'><span class='icomoon icon-bolt'></span> CRIT!</span> Damage</td><td><span style='color: yellow;'>Crit!</span> x " +
          prettify(critMult) +
          "</td><td class='bdNumberSm'>" +
          prettify(critCalc) +
          "</td>" +
...
function formatMultAsPercent(mult, noSpace) {
  var space = noSpace ? "" : " ";
  if (mult < 1) return "-" + space + prettify(100 * (1 - mult)) + "%";
...
function getMaxTrimps() {
  ...
  var housing =
    ...
    base -
    game.global.trimpsGenerated;
  if (game.global.challengeActive == "Downsize")
    housing = countTotalHousingBuildings();
  if (housing < 0) housing = 0;
  var currentCalc = housing + base;
  textString +=
    "<tr><td class='bdTitle'>Housing</td><td class='bdPercent'>+ " +
    prettify(housing) +
    "</td><td class='bdNumber'>" +
    prettify(currentCalc) +
    "</td></tr>";
  ...
  if (game.global.trimpsGenerated > 0) {
    ...
    textString +=
      "<tr><td class='bdTitle'>Generated Housing</td><td class='bdPercent'>+ " +
      prettify(game.global.trimpsGenerated) +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  ...
  if (game.global.totalGifts > 0) {
    ...
    textString +=
      "<tr><td class='bdTitle'>Territory Bonus</td><td class='bdPercent'>+ " +
      prettify(game.global.totalGifts) +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  ...
  if (game.unlocks.impCount.TauntimpAdded > 0) {
    ...
    textString +=
      "<tr><td class='bdTitle'>Tauntimp</td><td class='bdPercent'>+ " +
      prettify(game.unlocks.impCount.TauntimpAdded) +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  ...
  if (getPerkLevel("Carpentry") > 0) {
    ...
    textString +=
      "<tr><td class='bdTitle'>Carpentry</td><td class='bdPercent'>+ " +
      carpentryStrength +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  ...
  if (potionCrafting > 1) {
    ...
    currentCalc = Math.floor(currentCalc);
    textString +=
      "<tr><td class='bdTitle'>Elixir of Crafting</td><td class='bdPercent'>+ " +
      prettify((potionCrafting - 1) * 100) +
      "%</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  if (autoBattle.bonuses.Scaffolding.level > 0) {
    ...
    currentCalc = Math.floor(currentCalc);
    textString +=
      "<tr><td class='bdTitle'>Scaffolding</td><td class='bdPercent'>+ " +
      prettify((mult - 1) * 100) +
      "%</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  ...
  if (challengeActive("Size")) {
    ...
    textString +=
      "<tr style='color: red'><td class='bdTitle'>Huge</td><td class='bdPercent'>x 0.5</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  if (game.global.challengeActive == "Daily") {
    if (typeof game.global.dailyChallenge.large !== "undefined") {
      var mult = dailyModifiers.large.getMult(
        game.global.dailyChallenge.large.strength
      );
      currentCalc = Math.floor(currentCalc * mult);
      textString +=
        "<tr style='color: red'><td class='bdTitle'>Large (Daily)</td><td class='bdPercent'>x " +
        mult.toFixed(2) +
        "</td><td class='bdNumber'>" +
        prettify(currentCalc) +
        "</td></tr>";
...
function getMaxResources(what) {
  ...
  if (getPerkLevel("Packrat")) {
    ...
    textString +=
      "<tr><td class='bdTitle'>Packrat</td><td class='bdPercent'>+ " +
      packAmt +
      "</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
...
function getLootBd(what) {
  ...
  var textString =
    '	<div><ul id="lootBdTabs" class="nav nav-tabs nav-justified"><li role="presentation" onclick="getLootBd(\'Food/Wood/Metal\')"><a href="#">Food/Wood/Metal</a></li>';
  if (game.global.mapsUnlocked)
    textString +=
      '<li role="presentation" onclick="getLootBd(\'Fragments\')"><a href="#">Fragments</a></li><li role="presentation" onclick="getLootBd(\'Gems\')"><a href="#">Gems</a></li>';
  if (
    (game.global.universe == 1 && game.global.world >= 20) ||
    (game.global.universe == 2 && game.global.world > 15)
  )
    textString +=
      '<li role="presentation" onclick="getLootBd(\'Helium\')"><a href="#">' +
      heliumOrRadon() +
      "</a></li>";
  textString += "</ul></div>";
  var name = what == "Helium" ? heliumOrRadon() : what;
  textString +=
    "<table class='bdTableSm table table-striped'><tbody><tr><td style='font-weight: bold; font-size: 1.1em'>" +
    name +
    "</td><td>Base</td><td>Amount</td><td>Line Total</td><td>Total</td></tr>";
  var currentCalc = 0;
  var percent = 0;
  var amt = 0;
  switch (what) {
    case "Food/Wood/Metal":
      var tempModifier =
        ...
        Math.pow(
          1.25,
          game.global.world >= 59 && game.global.universe == 1
            ? 59
            : game.global.world
        );
      //Mega books
      ...
      currentCalc = amt;
      textString +=
        "<tr><td class='bdTitle'>Base</td><td></td><td></td><td>" +
        prettify(amt) +
        "</td><td>" +
        prettify(currentCalc) +
        "</td></tr>";
      if (
        ...
        currentCalc *= tBonus;
        textString +=
          "<tr><td class='bdTitle'>Turkimp</td><td></td><td></td><td>+ " +
          prettify((tBonus - 1) * 100) +
          "%</td><td>" +
          prettify(currentCalc) +
          "</td></tr>";
      }
      ...
      currentCalc *= amt;
      textString +=
        "<tr><td class='bdTitle'>Trimps</td><td>0.16</td><td>" +
        prettify(game.resources.trimps.realMax()) +
        "</td><td>x " +
        prettify(amt) +
        "</td><td>" +
        prettify(currentCalc) +
    ...
    case "Gems":
      ...
      if (game.jobs.Dragimp.owned >= 1) {
        ...
        currentCalc += amt;
        textString +=
          "<tr><td class='bdTitle'>Dragimp Scouting</td><td></td><td></td><td>+ " +
          prettify(amt) +
          "</td><td>" +
          prettify(currentCalc) +
          "</td></tr>";
    ...
    case "Helium":
      ...
      if (
        ...
        (game.global.world == 59 && game.global.mapsActive)
      )
        baseAmt = 1;
      else if (game.global.world < mutations.Corruption.start(true))
        baseAmt = 5;
      else baseAmt = 10;
      ...
      if (baseAmt >= 5) {
        if (mutations.Magma.active()) {
          currentCalc *= 15;
          textString +=
            "<tr><td class='bdTitle'>Omnipotrimp Bonus</td><td></td><td></td><td>x 15</td><td>" +
            prettify(currentCalc) +
            "</td></tr>";
        } else {
          currentCalc *= 5;
          textString +=
            "<tr><td class='bdTitle'>Improbability Bonus</td><td></td><td></td><td>x 5</td><td>" +
            prettify(currentCalc) +
            "</td></tr>";
        }
      }
      ...
      if (baseAmt >= 10) {
        currentCalc *= 2;
        textString +=
          "<tr><td class='bdTitle'>Corruption Bonus</td><td></td><td></td><td>x 2</td><td>" +
          prettify(currentCalc) +
          "</td></tr>";
      }
      if (getSLevel() >= 5) {
        ...
        currentCalc *= amt;
        textString +=
          "<tr><td class='bdTitle'>Scientist V</td><td></td><td></td><td>x " +
          prettify(amt) +
          "</td><td>" +
          prettify(currentCalc) +
          "</td></tr>";
      ...
      if (
        game.talents.scry2.purchased &&
        game.global.voidBuff &&
        game.global.canScryCache
      ) {
        currentCalc *= 1.5;
        textString +=
          "<tr><td class='bdTitle'>Scryhard II</td><td></td><td></td><td>+ 50%</td><td>" +
          prettify(currentCalc) +
          "</td></tr>";
      }
      if (game.global.voidBuff) {
        currentCalc *= 2;
        textString +=
          "<tr><td class='bdTitle'>Void Map</td><td></td><td></td><td>x 2</td><td>" +
          prettify(currentCalc) +
          "</td></tr>";
      }
      ...
      if (game.jobs.Meteorologist.vestedHires > 0) {
        ...
        currentCalc *= amt;
        textString +=
          "<tr><td class='bdTitle'>Meteorologists</td><td>" +
          prettify(pct) +
          "%</td><td>" +
          game.jobs.Meteorologist.vestedHires +
          "</td><td>+ " +
          prettify(pct * game.jobs.Meteorologist.vestedHires) +
          "%</td><td>" +
          prettify(currentCalc) +
          "</td></tr>";
      }
      if (
        ...
        currentCalc *= 2;
        textString +=
          "<tr><td class='bdTitle'>Completed Quest!</td><td>+ 100%</td><td>&nbsp;</td><td>+ 100%</td><td>" +
          prettify(currentCalc) +
          "</td></tr>";
      }
      if (game.global.challengeActive == "Archaeology") {
        ...
        currentCalc *= mult;
        textString +=
          "<tr><td class='bdTitle'>Radon Relic</td><td>x 1.05</td><td>" +
          points +
          "</td><td>x " +
          prettify(mult) +
          "</td><td>" +
      ...
      if (
        ...
        currentCalc *= mult;
        textString +=
          "<tr><td class='bdTitle'>Advanced Processing (Glass)</td><td>x 1.1</td><td>" +
          (game.global.world - 175) +
          "</td><td>x " +
          prettify(mult) +
          "</td><td>" +
      ...
      if (game.global.universe == 2 && game.global.world >= 201) {
        ...
        currentCalc *= mult;
        textString +=
          "<tr><td class='bdTitle'>Mutated Zone</td><td>x " +
          mult +
          "</td><td></td><td>x " +
          mult +
          "</td><td>" +
  ...
  if (game.global.mapsActive && what != "Helium") {
    ...
    if (world > compareLv && map.location != "Bionic") {
      ...
      currentCalc *= amt;
      textString +=
        "<tr><td class='bdTitle'>Extra Map Zones</td><td>+10%</td><td>x " +
        (world - compareLv) +
        "</td><td>+ " +
        prettify((amt - 1) * 100) +
        "%</td><td>" +
      ...
      if (world < compareLv) {
        ...
        currentCalc *= amt;
        textString +=
          "<tr style='color: red'><td class='bdTitle'>Low Map Level</td><td>-20%</td><td>" +
          (compareLv - world) +
          "</td><td>x " +
          prettify(amt) +
          "</td><td>" +
    ...
    textString +=
      "<tr><td class='bdTitle'>Map Loot</td><td></td><td></td><td>+ " +
      Math.round((map.loot - 1) * 100) +
      "%</td><td>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  if (game.global.challengeActive == "Insanity") {
    ...
    currentCalc *= mult;
    textString +=
      "<tr><td class='bdTitle'>Insane (Insanity)</td><td>+ 13.13%</td><td>" +
      game.challenges.Insanity.insanity +
      "</td><td>x " +
      mult.toFixed(4) +
      "</td><td>" +
  ...
  if (game.challenges.Nurture.boostsActive() && what != "Helium") {
    ...
    currentCalc *= mult;
    textString +=
      "<tr><td class='bdTitle'>Cruffys</td><td>Lv " +
      game.challenges.Nurture.getLevel() +
      "</td><td></td><td>" +
      formatMultAsPercent(mult) +
      "</td><td>" +
  ...
  if (getPerkLevel("Looting")) {
    ...
    currentCalc *= amt;
    textString +=
      "<tr><td class='bdTitle'>Looting (perk)</td><td>+ 5%</td><td>" +
      getPerkLevel("Looting") +
      "</td><td>+ " +
      prettify((amt - 1) * 100) +
      "%</td><td>" +
      prettify(currentCalc) +
  ...
  if (getPerkLevel("Looting_II")) {
    ...
    currentCalc *= amt;
    textString +=
      "<tr><td class='bdTitle'>Looting II (perk)</td><td>+ " +
      prettify(game.portal.Looting_II.modifier * 100) +
      "%</td><td>" +
      prettify(getPerkLevel("Looting_II")) +
      "</td><td>+ " +
      prettify((amt - 1) * 100) +
      "%</td><td>" +
      prettify(currentCalc) +
  ...
  if (getPerkLevel("Greed")) {
    ...
    currentCalc *= amt;
    textString +=
      "<tr><td class='bdTitle'>Greed (perk)</td><td>x" +
      " " +
      prettify(game.portal.Greed.getBonusAmt()) +
      "</td><td>" +
  ...
  var potionFinding =
    game.global.challengeActive == "Alchemy"
      ? alchObj.getPotionEffect("Potion of Finding")
      : "";
  if (what != "Helium" && what != "Fragments" && potionFinding > 1) {
    currentCalc *= potionFinding;
    textString +=
      "<tr><td class='bdTitle'>Potion of Finding</td><td>+ 25%</td><td>" +
      alchObj.getPotionCount("Potion of Finding") +
      "</td><td>+ " +
      prettify((potionFinding - 1) * 100) +
      "%</td><td>" +
      prettify(currentCalc) +
  ...
  if (what != "Helium" && what != "Fragments" && potionFinding > 1) {
    currentCalc *= potionFinding;
    textString +=
      "<tr><td class='bdTitle'>Elixir of Finding</td><td>x 1.05</td><td>" +
      alchObj.getPotionCount("Elixir of Finding") +
      "</td><td>+ " +
      prettify((potionFinding - 1) * 100) +
      "%</td><td>" +
      prettify(currentCalc) +
  ...
  if (what == "Helium" && gaseousPotion > 1) {
    ...
    textString +=
      "<tr><td class='bdTitle'>Gaseous Brew</td><td>+ 10%</td><td>" +
      alchObj.getPotionCount("Gaseous Brew") +
      "</td><td>+ " +
      prettify((gaseousPotion - 1) * 100) +
      "%</td><td>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  if (game.global.challengeActive == "Quagmire") {
    ...
    currentCalc *= amt;
    textString +=
      "<tr><td class='bdTitle'>Motivated (Quagmire)</td><td>+ 40%</td><td>" +
  ...
  if (Fluffy.isRewardActive("wealthy") && what != "Helium") {
    currentCalc *= 2;
    textString +=
      "<tr><td class='bdTitle'>Wealthy (" +
      Fluffy.getName() +
      ")</td><td>+ 100%</td><td>&nbsp;</td><td>+ 100%</td><td>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  if (game.unlocks.impCount.Magnimp && what != "Helium") {
    ...
    textString +=
      "<tr><td class='bdTitle'>Magnimp</td><td>+ 0.3%</td><td>" +
  ...
  if (challengeActive("Toxicity")) {
    ...
    toxMult = (toxMult * 100).toFixed(1) + "%";
    textString +=
      "<tr><td class='bdTitle'>Tweaky (Toxicity)</td><td>+" +
  ...
  if (game.global.challengeActive == "Decay" && what != "Helium") {
    currentCalc *= 10;
    textString +=
      "<tr><td class='bdTitle'>Sanity (Decay)</td><td></td><td></td><td class='bdPercent'>x 10</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
    var stackStr = Math.pow(
      game.challenges.Decay.decayValue,
  ...
  if (game.global.challengeActive == "Melt" && what != "Helium") {
    currentCalc *= 10;
    textString +=
      "<tr><td class='bdTitle'>Sanity (Melt)</td><td></td><td></td><td class='bdPercent'>x 10</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
    var stackStr = Math.pow(
      game.challenges.Melt.decayValue,
    ...
    currentCalc *= stackStr;
    textString +=
      "<tr style='color: red'><td class='bdTitle'>Melt</td><td>x 0.99</td><td>" +
      game.challenges.Melt.stacks +
      "</td><td class='bdPercent'>x " +
      stackStr.toFixed(3) +
      "</td><td class='bdNumber'>" +
  ...
  if (challengeActive("Watch") && what != "Helium") {
    currentCalc /= 2;
    textString +=
      "<tr style='color: red'><td class='bdTitle'>Sleepy (Watch)</td><td></td><td></td><td class='bdPercent'>50%</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  if (challengeActive("Lead") && game.global.world % 2 == 1) {
    currentCalc *= 2;
    textString +=
      "<tr><td class='bdTitle'>Determined (Lead)</td><td></td><td></td><td class='bdPercent'>+ 100%</td><td class='bdNumber'>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  if (game.global.challengeActive == "Daily") {
    ...
    if (
      ...
      mult = dailyModifiers.karma.getMult(
        game.global.dailyChallenge.karma.strength,
        game.global.dailyChallenge.karma.stacks
      );
      currentCalc *= mult;
      textString +=
        "<tr><td class='bdTitle'>Karma (Daily)</td><td class='bdPercent'>x  " +
        mult.toFixed(3) +
        "</td><td></td><td>x  " +
        mult.toFixed(3) +
        "</td><td class='bdNumber'>" +
  ...
  if (
    ...
    currentCalc *= mult;
    textString +=
      "<tr><td class='bdTitle'>Resource Relic</td><td>x 1.05</td><td>" +
      points +
      "</td><td>x " +
      prettify(mult) +
      "</td><td>" +
  ...
  if (game.global.spireRows > 0) {
    ...
    currentCalc *= 1 + amt;
    textString +=
      "<tr><td class='bdTitle'>Spire Rows</td><td>+ " +
      Math.round(spireRowBonus * 100) +
      "%</td><td>" +
      game.global.spireRows +
      "</td><td>+ " +
      prettify(amt * 100) +
  ...
  if (
    game.global.voidBuff &&
    what == "Helium" &&
    game.talents.voidSpecial.purchased
  ) {
    amt = getLastPortal() * 0.0025;
    currentCalc *= 1 + amt;
    textString +=
      "<tr><td class='bdTitle'>Void Special</td><td></td><td></td><td>+ " +
      prettify(amt * 100) +
      "%</td><td>" +
      prettify(currentCalc) +
      "</td></tr>";
  ...
  if (
    what != "Fragments" &&
    getEmpowerment() == "Wind" &&
    (what != "Helium" || !game.global.mapsActive)
  ) {
    var windMod;
    var baseMod = 0;
    if (what == "Helium") {
    ...
    currentCalc *= 1 + windMod;
    textString +=
      "<tr><td class='bdTitle'>Swiftness (Wind)</td><td>" +
      prettify(baseMod) +
      "%</td><td>" +
      prettify(game.empowerments.Wind.currentDebuffPower) +
      "</td><td class='bdPercent'>+ " +
      prettify(windMod * 100) +
      "%</td><td class='bdNumber'>" +
      prettify(currentCalc) +
  ...
  if (what != "Helium" && isScryerBonusActive()) {
    currentCalc *= 2;
    textString +=
      "<tr><td class='bdTitle'>Formation</td><td></td><td></td><td>x 2</td><td>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  if (
    ...
    currentCalc *= 10;
    textString +=
      "<tr><td class='bdTitle'>Enlightened Wind</td><td></td><td></td><td>x 10</td><td>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  ...
  if (what == "Helium" && playerSpireTraps.Condenser.owned) {
    ...
    currentCalc *= 1 + amt / 100;
    textString +=
      "<tr><td class='bdTitle'>Condenser Tower" +
      needAnS(playerSpireTraps.Condenser.owned) +
      "</td><td>+ " +
      prettify(playerSpireTraps.Condenser.getWorldBonus(true)) +
      "%</td><td>" +
  ...
  if (game.singleRunBonuses.heliumy.owned && what == "Helium") {
    ...
    textString +=
      "<tr><td class='bdTitle'>" +
      game.singleRunBonuses.heliumy.name +
      "</td><td>25%</td><td></td><td>+ 25%</td><td>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  if (
  ...
  if (
    ...
    currentCalc *= amt;
    textString +=
      "<tr><td class='bdTitle'>Spire Assault Radon</td><td>+ 10%</td><td>" +
      autoBattle.bonuses.Radon.level +
      "</td><td>+ " +
      prettify((amt - 1) * 100) +
      "%</td><td>" +
      prettify(currentCalc) +
  ...
  if (
    ...
    what == "Food/Wood/Metal"
  ) {
    var mult = game.challenges.Hypothermia.getWoodMult();
    if (mult != 1) {
      currentCalc *= mult;
      textString +=
        "<tr style='color: red'><td class='bdTitle'>Hypothermia (Wood only)</td><td class='bdPercent'>x0.95</td><td>" +
        game.challenges.Hypothermia.embers +
        "</td><td>x " +
        prettify(mult) +
        "</td><td class='bdNumber'>" +
        prettify(currentCalc) +
  ...
  if (
    ...
    currentCalc *= mult;
    textString +=
      "<tr style='color: red'><td class='bdTitle'>Desolation</td><td>-" +
      game.challenges.Desolation.getReducePercent() * 100 +
      "%</td><td>" +
      (game.global.world - 1) +
      "</td><td class='bdPercent'>x " +
      prettify(mult) +
  ...
  if (
    game.global.universe == 2 &&
    u2Mutations.tree.Loot.purchased &&
    what != "Helium"
  ) {
    currentCalc *= 1.5;
    textString +=
      "<tr><td class='bdTitle'>Loot Mutator</td><td>+ 50%</td><td></td><td>+ 50%</td><td>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  if (game.global.challengeActive == "Hypothermia" && what == "Helium") {
    ...
    currentCalc *= mult;
    textString +=
      "<tr><td class='bdTitle'>Hypothermia</td><td class='bdPercent'>+300%</td><td>" +
      game.challenges.Hypothermia.embers +
      "</td><td>+ " +
      prettify((mult - 1) * 100) +
      "%</td><td class='bdNumber'>" +
  ...
  if (game.global.challengeActive == "Domination" && what == "Helium") {
    textString +=
      "<tr><td class='bdTitle'>Domination (Boss Only)</td><td>x 3</td><td></td><td>x 3</td><td>" +
      prettify(currentCalc * 3) +
      "</td></tr>";
  ...
  if (
    what == "Helium" &&
    !game.global.voidBuff &&
    game.global.world >= mutations.Corruption.start()
  ) {
    ...
    textString +=
      "<tr class='corruptedCalcRow'><td class='bdTitle' style='vertical-align: middle'>Corruption Value</td><td>" +
      corrVal +
      "%<br/>" +
      corrCount +
      " Cells</td><td>Per Cell:<br/>" +
      prettify(corrCalc) +
      "</td><td>Per Zone:<br/>" +
      prettify(Math.round(corrCalc * corrCount)) +
  ...
  if (what == "Helium" && mutations.Healthy.active() && !game.global.voidBuff) {
    ...
    textString +=
      "<tr class='healthyCalcRow'><td class='bdTitle' style='vertical-align: middle'>Healthy Value</td><td>" +
      healthyVal +
      "%<br/>" +
      healthyCount +
      " Cells</td><td>Per Cell:<br/>" +
      prettify(healthyCalc) +
      "</td><td>Per Zone:<br/>" +
      prettify(Math.round(healthyCalc * healthyCount)) +
      "</td><td style='vertical-align: middle'>" +
      prettify(fullCorVal + healthyCalc * healthyCount) +
      "</td></tr>";
  }
  //Healthy - Void Maps
  ...
  if (
    what == "Helium" &&
    game.global.voidBuff &&
    mutations.Corruption.active()
  ) {
    var corruptedCells = mutations.Corruption.cellCount();
    if (mutations.Healthy.active())
      corruptedCells -= mutations.Healthy.cellCount();
    var corrVal = game.global.challengeActive == "Corrupted" ? 7.5 : 15;
    var percent = (corrVal / 100) * corruptedCells;

    if (mutations.Healthy.active()) {
      textString +=
        "<tr class='corruptedCalcRow mutationSumRow'><td class='bdTitle'>Corruption Value</td><td>" +
        corrVal +
        "%</td><td>" +
        corruptedCells +
        "</td><td>+ " +
        prettify(Math.round(percent * 100)) +
        "%</td><td></td></tr>";
      ...
      textString +=
        "<tr class='healthyCalcRow mutationSumRow'><td class='bdTitle'>Healthy Value</td><td>" +
        healthyVal +
        "%</td><td>" +
        healthyCells +
        "</td><td>+ " +
        prettify(Math.round(healthyPercent * 100)) +
        "%</td><td></td></tr>";
      var mutationPercent = percent + healthyPercent;
      currentCalc *= mutationPercent + 1;
      textString +=
        "<tr class='mutationSumRow mutationTotalRow'><td class='bdTitle'>Mutation Total</td><td></td><td>" +
        (healthyCells + corruptedCells) +
        "</td><td>+ " +
        prettify(Math.round(mutationPercent * 100)) +
        "%</td><td>" +
        prettify(currentCalc) +
        "</td></tr>";
    } else {
      ...
      currentCalc *= percent;
      textString +=
        "<tr class='corruptedCalcRow'><td class='bdTitle'>Corruption Value</td><td>" +
        corrVal +
        "%</td><td>" +
        corruptedCells +
        "</td><td>x " +
  ...
  if (
    ...
    if (game.talents.voidMastery.purchased)
      bonusMod = Math.pow(1.5, countedStacks);
    var flatBonus = currentCalc * bonusMod * stacks;
    currentCalc += flatBonus;
    textString +=
      "<tr class='fluffyCalcRow'><td class='bdTitle'>Stacked Map" +
      needAnS(stacks) +
      " (Fluffy)</td><td>+ " +
      prettify((bonusMod - 1) * 100) +
      "%</td><td>" +
      stacks +
      " extra</td><td>+ " +
      prettify(flatBonus) +
  ...
  if (game.global.runningChallengeSquared && what == "Helium") {
    ...
    var cMode = game.global.universe == 1 ? 2 : 3;
    textString +=
      "<tr class='colorSquared'><td class='bdTitle'>Challenge<sup>" +
      cMode +
      "</sup></td><td></td><td></td><td>0%</td><td>" +
      prettify(currentCalc) +
      "</td></tr>";
  }
  ...
  if (what == "Food/Wood/Metal") {
    ...
    if (heirloomBonus > 0) {
      textString +=
        "<tr><td class='bdTitle'>Heirloom - Food (Staff)</td><td></td><td></td><td>+ " +
        prettify(heirloomBonus) +
        "%</td><td>" +
        prettify(currentCalc * (heirloomBonus / 100 + 1)) +
        "</td></tr>";
      heirloomBonus = 0;
    }
    ...
    if (heirloomBonus > 0) {
      textString +=
        "<tr><td class='bdTitle'>Heirloom - Wood (Staff)</td><td></td><td></td><td>+ " +
        prettify(heirloomBonus) +
        "%</td><td>" +
        prettify(currentCalc * (heirloomBonus / 100 + 1)) +
        "</td></tr>";
    ...
    if (heirloomBonus > 0) {
      textString +=
        "<tr><td class='bdTitle'>Heirloom - Metal (Staff)</td><td></td><td></td><td>+ " +
        prettify(heirloomBonus) +
        "%</td><td>" +
        prettify(currentCalc * (heirloomBonus / 100 + 1)) +
        "</td></tr>";
    ...
    if (heirloomBonus > 0) {
      textString +=
        "<tr><td class='bdTitle'>Heirloom (Staff)</td><td></td><td></td><td>+ " +
        prettify(heirloomBonus) +
        "%</td><td>" +
        prettify(currentCalc * (heirloomBonus / 100 + 1)) +
        "</td></tr>";
...
function swapNotation(updateOnly) {
  if (!updateOnly)
    game.options.menu.standardNotation.enabled =
      !game.options.menu.standardNotation.enabled;
  document.getElementById("notationBtn").innerHTML = game.options.menu
    .standardNotation.enabled
    ? "Standard Notation"
    : "Scientific Notation";
...
function resetGame(keepPortal, resetting) {
  ...
  document.getElementById("upgradesTitleSpan").innerHTML =
    "Upgrades<br/>(Research first)";
  ...
  document.getElementById("wrapper").style.background =
    "url(css/bg2.png) center repeat-x";
  ...
  swapClass(
    "shriekState",
    "shriekStateCooldown",
    document.getElementById("chainHolder")
  );
  ...
  document.getElementById("goodGuyName").innerHTML =
    '<span id="realTrimpName">Trimps</span>&nbsp;(<span id="trimpsFighting">1</span>) <span id="anticipationSpan"></span> <span id="titimpBuff"></span> <span id="debuffSpan"></span>';
  ...
  if (keepPortal) {
    ...
    if (
      oldUniverse == 2 &&
      (game.global.world > 25 || game.stats.totalVoidMaps.value > 0)
    )
      lastU2Voids = game.stats.totalVoidMaps.value;
    ...
    if (game.global.dailyHelium) {
      if (game.global.universe == 1)
        game.global.tempHighHelium -= game.global.dailyHelium;
      else if (game.global.universe == 2)
        game.global.tempHighRadon -= game.global.dailyHelium;
    }
    bestHelium =
      game.global.universe == 1 &&
      game.global.tempHighHelium > game.global.bestHelium
        ? game.global.tempHighHelium
        : game.global.bestHelium;
    bestRadon =
      game.global.universe == 2 &&
      game.global.tempHighRadon > game.global.bestRadon
        ? game.global.tempHighRadon
        : game.global.bestRadon;
    if (
      game.global.universe == 1 &&
    ...
    if (game.global.selectedChallenge)
      challenge = game.global.selectedChallenge;
    achieves = game.achievements;
    pres = game.global.presimptStore;
    roboTrimp = game.global.roboTrimpLevel;
    if (game.global.universe == 2) {
      if (
        game.global.world < 25 &&
        game.global.lastRadonPortal >= 25 &&
        game.stats.totalHeirlooms.value == 0
      ) {
    ...
    if (oldUniverse == 1) {
      magmite =
        game.global.magmite > 0
          ? Math.floor(
              game.global.magmite * ((100 - getMagmiteDecayAmt()) / 100)
            )
          : 0;
    ...
    c2s = game.c2;
    firstCustomAmt =
      game.global.firstCustomAmt != -1
        ? game.global.firstCustomAmt
        : game.global.lastCustomAmt;
    firstCustomExact =
      game.global.firstCustomExact != -1
        ? game.global.firstCustomExact
        : game.global.lastCustomExact;
  ...
  if (keepPortal) {
    ...
    if (challenge !== "") {
      if (game.challenges[challenge].multiChallenge) {
        for (
          var ch = 0;
          ch < game.challenges[challenge].multiChallenge.length;
          ch++
        ) {
          game.global.multiChallenge[
            game.challenges[challenge].multiChallenge[ch]
          ] = true;
        }
      }
    }
    ...
    game.global.GeneticistassistSetting = game.options.menu
      .GeneticistassistTarget.disableOnUnlock
      ? -1
      : GeneticistassistSetting;
    ...
    if (improvedAutoStorage) enableImprovedAutoStorage();
    ...
    if (
      game.global.universe == 2 &&
      autoBattle.oneTimers.Expanding_Tauntimp.owned
    )
      game.global.expandingTauntimp = true;
    if (microchipLevel) {
    ...
    for (var statItem in stats) {
      ...
      if (statItem.keepHighest && statItem.value > statItem.valueTotal)
        statItem.valueTotal = statItem.value;
      if (
        typeof statItem.value !== "undefined" &&
        typeof statItem.value !== "function"
      )
        statItem.value = 0;
    ...
    if (challenge !== "") {
      var challengeList;
      if (game.challenges[challenge].multiChallenge)
        challengeList = game.challenges[challenge].multiChallenge;
      else challengeList = [challenge];
      for (var cha = 0; cha < challengeList.length; cha++) {
        if (typeof game.challenges[challengeList[cha]].start !== "undefined")
          game.challenges[challengeList[cha]].start();
      }
    }
    ...
    if (
      game.global.challengeActive == "Daily" &&
      game.global.universe == 2 &&
      game.global.dailyChallenge.seed
    ) {
      game.global.u2MutationSeed = getRandomIntSeeded(
        game.global.dailyChallenge.seed,
        0,
        1000000
      );
  ...
  if (oldUniverse != game.global.universe) {
    ...
    if (game.global.ShieldEquipped.name)
      oldSetting.Shield = game.global.ShieldEquipped.id;
    else oldSetting.Shield = -1;
    if (game.global.StaffEquipped.name)
      oldSetting.Staff = game.global.StaffEquipped.id;
  ...
  setUniverseStyle();
  if (
    Fluffy.isRewardActive("moreVoid") &&
    game.global.lastU2Voids >= 5 &&
    game.global.universe == 2
  ) {
...
function stringToSeed(useString) {
  var useSeed =
    useString.charCodeAt(0) +
    "" +
    useString.charCodeAt(1) +
    "" +
    useString.charCodeAt(2);
  ...
  if (game.global.challengeActive != "Frugal") {
    ...
    for (var x = 0; x < toUnlock.length; x++) {
      ...
      if (
        ...
        upgradeToUnlock.prestige &&
        game.challenges.Pandemonium.isEquipBlocked(
          game.upgrades[toUnlock[x]].prestiges
        )
      )
        continue;
...
function message(
  ...
  if (usingScreenReader) {
    if (type == "Story")
      document.getElementById("srSumLastStory").innerHTML =
        "Z " + game.global.world + ": " + messageString;
    if (type == "Combat")
      document.getElementById("srSumLastCombat").innerHTML = messageString;
  }
  ...
  if (
    extraTag &&
    typeof game.global.messages[type][extraTag] !== "undefined" &&
    !game.global.messages[type][extraTag]
  ) {
    return;
  }
  var log = document.getElementById("log");
  ...
  if (game.options.menu.timestamps.enabled) {
    messageString =
      (game.options.menu.timestamps.enabled == 1
        ? getCurrentTime()
        : updatePortalTimer(true)) +
      " " +
      messageString;
  }
  if (!htmlPrefix) {
    ...
    if (type == "Story")
      messageString =
        "<span class='glyphicon glyphicon-star'></span> " + messageString;
    if (type == "Combat")
      messageString =
        "<span class='glyphicon glyphicon-flag'></span> " + messageString;
    if (type == "Loot" && lootIcon)
      messageString =
        "<span class='" + prefix + lootIcon + "'></span> " + messageString;
    if (type == "Notices") {
      if (lootIcon !== null)
        messageString =
          "<span class='" + prefix + lootIcon + "'></span> " + messageString;
...
function adjustMessageIndexes(index) {
  for (var item in pendingLogs) {
    ...
    for (var x = 0; x < pendingLogs[item].length; x++) {
      if (pendingLogs[item][x] > index) pendingLogs[item][x]--;
    }
  }
}
...
function postMessages() {
  ...
  pendingLogs.RAF = requestAnimationFrame(function () {
    ...
    for (var item in pendingLogs) {
      if (item == "all" || item == "RAF") continue;
      if (pendingLogs[item].length) trimMessages(item);
      pendingLogs[item] = [];
    }
    if (needsScroll) log.scrollTop = log.scrollHeight;
  });
...
function filterMessage(what, updateOnly) {
  //send true for updateOnly
  var log = document.getElementById("log");
...
function filterTabs(what) {
  document.getElementById("talentsTab").style.display =
    game.global.highestLevelCleared >= 180 ? "table-cell" : "none";
  document.getElementById("MasteryTabName").innerHTML = game.global
    .tabForMastery
    ? "Mastery"
    : "Mutators";
  document.getElementById("equalityTab").style.display =
    game.global.universe == 2 && !game.portal.Equality.radLocked
      ? "table-cell"
      : "none";
  ...
  document.getElementById("swapToMutatorsBtn").style.display =
    game.global.highestRadonLevelCleared >= 200 ? "block" : "none";
  var buyContainer = document.getElementById("buyContainer");
  var newBuySize =
    game.global.highestLevelCleared >= 180
      ? "buyContainerSizeLg"
      : "buyContainerSizeSm";
  ...
  for (var tab in tabs) {
    ...
    document.getElementById(tab + "Container").style.display =
      (what == "all" && tab != "talents" && tab != "nature") || tab == what
        ? "block"
        : "none";
  }
...
function enableDisableTab(what, enable) {
  ...
  else elem.className = elem.className.replace("tabSelected", "tabNotSelected");
...
function setMax(amount, forPortal) {
  ...
  document.getElementById(elemName).innerHTML =
    amount != 1 ? game.global.maxSplit : "Max";
  if (forPortal) displayPortalUpgrades(true);
}

function numTab(what, p) {
  var num = 0;
  if (what == 6 && game.global.buyAmt == "Max")
    tooltip("Max", null, "update", p);
  if (what == 5) {
    unlockTooltip();
    tooltip("hide");
    ...
    if (numBox) {
      ...
      if (game.global.firstCustomExact == -1)
        game.global.firstCustomExact = num;
      if (num.split("%")[1] == "") {
        num = num.split("%");
    ...
    if (!isNumberBad(num)) {
      ...
      if (numBox.value == "pants" && game.global.sLevel >= 4) {
        ...
        pantsMode = true;
        message(
          "Get a leg up with PANTS! Until your next trou... browser refresh, you can enable the useless but stylish PANTS ONLY AutoPrestige setting! Denim-ite!",
          "Notices"
        );
        return;
      }
  ...
  for (var x = 1; x <= count; x++) {
    ...
    if (what == x)
      thisTab.className = thisTab.className.replace(
        "tabNotSelected",
        "tabSelected"
      );
    else
  ...
  document.getElementById(tabType + "6Text").innerHTML =
    what == 6 && game.global.maxSplit != 1 ? game.global.maxSplit : "Max";
  if (p) {
...
function convertNotationsToNumber(num) {
  ...
  if (letters.length) {
    ...
    if (base)
      num = Math.round(
        parseFloat(num.split(letters)[0]) * Math.pow(1000, base)
      );
  }
...
function addQueueItem(what) {
  ...
  elem.innerHTML +=
    '<div class="queueItem" id="queueItem' +
    game.global.nextQueueId +
    '" onmouseover="tooltip(\'Queue\',null,event)" onmouseout="tooltip(\'hide\')" onClick="removeQueueItem(\'queueItem' +
    game.global.nextQueueId +
    '\'); cancelTooltip();"><span class="queueItemName">' +
    name +
    '</span><div id="animationDiv"></div></div>';
...
function updateSkeleBtn() {
  ...
  document.getElementById("boneBtnText").innerHTML =
    "Trade " +
    prettify(game.global.b) +
    " Bone" +
    (game.global.b == 1 ? "" : "s");
}
...
function updateLabels() {
  ...
  for (var item in game.resources) {
    ...
    if (item == "helium" && game.global.universe == 2)
      toUpdate = game.resources.radon;
    document.getElementById(item + "Owned").innerHTML = prettify(
      Math.floor(toUpdate.owned)
    );
    if (toUpdate.max == -1 || document.getElementById(item + "Max") === null)
      continue;
    var newMax = toUpdate.max;
    if (item != "trimps")
      newMax = calcHeirloomBonus(
        "Shield",
        "storageSize",
        newMax * (game.portal.Packrat.modifier * getPerkLevel("Packrat") + 1)
      );
  ...
  for (var itemA in game.buildings) {
    ...
    elem.innerHTML = game.options.menu.menuFormatting.enabled
      ? prettify(toUpdate.owned)
      : toUpdate.owned;
    if (itemA == "Trap") {
  ...
  for (var itemB in game.jobs) {
    ...
    document.getElementById(itemB + "Owned").innerHTML = game.options.menu
      .menuFormatting.enabled
      ? prettify(toUpdate.owned)
      : toUpdate.owned;
...
function displayEfficientEquipment() {
  ...
  for (var item in game.equipment) {
    ...
    if (
      ...
      (!attackCost ||
        costPer < attackCost ||
        (highlightSetting == 1 && attackTier < equip.prestige))
    ) {
      if (
        highlightSetting != 1 ||
        equip.prestige >= attackTier ||
        !attackTier
      ) {
        attack = item;
        attackCost = costPer;
  ...
  for (var item in game.equipment) {
    ...
    if (item == attack || item == health)
      swapClass("efficient", "efficientYes", elem);
...
function updatePs(jobObj, trimps, jobName) {
  ...
  if (usingRealTimeOffline) return;
  if (
    jobObj.increase == "custom" ||
    (typeof jobObj.increase === "undefined" && !trimps)
  )
    return;
  var psText;
  var elem;
  if (trimps) {
    ...
    //portal Motivation
    if (getPerkLevel("Motivation"))
      psText *=
        1 + getPerkLevel("Motivation") * game.portal.Motivation.modifier;
    if (getPerkLevel("Motivation_II"))
      psText *=
    ...
    if (
      ...
      psText *= 1 + game.permaBoneBonuses.multitasking.mult();
    if (increase != "fragments" && increase != "science") {
      if (game.global.challengeActive == "Alchemy")
        psText *= alchObj.getPotionEffect("Potion of Finding");
      psText *= alchObj.getPotionEffect("Elixir of Finding");
    }
    if (game.global.challengeActive == "Frigid")
      psText *= game.challenges.Frigid.getShatteredMult();
    if (game.global.pandCompletions && increase != "fragments")
      psText *= game.challenges.Pandemonium.getTrimpMult();
    if (game.global.desoCompletions && increase != "fragments")
      psText *= game.challenges.Desolation.getTrimpMult();
    if (
      !game.portal.Observation.radLocked &&
      game.global.universe == 2 &&
      game.portal.Observation.trinkets > 0
    )
      psText *= game.portal.Observation.getMult();
    ...
    if (game.global.challengeActive == "Daily") {
      if (
        ...
        psText *= dailyModifiers.famine.getMult(
          game.global.dailyChallenge.famine.strength
        );
      }
      if (typeof game.global.dailyChallenge.dedication !== "undefined") {
        psText *= dailyModifiers.dedication.getMult(
          game.global.dailyChallenge.dedication.strength
        );
      }
    }
    if (game.global.challengeActive == "Archaeology" && increase != "fragments")
      psText *= game.challenges.Archaeology.getStatMult("science");
    if (game.global.challengeActive == "Insanity" && increase != "fragments")
      psText *= game.challenges.Insanity.getLootMult();
    if (game.global.challengeActive == "Desolation" && increase != "fragments")
      psText *= game.challenges.Desolation.trimpResourceMult();
    if (game.challenges.Nurture.boostsActive() && increase != "fragments")
      psText *= game.challenges.Nurture.getResourceBoost();
    if (game.global.challengeActive == "Hypothermia" && increase == "wood")
      psText *= game.challenges.Hypothermia.getWoodMult(true);
    ...
    if (increase.max != -1) {
      var newMax =
        increase.max +
        increase.max * game.portal.Packrat.modifier * getPerkLevel("Packrat");
  ...
  if (game.options.menu.useAverages.enabled)
    psText = parseFloat(psText) + getAvgLootSecond(jobObj.increase);
  psText = prettify(psText);
  psText = "+" + psText + "/sec";
  elem.textContent = psText;
  swapClass(
    "sizeSec",
    psText.replace(".", "").length >= 11 ? "sizeSecReduced" : "sizeSecRegular",
    elem
  );
}
...
function updateSideTrimps() {
  var trimps = game.resources.trimps;
  document.getElementById("trimpsEmployed").innerHTML = prettify(
    trimps.employed
  );
  var breedEmployed = trimps.employed;
  if (game.permaBoneBonuses.multitasking.owned)
    breedEmployed *= 1 - game.permaBoneBonuses.multitasking.mult();
  var breedCount =
    trimps.owned - breedEmployed > 2
      ? prettify(Math.floor(trimps.owned - breedEmployed))
      : 0;
  document.getElementById("trimpsUnemployed").innerHTML = breedCount;
  document.getElementById("maxEmployed").innerHTML = prettify(
    Math.ceil(trimps.realMax() / 2)
  );
  var free = Math.ceil(trimps.realMax() / 2) - trimps.employed;
  if (free < 0) free = 0;
  var s = free > 1 ? "s" : "";
  document.getElementById("jobsTitleUnemployed").innerHTML =
    prettify(free) + " workspace" + s;
}
...
function drawAllBuildings() {
  ...
  for (var item in game.buildings) {
    ...
    if (building.alert && game.options.menu.showAlerts.enabled) {
      ...
      if (document.getElementById(item + "Alert"))
...
function drawBuilding(what, where) {
  if (usingScreenReader) {
    where.innerHTML +=
      '<button class="thing noSelect pointer buildingThing" onclick="tooltip(\'' +
      what +
      "','buildings','screenRead')\">" +
      what +
      ' Info</button><button title="" onmouseout="tooltip(\'hide\')" class="thingColorCanNotAfford thing noselect pointer buildingThing" id="' +
      what +
      '" onclick="buyBuilding(\'' +
      what +
      '\')"><span class="thingName"><span id="' +
      what +
      'Alert" class="alert badge"></span>' +
      what +
      '</span>, <span class="thingOwned" id="' +
      what +
      'Owned">' +
      game.buildings[what].owned +
      '</span><span class="cantAffordSR">, Not Affordable</span><span class="affordSR">, Can Buy</span></button>';
    return;
  }
  where.innerHTML +=
    "<div onmouseover=\"tooltip('" +
    what +
    '\',\'buildings\',event)" onmouseout="tooltip(\'hide\')" class="thingColorCanNotAfford thing noselect pointer buildingThing" id="' +
    what +
    '" onclick="buyBuilding(\'' +
    what +
    '\')"><span class="thingName"><span id="' +
    ...
    'Alert" class="alert badge"></span>' +
    what +
    '</span><br/><span class="thingOwned" id="' +
    what +
    'Owned">' +
    game.buildings[what].owned +
    "</span></div>";
...
function drawJob(what, where) {
  if (usingScreenReader) {
    where.innerHTML +=
      ...
      what +
      '\',\'jobs\',event)" onmouseout="tooltip(\'hide\')" class="thingColorCanNotAfford thing noselect pointer jobThing" id="' +
      what +
      '" onclick="buyJob(\'' +
      what +
      '\')"><span class="thingName"><span id="' +
      ...
      '</span>, <span class="thingOwned" id="' +
      what +
      'Owned">0</span><span class="cantAffordSR">, Not Affordable</span><span class="affordSR">, Can Buy</span></button>';
    return;
  }
  where.innerHTML +=
    "<div onmouseover=\"tooltip('" +
...
function getUniqueColor(item) {
  if (!game.global.runningChallengeSquared) {
    if (item.name == "The Prison" && challengeActive("Electricity"))
      return " noRecycle";
    if (
      item.name == "The Prison" &&
      game.global.challengeActive == "Mapocalypse"
    )
      return " noRecycle";
    if (
      item.name == "Imploding Star" &&
      game.global.challengeActive == "Devastation"
    )
      return " noRecycle";
  }
  if (item.name == "Frozen Castle") return " noRecycle";
  if (item.name == "Trimple Of Doom" && game.portal.Relentlessness.locked)
    return " noRecycle";
...
function getMapIcon(mapObject, nameOnly) {
  ...
  if (mapObject.voidBuff) return voidBuffConfig[mapObject.voidBuff].icon;
...
function unlockMap(what) {
  ...
  if (item.location == "Void") {
    ...
    tooltip =
      " onmouseover=\"tooltip('Void Map', 'customText', event, 'This Map will scale in level to your current Zone Number, enemies have a random buff, and the boss at the final cell will drop " +
      heliumOrRadon() +
      ". This map will disappear after it is completed once, and leaving the map will reset its progress.');\" onmouseout=\"tooltip('hide')\"";
    loc = "voidMapsHere";
  }
  if (item.location == "Darkness") {
    ...
    level = '<span class="glyphicon glyphicon-globe"></span>';
    tooltip =
      " onmouseover=\"tooltip('Void Map', 'customText', event, 'This Map will scale in level to your current Zone Number. Completing this map will reduce your stacks of Exhausted and Motivated by 1.');\" onmouseout=\"tooltip('hide')\"";
  ...
  if (item.location == "Bionic") {
    if (game.talents.bionic2.purchased)
      abbrev = '<span class="mapSpec"> (P, FA)</span>';
  ...
  if (game.options.menu.extraStats.enabled)
    elem.innerHTML =
      ...
      '" onclick="selectMap(\'' +
      item.id +
      '\')"><div class="onMapIcon"><span class="' +
      getMapIcon(item) +
      '"></span></div><div class="thingName onMapName">' +
      item.name +
      '</div><br/><span class="thingOwned mapLevel"><span class="stackedVoids">' +
      (item.stacked ? "(x" + (item.stacked + 1) + ") " : "") +
      "</span>Level " +
      level +
      abbrev +
      '</span><br/><span class="onMapStats"><span class="icomoon icon-gift2"></span>' +
      Math.floor(item.loot * 100) +
      '% </span><span class="icomoon icon-cube2"></span>' +
      item.size +
      ' <span class="icon icon-warning"></span>' +
      Math.floor(item.difficulty * 100) +
      "%</div>" +
      elem.innerHTML;
  else
    elem.innerHTML =
      ...
      item.name +
      '</span><br/><span class="thingOwned mapLevel"><span class="stackedVoids">' +
      (item.stacked ? "(x" + (item.stacked + 1) + ") " : "") +
      "</span>Level " +
      level +
      abbrev +
      "</span></div>" +
      elem.innerHTML;
  if (item.id == game.global.currentMapId)
    swapClass(
      "mapElement",
      "mapElementSelected",
...
function getMapSpecTag(modifier) {
  return (
    '<span class="mapSpec"> (' +
    mapSpecialModifierConfig[modifier].abv +
    ")</span>"
  );
}
...
function drawUpgrade(what, where) {
  ...
  if (
    upgrade.prestiges &&
    (!upgrade.cost.resources[metal] || !upgrade.cost.resources[wood])
  ) {
    var resName = what == "Supershield" ? "wood" : "metal";
    upgrade.cost.resources[resName] = getNextPrestigeCost(what);
  }
  ...
  if (upgrade.isRelic)
    done = game.challenges.Archaeology.getPoints(upgrade.relic);
  if (usingScreenReader) {
    where.innerHTML +=
      '<button id="srTooltip' +
      what +
      '" class="thing noSelect pointer upgradeThing" onclick="tooltip(\'' +
      what +
      "','upgrades','screenRead')\">" +
      what +
      " Info</button><button onmouseover=\"tooltip('" +
      what +
      '\',\'upgrades\',event)" onmouseout="tooltip(\'hide\')" class="thingColorCanNotAfford thing noselect pointer upgradeThing" id="' +
      what +
      '" onclick="buyUpgrade(\'' +
      what +
      '\')"><span id="' +
      what +
      'Alert" class="alert badge"></span><span class="thingName">' +
      name +
      '</span>, <span class="thingOwned" id="' +
      what +
      'Owned">' +
  ...
  if (!upgrade.isRelic && dif >= 1)
    document.getElementById(what + "Owned").innerHTML =
      upgrade.done + "(+" + dif + ")";
}
...
function checkButtons(what) {
  ...
  if (what == "jobs") {
    ...
    for (var item in game.jobs) {
      ...
      if (
        workspaces <= 0 &&
        !(
          game.jobs[item].allowAutoFire && game.options.menu.fireForJobs.enabled
        )
      )
        updateButtonColor(item, false, true);
      else
        updateButtonColor(
          item,
          canAffordJob(item, false, workspaces, true),
          true
        );
    }
    return;
  ...
  if (what == "upgrades") {
    for (var itemA in game.upgrades) {
      ...
      if (itemA == "Coordination")
        updateButtonColor(
          itemA,
          canAffordTwoLevel(thisUpgrade) && canAffordCoordinationTrimps()
        );
      else if (thisUpgrade.isRelic)
        updateButtonColor(
          itemA,
          canAffordTwoLevel(thisUpgrade) &&
            game.challenges.Archaeology.getPoints(thisUpgrade.relic) < 50
        );
      else updateButtonColor(itemA, canAffordTwoLevel(thisUpgrade));
    }
    return;
  }
  if (what == "buildings") {
  ...
  if (what == "equipment") {
    for (var itemEquip in game.equipment) {
      ...
      updateButtonColor(
        itemEquip,
        canAffordBuilding(itemEquip, null, null, true, true)
      );
    }
    return;
  }
  for (var itemB in where) {
    ...
    for (var cost in where[itemB].cost) {
      ...
      if (typeof costItem[1] !== "undefined")
        numCost = resolvePow(costItem, where[itemB]);
...
function updateButtonColor(what, canAfford, isJob) {
  ...
  if (canAfford) {
    if (
      what == "Gigastation" &&
      (ctrlPressed || game.options.menu.ctrlGigas.enabled)
    )
      swapClass("thingColor", "thingColorCtrl", elem);
...
function drawEquipment(what, elem) {
  ...
  if (equipment.prestige > 1) {
    numeral = usingScreenReader
      ? prettify(equipment.prestige)
      : romanNumeral(equipment.prestige);
  }
  if (usingScreenReader) {
    elem.innerHTML +=
      '<button class="thing noSelect pointer" onclick="tooltip(\'' +
      what +
      "','equipment','screenRead')\">" +
      what +
      " Info</button><button onmouseover=\"tooltip('" +
      what +
      '\',\'equipment\',event)" onmouseout="tooltip(\'hide\')" class="noselect pointer thingColorCanNotAfford thing" id="' +
      what +
      '" onclick="buyEquipment(\'' +
      what +
      '\')"><span class="thingName">' +
      what +
      ' <span id="' +
      ...
      'Numeral">' +
      numeral +
      '</span></span>, <span class="thingOwned">Level: <span id="' +
      what +
      'Owned">0</span></span><span class="cantAffordSR">, Not Affordable</span><span class="affordSR">, Can Buy</span></button>';
    return;
  }
  elem.innerHTML +=
    "<div onmouseover=\"tooltip('" +
    what +
    '\',\'equipment\',event)" onmouseout="tooltip(\'hide\')" class="efficientNo noselect pointer thingColorCanNotAfford thing" id="' +
    what +
    '" onclick="buyEquipment(\'' +
    what +
    '\')"><span class="thingName">' +
    ...
    'Numeral">' +
    numeral +
    '</span></span><br/><span class="thingOwned">Level: <span id="' +
    what +
    'Owned">0</span></span></div>';
}
  ...
  if (elem == null) {
    if (hasNewSetting)
      document.getElementById("settingsText").innerHTML +=
        ' <span class="alert" id="settingsAlert">!</span>';
    return;
  }
...
function displayAllSettings() {
  ...
  for (var item in game.options.menu) {
    ...
    if (typeof optionItem.lockUnless === "function" && !optionItem.lockUnless())
      continue;
...
function toggleSettingSection(toSearch) {
  document.getElementById("searchSettingsWindow").style.display = toSearch
    ? "block"
    : "none";
  document.getElementById("allSettings").style.display = toSearch
    ? "none"
    : "block";
  document.getElementById(
    toSearch ? "allSettingsHere" : "settingSearchResults"
  ).innerHTML = "";
...
function searchSettings(elem) {
  ...
  for (var optionName in game.options.menu) {
    ...
    if (
      typeof optionObject.lockUnless === "function" &&
      !optionObject.lockUnless()
    )
      continue;
    if (search == "new") {
    ...
    if (optionObject.extraTags && optionObject.extraTags.search(search) != -1)
      results.push(optionName);
    else if (optionObject.description.toLowerCase().search(search) != -1)
      results.push(optionName);
    else {
...
function getSettingHtml(optionItem, item, forceClass, appendId) {
  ...
  return (
    ...
    item +
    appendId +
    "' class='noselect settingsBtn settingBtn" +
    optionItem.enabled +
...
function toggleSetting(
  ...
  if (
    setting == "standardNotation" &&
    ctrlPressed &&
    game.options.menu[setting].enabled == 5
  ) {
    ...
    tooltip(
      ...
      null,
      "update",
      "Enter a number here to use as the base for your logarithmic numbers! (Default is 10)<br/><br/><input id='logBaseInput' value='" +
        game.global.logNotBase +
        "' type='number'/>",
      "saveLogarithmicSetting()",
      "Configure Log",
      "Confirm"
    );
    return;
  ...
  if (
    setting == "mapAtZone" &&
    !updateOnly &&
    (menuOption.enabled == 0 || fromHotkey)
  ) {
  ...
  if (!updateOnly) {
    ...
    if (fromPortal) {
      document.getElementById("ptabInfoText").innerHTML = menuOption.enabled
        ? "Less Info"
        : "More Info";
      displayPortalUpgrades(true);
      return;
    ...
    for (var x = 0; x < menuElem.length; x++) {
      ...
      menuElem[x].onmouseover = function (event) {
        tooltip(
          menuOption.titles[menuOption.enabled],
          "customText",
          event,
...
function achievementCompatibilityUnlock() {
  ...
  checkAchieve(
    "damage",
    calculateDamage(game.global.soldierCurrentAttack, true, true, true),
    false,
    true
  );
  ...
  for (var item in game.achievements.housing.breakpoints) {
    ...
    if (game.buildings[item] && game.buildings[item].owned > 0)
      checkAchieve("housing", item, false, true);
    else break;
  }
...
function displayAchievementPopup(id, forHover, displayNumber, forTracker) {
  ...
  if (
    typeof displayNumber == "undefined" &&
    typeof achievement.finished === "number"
  )
    displayNumber = achievement.finished;
  var prog = forTracker
    ? document.getElementById("achievementTrackerProgress")
    : document.getElementById("achievementHoverProgress");
  var one = typeof achievement.finished !== "number";
  var titleElem = document.getElementById("achievement" + location + "Title");
  if (
    (forHover || forTracker) &&
    ((!one && !achievement.showAll && displayNumber > achievement.finished) ||
      (one &&
        achievement.filterLevel() < achievement.filters[displayNumber] &&
        !achievement.finished[displayNumber]))
  ) {
    document.getElementById("achievement" + location).style.display = "block";
    document.getElementById(
      "achievement" + location + "IconContainer"
    ).innerHTML =
      '<span class="achieveTier' +
      achievement.tiers[displayNumber] +
      ' icomoon icon-locked achievementPopupIcon"></span>';
    ...
    document.getElementById("achievement" + location + "Reward").innerHTML =
      "<b>Reward:</b> +" +
      game.tierValues[achievement.tiers[displayNumber]] +
      "% Damage";
    prog.innerHTML = "";
    return;
  }
  ...
  document.getElementById(
    ...
    " " +
    achievement.icon +
    ' achievementPopupIcon"></span>';
  titleElem.innerHTML = achievement.names[displayNumber];
  titleElem.className = "achieveTier" + achievement.tiers[displayNumber];
  document.getElementById("achievement" + location + "Description").innerHTML =
    achievement.description(displayNumber);
  document.getElementById("achievement" + location + "Reward").innerHTML =
    "<b>Reward:</b> +" +
    game.tierValues[achievement.tiers[displayNumber]] +
    "% Damage";
  if (
    (forHover || forTracker) &&
    typeof achievement.progress !== "undefined" &&
    (typeof achievement.highest === "undefined" ||
      achievement.highest > 0 ||
      achievement.finished > 0)
  ) {
    if (!one && achievement.tiers.length == achievement.finished) {
      prog.innerHTML =
        "Row Finished! (" + achievement.progress(displayNumber) + ")";
    } else {
      if (achievement.timed && displayNumber == achievement.finished) {
        if (achievement.u != game.global.universe)
          prog.innerHTML =
            "You're in the wrong Universe! " +
            achievement.progress(displayNumber);
        else if (
          achievement.evaluate() >= achievement.breakpoints[displayNumber]
        )
          prog.innerHTML =
            "Progress: Too slow! " + achievement.progress(displayNumber);
        else
  ...
  } else if (!one && achievement.tiers.length == achievement.finished) {
    prog.innerHTML = "Row Finished!";
  } else prog.innerHTML = "";
}

function checkAchieve(id, evalProperty, doubleChecking, noDisplay) {
  if (id == "housing" && checkHousing(false, true) >= 100)
    giveSingleAchieve("Realtor");
  var achievement = game.achievements[id];
  if (typeof achievement.evaluate !== "undefined")
    evalProperty = achievement.evaluate();
  if (achievement.timed && evalProperty < 0) return;
  if (typeof achievement.highest !== "undefined") {
    if (achievement.reverse) {
      if (achievement.highest === 0 || evalProperty < achievement.highest)
        achievement.highest = evalProperty;
    } else {
      if (evalProperty > achievement.highest)
        achievement.highest = evalProperty;
    }
  }
  ...
  } else if (evalProperty != achievement.breakpoints[achievement.finished])
    return;
...
function giveSingleAchieve(index) {
  ...
  if (
    ...
    area = "oneOffs2"; //U2 achievements but completable in U1
...
function displayAchievements() {
  ...
  if (usingScreenReader) {
    htmlString +=
      "<table class='screenReaderAchievements'><tbody><tr><td>Achievement Tier Values</td>";
    for (var y = 1; y < game.tierValues.length; y++) {
      htmlString +=
        "<td> Tier " + y + " is worth " + game.tierValues[y] + "% damage</td>";
    }
    htmlString += "</tr>";
  }
  for (var item in game.achievements) {
    count++;
    var achievement = game.achievements[item];
    if (typeof achievement.display !== "undefined" && !achievement.display())
      continue;
    ...
    if (usingScreenReader) {
      for (var x = 0; x < amount; x++) {
        if (
          ...
          game.options.menu.hideCompleteAchieves.enabled == 0
        )
          continue;
        if (
          one &&
        ...
        if (x == 0) {
          ...
          if (
            hasProgress &&
            !one &&
            achievement.tiers.length == achievement.finished
          ) {
        ...
        if (one && achievement.filters[x] == -1 && !achievement.finished[x])
          continue;
        htmlString += "<td>";
        if (
          ...
          if (item == "humaneRun" || item == "mapless")
            htmlString +=
              achievement.evaluate() == 0
                ? "Not complete, failed for this run."
                : "Not complete";
          else if (achievement.timed) {
            if (game.global.universe != achievement.u)
              htmlString += "You're in the wrong Universe!";
            else if (
              achievement.evaluate() >
              achievement.breakpoints[achievement.finished]
            )
              htmlString += "This run is already too long!";
          } else
            htmlString +=
    ...
    if (amount > 48) titleClass += " quinTall";
    else if (amount > 36) titleClass += " quadTall";
    else if (amount > 24) titleClass += " tripleTall";
    else if (amount > 12) titleClass += " doubleTall";

    var tempHtmlString =
      '<div class="achievementsContainer"><div ' +
      titleClass +
      '">' +
      achievement.title +
      '</div><span class="littleAchievementWrapper">';
    var width = 7.3;
    var added = 0;
    for (var x = 0; x < amount; x++) {
      if (
      ...
      if (
        game.global.trackedAchieve &&
        item == game.global.trackedAchieve[0] &&
        x == game.global.trackedAchieve[1]
      )
        tierValue +=
          "<span style='color: black;' class='icomoon icon-map-pin pinnedAchieve'></span>";
      if (
        (!one && achievement.finished == x) ||
        (one &&
          !achievement.finished[x] &&
        ...
        if (
          achievement.newStuff.length &&
          achievement.newStuff.indexOf(x) != -1
        )
          tierValue =
            "<span id='" +
            item +
            x +
            "Alert' style='color: yellow;' class='icomoon icon-exclamation-circle'></span>&nbsp;" +
            tierValue;
      } else tierValue = "&nbsp;";
      var icon =
        displayColor == "achieveColorRed"
          ? "icomoon icon-cross2"
          : achievement.icon;
      tierValue = tierValue.replace("{ICONCLASS}", icon);
      var sizeOvr = achievement.size
        ? " font-size: " + achievement.size + "vw;"
        : "";
      tempHtmlString +=
        "<div onclick=\"startTrackAchieve('" +
        item +
        "', " +
        x +
        ')" onmouseover="displayAchievementPopup(\'' +
        item +
        "', true, " +
        x +
        ')" class="achievementContainer achieveTier' +
        achievement.tiers[x] +
        " " +
        displayColor +
        '" style="width: ' +
    ...
    tempHtmlString +=
      '</span><div id="' +
      item +
      'Description" class="achievementDescription")"></div></div>';
    if (added > 0) htmlString += tempHtmlString;
  }
  if (usingScreenReader) htmlString += "</tr></tbody></table>";
  if (!htmlString)
    htmlString = "<br/><br/>You have completed every Achievement!";
  document.getElementById("achievementsHere").innerHTML = htmlString;
  document.getElementById("achievementTotalPercent").innerHTML =
    game.global.achievementBonus;
}
...
function getTierValues() {
  for (var x = 0; x < game.heirlooms.rarities.length; x++) {
    var output =
      x == game.heirlooms.rarities.length - 1
        ? game.heirlooms.rarityBreakpoints[x - 1] + "+: "
        : "<" + game.heirlooms.rarityBreakpoints[x] + ": ";
    var value = 0;
...
function toggleAchievementWindow() {
  ...
  document.getElementById("achievementWrapper").style.display =
    trimpAchievementsOpen ? "none" : "block";
  document.getElementById("wrapper").style.display = trimpAchievementsOpen
    ? "block"
    : "none";
  ...
  var fluff = [
    [
      ", better get some more achievements",
      ", you'd do fine with a few more achievements",
      " but you wish you had a few more achievements",
    ],
    [
      ", your achievement game shows promise",
      " on your path to achievement",
      ", thanks to your achievements",
    ],
    [
      ", thanks to your bounty of achievements",
      ", must be all those achievements",
      ", you are one with the achievements",
      " and you water your achievements daily",
    ],
    [
      ", your Trimps are mighty impressed",
      ", your achievements are mind blowing",
      ". You wake up, achieve, then sleep",
      ", you have achievement in your blood",
    ],
    [
      ", your achievements are beyond mortal comprehension",
      ", Trimps far and wide tell stories of your achievement",
      ", you have achieved achievement",
      ", everything you touch turns to achievement",
    ],
    [
      ", your achievements have achieved achievement",
      ", news of your achievement spreads throughout the galaxy",
      ", achievements bend to your will",
      ", your achievements transcend reality",
    ],
    [
      ", word of your achievement spreads throughout the universe",
      ", everyone else is super jealous",
      ", the achievements of your achievements have achieved achievement",
      ", your achievements have gained sentience",
      ", everyone else just stays home",
      ", you appear if someone says 'Achievement' 3 times in a mirror",
    ],
    [
      ", news of your achievement spreads throughout the multiverse",
      ". It's actually over 9000",
      ", everyone else is legitimately impressed",
      ", your great great grand achievements have achieved achievement",
      ".<br/>If achievement was a game, you would win",
      ". You achieved enlightenment, then your enlightenment started achieving",
      ", your Trimps tell all their friends how cool you are",
      ", you now gain your sustenance from achievements",
      ", your achievements bring all the Trimps to the Barn",
    ],
  ];
  ...
  var failables = {
    ...
    Underbalanced: function () {
      return (
        challengeActive("Balance") &&
        !game.global.runningChallengeSquared &&
        game.challenges.Balance.highestStacks <= 100
      );
    },
    ...
    Thick_Skinned: function () {
      return (
        game.global.challengeActive == "Crushed" &&
        game.challenges.Crushed.critsTaken == 0
      );
    },
    Great_Host: function () {
    ...
    Invisible: function () {
      return (
        game.global.world < 599 ||
        (game.global.spireDeaths == 0 && game.global.spireActive)
      );
    },
    ...
    Unpoppable: function () {
      return (
        game.global.challengeActive == "Bublé" &&
        game.global.canRespecPerks &&
        !game.global.bonePortalThisRun &&
    ...
    Pwnd: function () {
      return (
        game.global.challengeActive == "Duel" &&
        game.challenges.Duel.lowestTrimpStacks >= 20
      );
    },
    Solid: function () {
      return (
        game.global.challengeActive == "Melt" &&
        game.challenges.Melt.largestStacks <= 150
      );
    },
    Coastapalooza: function () {
      return (
        game.global.challengeActive == "Trappapalooza" &&
        !game.challenges.Trappapalooza.trappedAt50
      );
    },
    ...
    Level_Up: function () {
      ...
      return (
        game.global.challengeActive == "Quest" &&
        complete == game.global.world - 5
      );
    },
    Unassisted: function () {
      return (
        game.global.challengeActive == "Archaeology" &&
        game.challenges.Archaeology.overZero == false
      );
    },
    Clear_Skies: function () {
      return (
        game.global.challengeActive == "Storm" && !game.challenges.Storm.mutated
      );
    },
    Actually_Insane: function () {
      return (
        game.global.challengeActive == "Insanity" &&
        (game.global.world < 50 || game.challenges.Insanity.insanity == 500) &&
        game.challenges.Insanity.highestLevel <= 50
      );
    },
    You_re_Doing_it_Wrong: function () {
      return (
        game.global.challengeActive == "Berserk" &&
        (game.global.world < 100 ||
          (game.challenges.Berserk.fullWeakAt != -1 &&
            game.challenges.Berserk.fullWeakAt < 100))
      );
    },
    The_Tortoise_and_the_Bugs: function () {
      return (
        game.global.challengeActive == "Exterminate" &&
        (game.global.world < 120 || game.challenges.Exterminate.achieveDone)
      );
    },
    Nurtured_AF: function () {
      return (
        game.global.challengeActive == "Nurture" &&
        (game.global.world <= 69 || game.challenges.Nurture.achieveDone)
      );
    },
    ...
    Unbreakable: function () {
      return (
        ...
        !game.global.runningChallengeSquared &&
        game.challenges.Glass.highestGlass < 3
      );
    },
  };
...
function getWorldText(zoneNumber) {
  var universe1 = {
    ...
    get w3() {
      if (game.jobs.Scientist.owned > 0)
        return "By your orders, your scientists have begun to try and figure out how large this planet is.";
    ...
    get w22() {
      if (
        ...
        return toZalgo(
          "You hear a strange humming noise that seems to draw you towards it, though it also seems to come from no direction in particular. You can feel that it's being created by " +
            (game.jobs.Amalgamator.owned == 1 ? "the" : "an") +
            " Amalgamator, though you've never heard such a sound before. It's both unsettling and enchanting, and the Universe seems to hate it.",
          4,
          1
        );
    ...
    get w65() {
      if (
        ...
        return toZalgo(
          "The Universe seems even more upset than you expected here, but your Amalgamator" +
            (game.jobs.Amalgamator.owned == 1 ? " doesn't" : "s don't") +
            " really seem to care. You walk towards " +
            (game.jobs.Amalgamator.owned == 1 ? "it" : "one") +
            " to get a better look, but find yourself further away than you were.",
          2,
          2
        );
      ...
      if (
        ...
        return toZalgo(
          (game.jobs.Amalgamator.owned == 1
            ...
            " starting to rapidly switch between different colors. It would be slightly entertaining if the fabric of existence wasn't falling apart around " +
            (game.jobs.Amalgamator.owned == 1 ? "it." : "them."),
          3,
          2
        );
    ...
    get w184() {
      return (
        "The corruption seems to be more pronounced the closer you get to the Spire. Looks like there's " +
        mutations.Corruption.cellCount() +
        " of em now."
      );
    },
    ...
    w245: [
      "Something in the next zone appears to be sucking up all of the Wind again. You've enjoyed all of the extra resources, but you're excited to see what Nature has next for you!",
      "natureMessage wind",
    ],
    w246: [
    ...
    w264: [
      "Good job not high-fiving any Trimps so far this time. You are worried morale might fall if you spend too much time with such a difficult restriction, but you're pretty sure Poison is coming up soon.",
      "natureMessage ice",
    ],
    w267: [
      "You're determined to repair the planet, and now that Nature is on your side you feel it might actually be possible. Either way, you know you must be doing something right to have earned the loyalty of Trimps and Nature.",
      "natureMessage poison",
    ],
    ...
    get w283() {
      ...
      return (
        "During a boring night while waiting to cross a particularly rough Magma river, you managed to teach your Trimps how to stack on each other to create some funny shapes. You almost feel bad for the first Snimp to come across " +
        prettify(soldiers) +
        " Trimps stuck together in the shape of a humongous Mongooseimp."
      );
    },
    get w285() {
      if (game.global.spireRows >= 10)
    ...
    get w303() {
      if (game.global.spireRows >= 15 || Fluffy.getCapableLevel() > 0)
        return "You're glad you have Fluffy around now. He seems to be getting along well with the other Trimps, and seems happy to have found others like him. He doesn't seem to be any smarter than a normal Trimp so you're sure you'll get some entertainment out of him.";
      return "You wish you had a pet.";
    },
    get w315() {
      if (game.global.lastSpireCleared == 2)
        return "These healthy spots of land seem to be increasing as the Spire pumps more and more into the air! Hopefully that's a good thing. You ask Fluffy what he thinks and he nods in approval.";
    ...
    get w360() {
      if (game.global.spireRows >= 15 || Fluffy.getCapableLevel() > 0)
        return "You attempt to put Fluffy through your rigorous Scientist training program, but he doesn't want to. He wouldn't have any trouble, but he doesn't want the label. You still couldn't be happier to have the little guy around!";
    ...
    get w390() {
      if (game.global.lastSpireCleared == 2)
        return "You can finally see the next Spire in the distance, a thick purple cloud boiling out of the top. Hard to believe there's an infinite amount of these things, how big even is this planet?";
    ...
    get w395() {
      if (game.global.lastSpireCleared == 2)
        return "Ahh, that gross old taste of Spire. You'll never get used to that. Most of your Trimps are trying to stay under trees, but Fluffy is running around with his tongue out as if he was trying to catch snowflakes.";
      return "Did you leave the oven on? Oh yeah, you don't have an oven. Now you wonder what an oven even is. Oh well.";
    },
    get w405() {
      if (game.global.lastSpireCleared == 3)
        return "It really seemed like you weakened Druopitee back there. Maybe you'll be able to at least shut off any last conscious parts of him with just one more Spire?";
      return "You can't shake the feeling like you forgot to do something.";
    },
    get w415() {
      if (game.global.lastSpireCleared == 3)
        return "The Healthy mutation is starting to spread nicely now. The Bad Guys hurt quite a bit more, but you're pretty sure you're doing the right thing which kinda makes you feel good.";
      if (game.global.lastSpireCleared == 2)
        return "It seems like the Healthy mutation has stopped spreading. That's alright though, some other version of you will probably take care of it.";
      if (game.global.spireRows >= 15 || Fluffy.getCapableLevel() > 0)
        return "The land sure looks terrible and corrupted, but at least you have Fluffy.";
    ...
    get w485() {
      if (game.global.lastSpireCleared == 3)
        return "Once again, you can taste the Spire, it must just be over that next hill now. Fluffy seems excited.";
      return "Hey! Is that... oh, nope, just some dirt.";
    },
    get w495() {
      if (game.global.lastSpireCleared == 3)
        return "It's time. He's weak. You've got this. Time to make this planet Healthy again.";
      return "You're feeling rather itchy today. You ask some Trimps to scratch your back but they don't really want to.";
    },
    get w505() {
      if (game.global.lastSpireCleared == 4)
        return "Well you've totally 100% eradicated Druopitee's consciousness, now you figure it's just time to clear the rest of his brainless Echoes out of the remaining Spires.";
      return "Druopitee is just over there getting stronger, someone should really do something about him.";
    },
    get w605() {
      if (game.global.lastSpireCleared == 5)
        return "Fluffy seemed to greatly enjoy downing that last Spire, he strongly dislikes those Echoes of Druopitee. Nobody sticks Fluffy in a cage and gets away with it!";
    ...
    get w801() {
      if (game.global.lastSpireCleared == 7)
        return "You finish climbing down the Spire with Fluffy. With the last Spire cleared of Druopitee's echoes, maybe this world can finally start to heal. Unfortunately, this isn't the only Universe where Druopitee has wreaked havoc! You still have some work ahead of you to clean up this mess he made.";
  ...
  var universe2 = {
    ...
    get w118() {
      if (game.global.challengeActive == "Nurture")
        return "Cruffys tells you about the time he put a bucket of water above one of Druopitee's doors as a prank and got banished from the dimension for it.";
    ...
    get w124() {
      return (
        "The next Zone is connected to this one by a large downward sloping hill. All " +
        prettify(game.resources.trimps.getCurrentSend()) +
        " of your Trimps all tuck themselves into a ball and roll down it, what a sight!"
      );
    },
    get w130() {
      if (game.global.challengeActive == "Nurture")
        return "Scruffy plays his Riflunger while Cruffys sings, and you really wish you had some earplugs or something.";
    ...
    get w140() {
      if (autoBattle.sessionEnemiesKilled > autoBattle.sessionTrimpsKilled)
        return "Huffy pops a quick message into your head to let you know he's doing fine in the Spire!";
  ...
  if (typeof thisUniverse["w" + zoneNumber] !== "undefined")
    return thisUniverse["w" + zoneNumber];
  return false;
}
...
function setGoldenBonusAchievementText() {
  ...
  if (tier < tiers.length)
    html += " Frequency increases at " + tiers[tier] + "% bonus damage.";
  else {
    var count = countExtraAchievementGoldens();
    if (bonus <= 10000)
      html +=
        " Start with 1 extra Golden Upgrade after each Portal for every 500% earned between 2000% and " +
        prettify(10000);
    else if (bonus <= 50000)
      html +=
        " Start with 1 extra Golden Upgrade after each Portal for every 2000% earned between " +
        prettify(10000) +
        " and " +
        prettify(50000);
    else
      html +=
        " Start with 1 extra Golden Upgrade after each Portal for every " +
        prettify(10000) +
        "% earned above " +
        prettify(50000);
    html +=
...
function toggleAchievementHelp() {
  document.getElementById("achievementHelp").style.color =
    trimpAchievementHelpOn ? "#202080" : "#6060C0";
  document.getElementById("achievementHeader").style.display =
    trimpAchievementHelpOn ? "block" : "none";
  document.getElementById("achievementHelpContainer").style.display =
    trimpAchievementHelpOn ? "none" : "block";
...
function updateDecayStacks(addStack) {
  ...
  if (
    addStack &&
    challenge.stacks < challenge.maxStacks &&
    game.upgrades.Battle.done > 0
  )
    challenge.stacks++;
  if (elem == null) {
    var icon =
    ...
    document.getElementById("debuffSpan").innerHTML +=
      "<span id='decayStacks' onmouseout='tooltip(\"hide\")' class='badge antiBadge'><span id='decayStackCount'></span> <span class='" +
      icon +
      "'></span></span>";
    elem = document.getElementById("decayStacks");
  }
  if (game.global.challengeActive == "Melt") {
    if (challenge.stacks > challenge.largestStacks)
      challenge.largestStacks = challenge.stacks;
  }
...
function swapClass(prefix, newClass, elem) {
  if (elem == null) {
    console.log(
      "swapClass, No element found. Prefix: " +
        prefix +
        ", newClass: " +
        newClass
    );
  ...
  if (typeof className[1] === "undefined") {
    console.log(
      "swapClass function error: Tried to replace a class that doesn't exist at [" +
        elem.className +
        "] using " +
        prefix +
        " as prefix and " +
  ...
  if (classEnd >= 0)
    className =
      className[0] +
      newClass +
      className[1].slice(classEnd, className[1].length);
  else className = className[0] + newClass;
...
function goRadial(elem, currentSeconds, totalSeconds, frameTime) {
  ...
  elem.style.transform =
    "rotate(" + timeToDegrees(currentSeconds, totalSeconds) + "deg)";
  setTimeout(
    (function (ft, cs, ts) {
      return function () {
        elem.style.transform =
          "rotate(" + timeToDegrees(cs + ft / 1000, ts) + "deg)";
...
tooltips.showError = function (textString) {
  var tooltip =
    "<p>Well this is embarrassing. Trimps has encountered an error. Try refreshing the page.</p>";
  tooltip +=
    "<p>It would be awesome if you post the following to the <a href='https://reddit.com/r/Trimps/'>trimps subreddit</a> or email it to trimpsgame@gmail.com</p>";
  tooltip +=
    "Note: Saving has been disabled.<br/><br/><textarea id='exportArea' spellcheck='false' style='width: 100%' rows='5'>";
  ...
  costText +=
    "<a id='downloadLink' target='_blank' download='Trimps Bug Report', href=";
  if (Blob !== null) {
...
function screenReaderSummary() {
  ...
  var srSumChallengeContainer = document.getElementById(
  ...
  if (game.global.mapsActive) {
    ...
    srSumMapCell.innerHTML =
      game.global.lastClearedMapCell + 2 + " of " + map.size;
  ...
  srSumTrimps.innerHTML =
    prettify(game.resources.trimps.soldiers) +
    " Fighting, " +
    prettify(game.resources.trimps.owned) +
    " owned, " +
    prettify(
      (game.resources.trimps.owned / game.resources.trimps.realMax()) * 100
    ) +
    "% full";
  ...
  if (cell) {
    ...
    srSumAttackScore.innerHTML =
      prettify(trimpAttack) +
      " ATK, " +
      prettify((trimpAttack / cellHealth) * 100) +
      "% of Enemy Health";
    srSumHealthScore.innerHTML =
      prettify(trimpHealth) +
      " HP, " +
      prettify((cellAttack / trimpHealth) * 100) +
      "% lost per Enemy Attack";
  }
  ...
  for (var x = 0; x < resources.length; x++) {
    ...
    if (max && max > 0)
      text += ", " + prettify((res.owned / max) * 100) + "% full";
    elem.innerHTML = text;
  }
  ...
  if (game.global.challengeActive) {
    ...
    switch (game.global.challengeActive) {
      case "Balance":
        ...
        challengeText =
          "Balance Stacks: " + game.challenges.Balance.balanceStacks;
        break;
      case "Unbalance":
        hasChallengeText = true;
        challengeText =
          "Unbalance stacks: " + game.challenges.Unbalance.balanceStacks;
        break;
    }

    srSumChallengeContainer.style.display = hasChallengeText
      ? "table-row"
      : "none";
      ...
      document
        ...
        .addEventListener("click", function (event) {
          ...
          try {
            ...
            document.getElementById("clipBoardBtn").innerHTML =
              "Error, not copied";
          }
        });
    };
