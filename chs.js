...
var cnItems = {
    ...
    'Stats': '下级属性',
    'Scaffolding': '下级脚手架',
    'Paste a save or a build\n                                                        from the community sheet\n                                                        (copy items or the\n                                                        entire row).': '粘贴存档或装备代码。',
    'Reset!': '重置!',
    '▶ Run!': '▶ 开始模拟!',
    '■ Stop!': '■ 停止模拟!',
    'Auto run!': '自动开始模拟!',
    ...
    'Mods': '词缀',
    'Attack & Health': '攻击力及生命值',
    'Attack & Defense': '攻击力及防御力',
    'Attack & Lifesteal': '攻击力及吸血',
    'Attack & Dust': '攻击力及魔尘',
    'Health & Defense': '生命值及防御力',
    'Health & Lifesteal': '生命值及吸血',
    'Health & Dust': '生命值及魔尘',
    'Defense & Lifesteal': '防御力及吸血',
    'Defense & Dust': '防御力及魔尘',
    'Lifesteal & Dust': '吸血及魔尘',
    'Kill time': '击杀时间',
    'Dust/s': '魔尘/秒',
    'WR': '胜率',
    'Income': '收益',
